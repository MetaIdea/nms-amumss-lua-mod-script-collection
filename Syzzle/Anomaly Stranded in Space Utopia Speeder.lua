Author = "Syzzle"
ModName = "Anomaly Stranded in Space - Utopia Speeder Version"
GameVersion = "4.15"
--ModVersion = "v1"
Description = "Essentialy a No Starter Ship mod, except you still have your ship, tecnically."

-- REMOVED UNTIL I FIGURE OUT HOW TO MAKE IT WORK WHEN YOU SKIP TUTORIAL --
			...
			{ 
				...
				-- REMOVE LAUNCHER FROM DEFAULT KNOWNTECH AND HYPERDRIVE FROM THE BLUEPRINT LIST WHEN USING THE SKIP TUTORIAL OPTION
				{
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						-- CHANGE STARTER SHIP TO GOLDEN VECTOR
						{
							...
							["VALUE_CHANGE_TABLE"]  =
							{
								{"Filename","MODELS/COMMON/SPACECRAFT/FIGHTERS/VRSPEEDER.SCENE.MBIN"}
							}
						},
						{
				...
				},
				{
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						-- AMOUNT OF HAZARD BAR WHEN YOU START
						-- {
						...
						-- 	}
						-- },
						-- -- ADD BATTERY AND GEL TO YOUR STARTING INVENTORY
						-- {
						-- 	["SPECIAL_KEY_WORDS"] = {"Id", "R_SET_HAZ"},
