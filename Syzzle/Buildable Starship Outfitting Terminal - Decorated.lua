    ...
    <Property name="StyleModels">
      <Property name="StyleModels" value="GcBaseBuildingPartStyleModel" _index="0">
        ...
        <Property name="Model" value="TkModelResource">
          <Property name="Filename" value="S/SCENE/UTPROBOTTERMINAL.SCENE.MBIN" />
      ...
      { 
        {
          MBIN_FILE_SOURCE 	= 
          {
            {"MODELS/PLANETS/COMMON/BUILDINGS/ROBOT/PARTS/ROBOTTERMINAL.SCENE.MBIN","S/SCENE/UTPROBOTTERMINAL.SCENE.MBIN"},
          },
        },
        {
          ["MBIN_FILE_SOURCE"] 	= "S/SCENE/UTPROBOTTERMINAL.SCENE.MBIN",
          ["MXML_CHANGE_TABLE"] 	= 
          {
            {
