    ...
    <Property name="StyleModels">
      <Property name="StyleModels" value="GcBaseBuildingPartStyleModel" _index="0">
        ...
        <Property name="Model" value="TkModelResource">
          <Property name="Filename" value="S/SCENE/UTPROBOTTERMINALSMALL.SCENE.MBIN" />
      ...
      { 
        {
          MBIN_FILE_SOURCE 	= 
          {
            {"MODELS/PLANETS/COMMON/BUILDINGS/ROBOT/PARTS/ROBOTTERMINALSMALL.SCENE.MBIN","S/SCENE/UTPROBOTTERMINALSMALL.SCENE.MBIN"},
          },
        },
        {
          ["MBIN_FILE_SOURCE"] 	= "S/SCENE/UTPROBOTTERMINALSMALL.SCENE.MBIN",
          ["MXML_CHANGE_TABLE"] 	= 
          {
            {
              ...
              VALUE_CHANGE_TABLE =
              {
               {"Value","MODELS/PLANETS/BIOMES/COMMON/BUILDINGS/PARTS/BUILDABLEPARTS/TECH/SHIPSALVAGETERMINAL/ENTITIES/SHIPSALVAGE.ENTITY.MBIN"},
              }
            },
          }
        },
