-- SHIP
local Ship_Inv_Slot = 10
local Input_Ship_Inv_Slot = {Ship_Inv_Slot,
[[
...
local Price_Ship_Inv_Slot = 20000000
local Input_Price_Ship_Inv_Slot = {Price_Ship_Inv_Slot,
[[
...
-- WEAPON
local Weap_Inv_Slot = 10
local Input_Weap_Inv_Slot = {Weap_Inv_Slot,
[[
...
local Price_Weap_Inv_Slot = 5000000
local Input_Price_Weap_Inv_Slot = {Price_Weap_Inv_Slot,
[[
...
--SUIT
local Suit_Inv_Slot = 10
local Input_Suit_Inv_Slot = {Suit_Inv_Slot,
[[
...
local Price_Suit_Inv_Slot = 20000000
local Input_Price_Suit_Inv_Slot = {Price_Suit_Inv_Slot,
[[
...
-- upgrade weapon
local Price_Up_Weap = 10000000
local Input_Price_Up_Weap = {Price_Up_Weap,
[[
...
-- Upgrade Ship
local Price_Up_Ship_B = 25000000
local Input_Price_Up_Ship_B = {Price_Up_Ship_B,
[[
...
local Price_Up_Ship_A = 50000000
local Input_Price_Up_Ship_A = {Price_Up_Ship_A,
[[
...
local Price_Up_Ship_S = 75000000
local Input_Price_Up_Ship_S = {Price_Up_Ship_S,
[[
...
{
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'RS_S13_S2M3', 'Reward', 'GcRewardUpgradeWeaponClass'},
                    PKW = {},
                    VCT = {
    ...
    },
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'RS_S13_S4M5', 'Reward', 'GcRewardUpgradeShipClass'},
                    PKW = {},
                    VCT = {
                        {'InventoryClass', 'S'}
                    }
    ...
    },
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'RS_S10_S1M3', 'Reward', 'GcRewardMultiSpecificItems'},
                    PKW = {},
                    VCT = {
            ...
            {
                {
                    ...
                    VCT = {
                        ...
                        {'ProcTechGroup', ''},
                        {'IllegalProcTech', 'false'}
                    -- maybe add delete section option in case Specific has more than 1 item
                    }
                }
            }
        },
...
local Custom_Language_Tag = 'SUMO'

local ModName = 'SuperUpgradeModuleOptions'
...
function Create_Reward_Entry(Reward_Entry_Data)
    local SKW = Reward_Entry_Data.SKW
    -- keeping incase ever needed
    -- local PKW = Reward_Entry_Data.PKW
    local VCT = Reward_Entry_Data.VCT
...
function Start()
    ...
    for i = 1 , #Custom_Products do
        ...
        -- Product_Requirements = Custom_ProductsREQUIREMENTS
