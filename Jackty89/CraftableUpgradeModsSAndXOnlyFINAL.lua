    ...
    for i = 1, #ModArray do
        ...
        for j = 1, #ModIdList do
            ...
            if(NoOfUpgrades == "" or UpgradeStart == "") then
                ...
                for l = NoOfUpgrades, NoOfUpgrades do
...
local MassChangesToProductTable = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"]
...
for i = 1, #CustomFreighterModData do
    ...
    for l = 1, #CustomFreighterMods do
        ...
        for j = NumberOfUpgrades,  NumberOfUpgrades, -1 do
...
for i = 1, #GeneralUpgradeMods do
    ...
    for j = 1, #UpgradeMods do
        ...
        for l = NoOfUpgrades, NoOfUpgrades, -1 do
