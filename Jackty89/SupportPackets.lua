local Recipe_Cost = 2
local Nexuscost= Recipe_Cost * 250
local Input_Pack_Recipe_Cost = {Recipe_Cost,
[[
...
local Pack_Price = 1500
local Input_Pack_Price= {Pack_Price,
[[
...
{
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'DRONE_LOOT', 'Reward', 'GcRewardHealth'},
                    PKW = {},
                    VCT = {
                        {'AmountMax', 100},
                        {'AmountMin', 100}
    ...
    },
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'DRONE_LOOT', 'Reward', 'GcRewardShield'},
                    PKW = {},
                    VCT = {
                        {'AmountMax', 100},
                        {'AmountMin', 100}
    ...
    },
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'DE_FOOD_JETPACK', 'Reward', 'GcRewardJetpackBoost'},
                    PKW = {},
                    VCT = {
                        {'Duration', 600}
                    }
    ...
    },
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'MIXER_HEAL', 'Reward', 'GcRewardHazard'},
                    PKW = {},
                    VCT = {
                        {'AmountMax', 100},
                        {'AmountMin', 100}
    ...
    },
    {
        ...
        REWARD_DATA =
        {
            ...
            {
                {
                    SKW = {'Id', 'MIXER_HEAL', 'Reward', 'GcRewardEnergy'},
                    PKW = {},
                    VCT = {
                        {'Amount', 100}
                    }
...
local Custom_Language_Tag = 'SUPPA'

local ModName = 'SupportPackets'
