...
{
	public class CraftableUpgradeModsSandXonly : cmk.NMS.ModScript
	{
		...
		protected override void Execute()
		{
			...
			foreach (var ModData in AllModData)
			{
				...
				{
					SetCraftabletoTrueAndAddRequirments(Mods);
		...
		protected void SetCraftabletoTrueAndAddRequirments(List<CraftableUpgradeMod> Mods)
		{
			var Prod_mbin = ExtractMbin<GcProductTable>("METADATA/REALITY/TABLES/NMS_REALITY_GCPRODUCTTABLE.MBIN");
		...
		protected void AddUnlockableTrees(List<CraftableUpgradeMod> Mods, TreeExpansion Expansion)
		{
			...
			foreach (var Mod in Mods)
			{
				...
				Root.Children.Add(CreateChildNode(ProductBase, HighestClassNo, HighestClassNo));
			}
		}
