            ...
            MBIN_CHANGE_TABLE =
            {
                ...
                },
                {
                    ...
                    MXML_CHANGE_TABLE =
                    {
                        ...
                        {
                            SPECIAL_KEY_WORDS = {'ID', 'FLAME' , 'TechShopRarity', 'GcTechnologyRarity'},
                            VALUE_CHANGE_TABLE =
                            {
                        ...
                        {
                            SPECIAL_KEY_WORDS = {'ID', 'FLAME' , 'Rarity', 'GcTechnologyRarity'},
                            VALUE_CHANGE_TABLE =
                            {
                                {'TechnologyRarity', 'Common'}
                            }
...
function Single_Stat(Stat_Type, Bonus, Level)
    ...
    {
        SPECIAL_KEY_WORDS = {'ID', 'FLAME', 'StatBonuses', 'GcStatsBonus'},
