...
-- Multipliers --
Daily_Multiplier = "2" -- Nexus Daily Quicksilver Mission Muliplier
Weekly_Multiplier = "2" -- Nexus Weekly Quicksilver Mission Muliplier
...
-- File Settings --
FileName = "QS Daily Mission Reward 2x 1.4.pak" -- can be changed to the name you want the mod but make sure to keep .pak at the end
