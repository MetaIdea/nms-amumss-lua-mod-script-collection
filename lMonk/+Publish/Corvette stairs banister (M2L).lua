...
NMS_MOD_DEFINITION_CONTAINER = {
	...
	{--	|corvette interior stairs banister|
		MBIN_FILE_SOURCE	= {
			'MODELS/COMMON/SPACECRAFT/BIGGS/MODULES/PARTS/STAIRS0_INTERIOR_A.SCENE.MBIN',
			'MODELS/COMMON/SPACECRAFT/BIGGS/MODULES/PARTS/STAIRS0_INTERIOR_B.SCENE.MBIN',
			'MODELS/COMMON/SPACECRAFT/BIGGS/MODULES/PARTS/STAIRS0_INTERIOR_C.SCENE.MBIN',
		},
		MXML_CHANGE_TABLE	= {
			{
