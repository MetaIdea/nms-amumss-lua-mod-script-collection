...
local linkcolour = {
	['[%w_]-_BOOST']		= {0.76,	0.49,	0.309}, -- vehicle boost
	['[%w_]-ICLE_SC[%w_]-']	= {0.25,	0.8,	0.866}, -- vehicle scan
	['[%w_]-SUB[%w_]-GUN']	= {0.266,	0.96,	0.627}, -- submarine gun
	VEHICLE_GUN				= {0.266,	0.96,	0.627},
	T_EXGUN					= {0.266,	0.96,	0.627}, -- vehicle gun
	MECH_GUN				= {0.266,	0.96,	0.627},
	T_MCGUN					= {0.266,	0.96,	0.627}, -- mech gun
}
for id, rgb in pairs(linkcolour) do
	mx_ct[#mx_ct+1] = {
		SPECIAL_KEY_WORDS	= {'ID', id},
