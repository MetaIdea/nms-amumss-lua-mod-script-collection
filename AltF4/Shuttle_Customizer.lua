...
local function CreateCockpitID(NewID,Price)
    return [[
    <Property value="GcProductData.xml">
      ...
      <Property name="BaseValue" value="]] .. Price .. [[" />
...
local function CreateHullID(NewID,Price)
    return [[
    <Property value="GcProductData.xml">
...
local function CreateWingID(NewID,Price)
    return [[
    <Property value="GcProductData.xml">
...
for i=1,#ShuttleCockpitID do
    ADDProductTable[#ADDProductTable + 1] = CreateCockpitID(ShuttleCockpitID[i],Price)
end

for i=1,#ShuttleHullID do
    ADDProductTable[#ADDProductTable + 1] = CreateHullID(ShuttleHullID[i],Price)
end

for i=1,#ShuttleWingID do
    ADDProductTable[#ADDProductTable + 1] = CreateWingID(ShuttleWingID[i],Price)
end

local ADDProductTable = table.concat(ADDProductTable,"\n")

NMS_MOD_DEFINITION_CONTAINER = {
    ["MOD_FILENAME"] = "Shuttle_Customizer.pak",
