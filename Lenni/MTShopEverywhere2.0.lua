...
{
	{ ["ID_NAME"]="WEAPONSHOP", 	["P_NAME"]="WEAPONSHOP", 	    	["PATH"]="MODELS/SPACE/SPACESTATION/MODULARPARTS/DOCK/SHOPS/", 		["GROUP_NAME"]="PLANET_TECH", ["SUBGROUP_NAME"]="PLANETPORTABLE", ["OFFSET"]="0", ["ICON"]=BLDGICON },
}
...
{
["MOD_FILENAME"] 			=	"MTShopEverywhere2.0.pak",
["MOD_AUTHOR"]				=	"Lenni",
	...
	{
		{
			...
			{
				{
                    ["MBIN_FILE_SOURCE"]    = {{[[MODELS/SPACE/SPACESTATION/MODULARPARTS/DOCK/SHOPS/WEAPONSHOP.SCENE.MBIN]],[[MODELS/SPACE/SPACESTATION/MODULARPARTS/DOCK/SHOPS/WEAPONSHOPOLD.SCENE.MBIN]]}},
					["EXML_CHANGE_TABLE"]	= 
					{
						{
						...
						{
							["SPECIAL_KEY_WORDS"]	=	{"Name","RefWeaponsShopTerminal"},
							["ADD_OPTION"]			=	"ADDafterSECTION",
							["ADD"]					=	bottom,
						},
					},
				...
				
                {
					...
					{
						{
                            ["SPECIAL_KEY_WORDS"]	=   {"Name","WeaponShop"},
                            ["VALUE_CHANGE_TABLE"]	=
                            {
                                {"Value","MODELS\SPACE\SPACESTATION\MODULARPARTS\DOCK\SHOPS\WEAPONSHOPOLD.SCENE.MBIN"},   --Original: MODELS\SPACE\SPACESTATION\MODULARPARTS\DOCK\SHOPS\WEAPONSHOP.SCENE.MBIN
                            },
                        },
                    },
				},
