...
{
["MOD_FILENAME"] 			= "Better Asteroid Explosions 1.5.pak", 
["MOD_AUTHOR"]				= "Lo2k",
["NMS_VERSION"]				= "3.53",
			...
			{ 
				{
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						{
							["SPECIAL_KEY_WORDS"]  = {"Id","ASTEROID_M_EXP",},  --force rewrite all scales as we can't target the last "Scale" property
							["REPLACE_TYPE"] = "ALL",
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"Scale",	"50"},	
						...
						{
							["SPECIAL_KEY_WORDS"]  = {"Id","ASTEROID_S_EXP",},  --force rewrite all scales as we can't target the last "Scale" property
							["REPLACE_TYPE"] = "ALL",
							["VALUE_CHANGE_TABLE"] 	= 
							{
