MINSPEED = 		0 			-- This value sets the minimum possible speed while being inside a planet's atmosphere;
											-- Set to a value close to zero for hover (eg. 0.001); Set to zero for backwards flight capability; Base game default = 20;
					  
SPEEDMULT = 	1	  		-- This sets a multiplier for the maximum flight and maximum boost speed inside a planet's atmosphere (eg. 3 would mean flight speed would be at three times the normal speed);
											-- Base game default = 1; Mod default = 2;
											-- Set to "1" for compatibility with _shoemakers_flight_adjustments.lua
					  
TURNMULT = 		1	  		-- Change this depending on your SPEEDMULT setting; For SPEEDMULT = 1 set TURNMULT = 1 as well; For SPEEDMULT = 2 I recommend setting TURNMULT = 0.5, etc;
											-- Or simply test around and tweak it to your liking;
											-- Set to "1" for compatibility with _shoemakers_flight_adjustments.lua
					  
BOOSTMULT = 	1	  		-- Multiplier for strength of the boost acceleration; Set this depending on your SPEEDMULT setting;
...
TELEPORTMULT =	7.5		-- Multiplier for ship Teleport Receiver inventory interaction range bonus; Tweak it to your liking;
											-- By default this is set to 6 times the vanilla range bonus, which is 100u x 7.5 = 750u;
											-- Setting added by Hypn0tick
...
COSTMULT = 		1	  		-- This sets the ship launch fuel cost; The lower the number, the cheaper it gets; Tweak to your liking;
...
{
  ["MOD_FILENAME"]             = "_Planetary_Flight_Fixes_2_5.pak", 
			...
			{
				{
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						{ -- Added by Hypn0tick; Increases Ship Teleport Module Range
