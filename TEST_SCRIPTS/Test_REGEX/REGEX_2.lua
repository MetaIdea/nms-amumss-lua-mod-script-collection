...
while COSTCHOICE do
  COSTCHOICE = GUIF(InputCOSTCHOICE,1)
...
AERIAL_SCAN = GUIF({false, [[Do you want aerial scans (flyup when scan is initiated)?  Default = N.  Press ENTER for default value.]]},1)
