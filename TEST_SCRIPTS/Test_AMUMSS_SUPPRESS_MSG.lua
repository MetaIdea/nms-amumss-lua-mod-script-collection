...
-- ONLY ALTER UPON MBIN CHANGE
VANILLA_PARTS_COUNT = 312

-- MAXIMUM NUMBER OF STABLE UI SLOTS
-- DO NOT ALTER
PARTS_SLOTS_LIMIT = 335
...
function GetBaseBuildingObject(ID)
SNAP_INJECT = ""
if ID == "" then SNAP_INJECT = ID 
else SNAP_INJECT = ID 
end

OVERRIDE_INACTIVE = true
INACTIVE = ""
if OVERRIDE_INACTIVE then INACTIVE = ID end

return [[ ]]
end

GetBaseBuildingObject("TEST")

NMS_MOD_DEFINITION_CONTAINER = 
{
["MOD_FILENAME"] 			= "Test_AMUMSS_SUPPRESS_MSG.pak",
["MOD_AUTHOR"]				= "Wbertro",
["MOD_DESCRIPTION"]			= "Test_AMUMSS_SUPPRESS_MSG",
["NMS_VERSION"]				= "",
