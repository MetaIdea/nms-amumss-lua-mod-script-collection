...
Rewards = 
{
  ...
  {
    ["REWARD"] = REWARD_M,
    ["IDS"] = {"PIRATE_BOUNTY2", "BEGIN_SALVAGE", "PIRATE_REJECT", "MB_STAND_MED", "MECH_LOOT", "R_SENTINELS_OFF"},
  },
  {
    ["REWARD"] = REWARD_MM,
    ["IDS"] = {"WALKER_LOOT"},
  },  
  {
    ...
    {
    ["REWARD"] = REWARD_LL,
    ["IDS"] = {"R_PIRATEBOARD_B", "R_NEXUS_MED_C"},
  },
  {
    ["REWARD"] = REWARD_XL,
          ...
          ["REGEXBEFORE"] =
            ...
            -- {
              ...
              -- {
                ...
                -- { [["SECTION_TO_CHANGE" oldvalue=]],	[[]] }, --any part of a line or a full line can be changed
              -- },
            -- },
          },
				},
        ...
        
				{
					...
					{
						{
							["SPECIAL_KEY_WORDS"] = {"Id", "R_SEE_STATION_2"},
