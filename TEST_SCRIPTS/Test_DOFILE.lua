...
print("")
dofile([[SayHello.lua]]) -- using default ModScript\ModHelperScripts folder
-- dofile([[G:\AMUMSS\ModScript\ModHelperScripts\SayHello.lua]]) -- using fullpath folder
-- can use '...', "..." or [[...]]
-- other ways to write the string \\ or / if a path is used

dofile([[..\..\TEST_HELPER_SCRIPTS\SayHello - child_3.lua]]) -- using relative folder to ModScript\ModHelperScripts
        ...
        EXML_CHANGE_TABLE  = {
          {
            VALUE_CHANGE_TABLE   = {
              ...
              ]=]} , 2)]] or "Interact", }, -- asking for user input, a string
              ...
              Enter 'Y' if you want Interaction as a crime or 'N' for default ]=]} ,2)]] or "False", },
