...
if DoConfig then
  ...
  if DoConfig then
    ...
    print("")
    version = GUIF(GUI.version)
    MyOwnVariable = GUIF(GUI.MyOwnVariable)
    Author = GUIF(GUI.Author)
        ...
        EXML_CHANGE_TABLE  = {
          {
            VALUE_CHANGE_TABLE   = {
              ...
              ]=]} )]] or "Interact", }, -- asking for user input, a string
              ...
              Enter 'Y' if you want Interaction as a crime or press ENTER for default value ]=]} )]], },
              ...
              Enter 'Y' if you want Interaction as a crime or 'N' for default ]=]} )]] or "False", },
              ...
              ]=]} )]], }, -- asking for user input, entered as a string but being a number, a number will be asked 
