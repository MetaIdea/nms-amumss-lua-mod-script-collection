...
REDMAS_NEW_GAME_BONUSES_PRESET ={
    ...
    { -- You can Edit the Pictures inside  RGOG/IMAGES/ to customise the screens
        ["HELLO_GAMES_SPASH_SCREEN"] = "",  --"HG-E3-1"  or another img name or your image name
        ["ENGINE_SPASH_SCREEN"] = "", --"E-E3-1"  or your image name
        ["NMS_TITLE"] = "", --"TITLE-WAYPOINT"  --"TITLE-ATLAS" or your image name
        ["MENU_SPLASH_SCREEN"] = "", --"E3-RUINS"  or your image name
