...
STARTING_SHIP = ""
STARTING_MULTITOOL =""
NEWGAME_BONUSES ="new var"
--FIRST INIT
MODNAME = TEST_PRESET.MODNAME
STARTING_SHIP = TEST_PRESET.NEWGAME_BONUS_FEATURES.STARTING_SHIP
STARTING_MULTITOOL = TEST_PRESET.NEWGAME_BONUS_FEATURES.STARTING_MULTITOOL
VISUAL_OVERHAUL = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.VISUAL_OVERHAUL
CAMERA_OVERHAUL_FEATURE = TEST_PRESET.CAMERA_FEATURES.CAMERA_OVERHAUL_FEATURE
CAMERA_NO_SHAKE_FEATURE = TEST_PRESET.CAMERA_FEATURES.CAMERA_NO_SHAKE_FEATURE
CENTERED_CAMERA_FEATURE = TEST_PRESET.CAMERA_FEATURES.CENTERED_CAMERA_FEATURE
GAMEPLAY_OVERHAUL = TEST_PRESET.GAMEPLAY_FEATURES.GAMEPLAY_OVERHAUL
CREATURES_OVERHAUL = TEST_PRESET.CREATURES_FEATURES.CREATURES_OVERHAUL
GENERATION_OVERHAUL = TEST_PRESET.GENERATION_FEATURES.GENERATION_OVERHAUL
CHARACTERS_SKINS_FEATURE = TEST_PRESET.SKINS.CHARACTERS_SKINS_FEATURE
NEWGAME_BONUSES = TEST_PRESET.NEWGAME_BONUS_FEATURES.NEWGAME_BONUSES
EASY_MODE = TEST_PRESET.EASY_MODE_FEATURES.EASY_MODE
CHALLENGE_MODE = TEST_PRESET.CHALLENGE_FEATURES.CHALLENGE_MODE
-- MENUS PARAMS ----------------------------------------------------------------------------------------------
HELLO_GAMES_SPASH_SCREEN = TEST_PRESET.MENU_OVERHAUL_FEATURES.HELLO_GAMES_SPASH_SCREEN
ENGINE_SPASH_SCREEN = TEST_PRESET.MENU_OVERHAUL_FEATURES.ENGINE_SPASH_SCREEN
NMS_TITLE = TEST_PRESET.MENU_OVERHAUL_FEATURES.NMS_TITLE
...
MENU_SPLASH_SCREEN = TEST_PRESET.MENU_OVERHAUL_FEATURES.MENU_SPLASH_SCREEN
TRANSPARENT_OPTIONS_MENU = TEST_PRESET.MENU_OVERHAUL_FEATURES.TRANSPARENT_OPTIONS_MENU
-- VISUAL OVERHAUL PARAMS ------------------------------------------------------------------------------------
REDMAS_WATER_REFLECTIONS = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.REDMAS_WATER_REFLECTIONS
SPACE_BLUR_FEATURE = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.SPACE_BLUR_FEATURE
FILTERS_SWAP_FEATURE = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.FILTERS_SWAP_FEATURE
BINOCULARS_TYPE = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.BINOCULARS_TYPE
SPEED_EFFECTS_REDUCER_FEATURE = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.SPEED_EFFECTS_REDUCER_FEATURE
SPACESHIPS_TRAILS_TYPE = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.SPACESHIPS_TRAILS_TYPE
SPACE_COLOURS_TYPE = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.SPACE_COLOURS_TYPE
ULTRA_DIVERSE_SPACE_COLOURS = TEST_PRESET.GENERATION_FEATURES.COLORS_AUTO_GENERATION_FEATURES.ULTRA_DIVERSE_SPACE_COLOURS
ASTEROIDS_FIELDS_TYPE = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.ASTEROIDS_FIELDS_TYPE
FIGHTERS_SPACESHIPS_REPAINT = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.FIGHTERS_SPACESHIPS_REPAINT
DROPSHIPS_SPACESHIPS_REPAINT = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.DROPSHIPS_SPACESHIPS_REPAINT
SHUTTLE_SPACESHIPS_REPAINT = TEST_PRESET.VISUAL_OVERHAUL_FEATURES.SHUTTLE_SPACESHIPS_REPAINT
-- CAMERA OVERHAUL PARAMS ------------------------------------------------------------------------------------
...
-- GAMEPLAY OVERHAUL PARAMS ----------------------------------------------------------------------------------
ADVANCED_BODY_SHAPES_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.QOL_FEATURES.ADVANCED_BODY_SHAPES_FEATURE
MINING_SPEED = TEST_PRESET.GAMEPLAY_FEATURES.QOL_FEATURES.MINING_SPEED
NEW_INTERACTIONS_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.QOL_FEATURES.NEW_INTERACTIONS_FEATURE
ADVANCED_BUILDS_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.QOL_FEATURES.ADVANCED_BUILDS_FEATURE
FREE_POWER_ON_EM_GENERATORS = TEST_PRESET.GAMEPLAY_FEATURES.QOL_FEATURES.FREE_POWER_ON_EM_GENERATORS
HOVER_MODE = TEST_PRESET.GAMEPLAY_FEATURES.SPACESHIPS_GAMEPLAY_FEATURES.HOVER_MODE
SANKUKAI_SPACESHIPS_COMBAT = TEST_PRESET.GAMEPLAY_FEATURES.SPACESHIPS_GAMEPLAY_FEATURES.SANKUKAI_SPACESHIPS_COMBAT
ONFOOT_CONTROLS_REVISON_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.ONFOOT_GAMEPLAY_FEATURES.ONFOOT_CONTROLS_REVISON_FEATURE
LONGER_STEATH_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.ONFOOT_GAMEPLAY_FEATURES.LONGER_STEATH_FEATURE
FASTER_WALK_WHILE_SHIELDING_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.ONFOOT_GAMEPLAY_FEATURES.FASTER_WALK_WHILE_SHIELDING_FEATURE
PLAYER_IS_WALKING_INSTEAD_OF_JOGGING_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.ONFOOT_GAMEPLAY_FEATURES.PLAYER_IS_WALKING_INSTEAD_OF_JOGGING_FEATURE
CONTROLLED_FALL_ANIMATION_REPLACEMENT = TEST_PRESET.GAMEPLAY_FEATURES.ONFOOT_GAMEPLAY_FEATURES.CONTROLLED_FALL_ANIMATION_REPLACEMENT
EXOCRAFTS_CONTROLS_REVISON_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.EXOCRAFTS_CONTROLS_REVISON_FEATURE
ADDITIONAL_EXOCRAFT_DRAGONFLY = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.ADDITIONAL_EXOCRAFT_DRAGONFLY
CUSTOM_NOMAD_EXOCRAFT = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.CUSTOM_NOMAD_EXOCRAFT
CUSTOM_ROAMER_EXOCRAFT = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.CUSTOM_ROAMER_EXOCRAFT
ROAMER_BIGWHEELS_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.ROAMER_BIGWHEELS_FEATURE
ROAMER_ADDITIONAL_LAMPS_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.ROAMER_ADDITIONAL_LAMPS_FEATURE
CUSTOM_COLOSSUS_EXOCRAFT = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.CUSTOM_COLOSSUS_EXOCRAFT
CUSTOM_PILGRIM_EXOCRAFT = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.CUSTOM_PILGRIM_EXOCRAFT
ONFOOT_COMBAT_REVISON_BETA_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.ONFOOT_GAMEPLAY_FEATURES.ONFOOT_COMBAT_REVISON_BETA_FEATURE
GIANT_MECHS_BETA_FEATURE = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.GIANT_MECHS_BETA_FEATURE
MECHS_SIZE_MULTIPLIER = TEST_PRESET.GAMEPLAY_FEATURES.VEHICLES_FEATURES.MECHS_SIZE_MULTIPLIER
-- CREATURES PARAMS ------------------------------------------------------------------------------------------
CREATURES_HIGH_DENSITY_FEATURE = TEST_PRESET.CREATURES_FEATURES.CREATURES_HIGH_DENSITY_FEATURE
MAX_CREATURES_NUMBER = TEST_PRESET.CREATURES_FEATURES.MAX_CREATURES_NUMBER
CREATURES_BEHAVIOURS_IMPROVEMENTS_FEATURE = TEST_PRESET.CREATURES_FEATURES.CREATURES_BEHAVIOURS_IMPROVEMENTS_FEATURE
SANDWORM_OVERHAUL_FEATURE = TEST_PRESET.CREATURES_FEATURES.SANDWORM_OVERHAUL_FEATURE
PETS_BEHAVIOURS_AND_RIDING_IMPROVEMENTS_FEATURE = TEST_PRESET.CREATURES_FEATURES.PETS_BEHAVIOURS_AND_RIDING_IMPROVEMENTS_FEATURE
OVERHAUL_TIMER = TEST_PRESET.CREATURES_FEATURES.OVERHAUL_TIMER
FIENDS_SCARY_COMBAT_FEATURE = TEST_PRESET.CREATURES_FEATURES.FIENDS_SCARY_COMBAT_FEATURE
GIANTS_CREATURES_FEATURE = TEST_PRESET.CREATURES_FEATURES.GIANTS_CREATURES_FEATURE
GIANTS_MAX_SIZE = TEST_PRESET.CREATURES_FEATURES.GIANTS_MAX_SIZE
--  GENERATION PARAMS ---------------------------------------------------------------------------------------
-- SPACESHIPS GENERATION PARAMS ----------------------------------------------------------------------------
ADDITIONAL_VARIATIONS_FOR_SHUTTLE_SPACESHIPS = TEST_PRESET.GENERATION_FEATURES.SPACESHIPS_GENERATION_FEATURES.ADDITIONAL_VARIATIONS_FOR_SHUTTLE_SPACESHIPS
ADDITIONAL_VARIATIONS_FOR_FIGHTERS_SPACESHIPS = TEST_PRESET.GENERATION_FEATURES.SPACESHIPS_GENERATION_FEATURES.ADDITIONAL_VARIATIONS_FOR_FIGHTERS_SPACESHIPS
ADDITIONAL_VARIATIONS_FOR_SCIENTICS_SPACESHIPS = TEST_PRESET.GENERATION_FEATURES.SPACESHIPS_GENERATION_FEATURES.ADDITIONAL_VARIATIONS_FOR_SCIENTICS_SPACESHIPS
ADDITIONAL_VARIATIONS_FOR_SCLASS_SPACESHIPS = TEST_PRESET.GENERATION_FEATURES.SPACESHIPS_GENERATION_FEATURES.ADDITIONAL_VARIATIONS_FOR_SCLASS_SPACESHIPS
ADDITIONAL_VARIATIONS_FOR_FREIGHTERS_SPACESHIPS = TEST_PRESET.GENERATION_FEATURES.SPACESHIPS_GENERATION_FEATURES.ADDITIONAL_VARIATIONS_FOR_FREIGHTERS_SPACESHIPS
-- PLANETS GENERATION PARAMS ---------------------------------------------------------------------------------
--voxels params
MODDED_TERRAIN_SHAPES_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.TERRAIN_SHAPES_FEATURES.MODDED_TERRAIN_SHAPES_FEATURE
E3_STYLE_RESSOURCES_DEPOSITS = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.TERRAIN_SHAPES_FEATURES.E3_STYLE_RESSOURCES_DEPOSITS
TERRAIN_HEIGHT_MAX = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.TERRAIN_SHAPES_FEATURES.TERRAIN_HEIGHT_MAX
-- end voxels params
-- ASSETS REWORK params
E3_FANTASY_ASSETS_FEATURES = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.E3_FANTASY_ASSETS_FEATURES
E3_FANTASY_WORSTONES_ASSETS_FEATURE =  TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.E3_FANTASY_WORSTONES_ASSETS_FEATURE
E3_FANTASY_PORTALS_ASSETS_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.E3_FANTASY_PORTALS_ASSETS_FEATURE
E3_FANTASY_BEACONS_ASSETS_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.E3_FANTASY_BEACONS_ASSETS_FEATURE
E3_FANTASY_DEPOTS_ASSETS_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.E3_FANTASY_DEPOTS_ASSETS_FEATURE
E3_FANTASY_CRYSTALS_ASSETS_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.E3_FANTASY_CRYSTALS_ASSETS_FEATURE
E3_FANTASY_PLANETS_COLORS_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.E3_FANTASY_PLANETS_COLORS_FEATURE
REDMAS_RUINS_FEATURES = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.REDMAS_RUINS_FEATURES
-- End Assets Rework params
HUGE_WATER_COLORS_DIVERSITY_FEATURE = TEST_PRESET.GENERATION_FEATURES.COLORS_AUTO_GENERATION_FEATURES.HUGE_WATER_COLORS_DIVERSITY_FEATURE
PLANETSKY_COLORS_DIVERSITY_FEATURE = TEST_PRESET.GENERATION_FEATURES.COLORS_AUTO_GENERATION_FEATURES.PLANETSKY_COLORS_DIVERSITY_FEATURE
LARGE_BUILDINGS_TRADINGPOSTS_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.ASSETS_REPLACEMENTS_FEATURES.LARGE_BUILDINGS_TRADINGPOSTS_FEATURE
-- Biomes param
CONSTRUCTS_BY_MSSP_SPAWNER = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.CONSTRUCTS_BY_MSSP_SPAWNER
SKY_BIOMES_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.SKY_BIOMES_FEATURE
FANTASY_BIOMES_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.FANTASY_BIOMES_FEATURE
STORM_BIOMES_FEATURES = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.STORM_BIOMES_FEATURES
GIANTS_BIOMES_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.GIANTS_BIOMES_FEATURE
LOWWATER_AND_BEACH_BIOMES_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.LOWWATER_AND_BEACH_BIOMES_FEATURE
MONTAINS_BIOMES_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.MONTAINS_BIOMES_FEATURE
CAVE_BIOMES_FEATURE = TEST_PRESET.GENERATION_FEATURES.PLANETS_GENERATION_FEATURES.BIOMES_FEATURES.CAVE_BIOMES_FEATURE
-- End Biomes param
-- SPACE PARAMS ----------------------------------------------------------------------------------------------
REDMAS_SPACE_GENERATION = TEST_PRESET.GENERATION_FEATURES.SPACE_GENERATION_FEATURES.REDMAS_SPACE_GENERATION
TRADING_ROUTES = TEST_PRESET.GENERATION_FEATURES.SPACE_GENERATION_FEATURES.TRADING_ROUTES
MASSIVE_FLEET = TEST_PRESET.GENERATION_FEATURES.SPACE_GENERATION_FEATURES.MASSIVE_FLEET
PROCEDURAL_SPACE_CRASHSITE_FOR_SCAVENGING_MISSION = TEST_PRESET.GENERATION_FEATURES.SPACE_GENERATION_FEATURES.PROCEDURAL_SPACE_CRASHSITE_FOR_SCAVENGING_MISSION
-- SKINS PARAMS ---------------------------------------------------------------------------------
DRONE_PET_SKIN_FEATURE = TEST_PRESET.SKINS.DRONE_PET_SKIN_FEATURE
DRONE_PET_SKIN = TEST_PRESET.SKINS.DRONE_PET_SKIN
CHAR_PRESETS_SKINS = TEST_PRESET.SKINS.CHAR_PRESETS_SKINS
-- CHALLENGE MODE PARAMS -------------------------------------------------------------------------------------
 STRONG_CREATURES_FEATURE = TEST_PRESET.CHALLENGE_FEATURES.STRONG_CREATURES_FEATURE
 HEALTH_MULTIPLIER = TEST_PRESET.CHALLENGE_FEATURES.HEALTH_MULTIPLIER
 DARK_UNDERWATER = TEST_PRESET.CHALLENGE_FEATURES.DARK_UNDERWATER
 STRONG_PIRATES_FEATURE = TEST_PRESET.CHALLENGE_FEATURES.STRONG_PIRATES_FEATURE
-- EASY MODE PARAMS ------------------------------------------------------------------------------------------
PULSE_ENGINE_SPEED_MULTIPLIER = TEST_PRESET.EASY_MODE_FEATURES.PULSE_ENGINE_SPEED_MULTIPLIER
 LAUNCH_COST_REDUCTION = TEST_PRESET.EASY_MODE_FEATURES.LAUNCH_COST_REDUCTION
 WARPCELL_USAGE_MULTIPLIER = TEST_PRESET.EASY_MODE_FEATURES.WARPCELL_USAGE_MULTIPLIER
 HYPERDRIVE_RANGE_MULTIPLIER = TEST_PRESET.EASY_MODE_FEATURES.HYPERDRIVE_RANGE_MULTIPLIER
 --
