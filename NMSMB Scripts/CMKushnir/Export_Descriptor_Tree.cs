//=============================================================================
// Given a list of top-level descriptor mbin's, recurse through the contents
// of each and build a lua string describing their tree of items.
// Save each lua string to a file.
// This is the prototype code that was adapted by the NMS Creative & Sharing Hub
// discord server to generate the descriptor trees used by their seed bots.
//=============================================================================

namespace cmk.NMS.Scripts.Query
{
	public class Export_Descriptor_Tree : cmk.NMS.QueryScript
	{
		...
		{
			var mbin  = ExtractMbin<TkModelDescriptorList>(PATH);
			if( mbin != null ) {
