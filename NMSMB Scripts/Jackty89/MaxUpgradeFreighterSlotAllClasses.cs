...
{
	public class MaxUpgradeFreighterSlotAllClasses : cmk.NMS.ModScript
	{
		...
		protected void FreighterInventoryEdit()
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				mbin.ShipInventoryMaxUpgradeSize[(int)GcSpaceshipClasses.ShipClassEnum.Freighter].MaxTechInventoryCapacity[i] = 21;
			}
		}
	}
}
