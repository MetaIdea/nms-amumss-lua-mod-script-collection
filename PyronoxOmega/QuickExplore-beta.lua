...
Spawn = 500
GroupSizeMultiplier = 8
DensityMultiplier = 7

-- files Path--
Filesource1 = "METADATA/SIMULATION/ECOSYSTEM/CREATUREROLEDESCRIPTIONTABLE.MBIN"
Filesource2 = "METADATA/SIMULATION/ECOSYSTEM/CREATUREGENERATIONDATA.MBIN"
			...
			{ 
				{
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						},
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"MinGroupSize", GroupSizeMultiplier },
                                {"MaxGroupSize", GroupSizeMultiplier },  
							}
						},
					}
				},
					...
					{
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"Sparse", DensityMultiplier},
								{"Normal", DensityMultiplier},
								{"Dense", DensityMultiplier},
								{"VeryDense", DensityMultiplier},			
							}
						},
						{
