ModName = "PTSd Crops + Machine Speed"
GameVersion = "5_11"
...
local ChangesToBaseObjects = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][5]["MXML_CHANGE_TABLE"]
...
for i = 1, #GrowthChanges do
	local ChangesToGrowths = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][i+5]["MXML_CHANGE_TABLE"]
