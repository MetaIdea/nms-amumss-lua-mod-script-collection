...
ExpensiveStationDecMult	=			0.1			--Multiplier applied to default cost of 20/25/30/40/50 Salvaged Data for all items on the 3 "Station Decorations" pages
...
NewStartingSuitRepairTech =
[[<Property name="Table" value="GcTechnology">
			<Property name="ID" value="NEWSUIT_DMG" />
			<Property name="Group" value="" />
			<Property name="Name" value="UI_NEWSUIT_DMG_NAME" />
			<Property name="NameLower" value="UI_NEWSUIT_DMG_NAME_L" />
			<Property name="Subtitle" value="UI_NEWSUIT_DMG_SUB" />
			<Property name="Description" value="UI_NEWSUIT_DMG_DESC" />
			<Property name="Teach" value="false" />
			<Property name="HintStart" value="" />
			<Property name="HintEnd" value="" />
			<Property name="Icon" value="TkTextureResource">
