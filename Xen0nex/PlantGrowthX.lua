...
NMS_MOD_DEFINITION_CONTAINER = 
{
	...
	["MOD_DESCRIPTION"]		= "Changes the growth time for a few farmable plants to make Albumen Pearls, Sac Venom, etc. more worthwhile. Note that the build menu UI does not accurately show the correct growth times.",
	["MOD_AUTHOR"]			= "Xen0nex",
