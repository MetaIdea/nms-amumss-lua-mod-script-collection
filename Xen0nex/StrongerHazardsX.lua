...
["MOD_DESCRIPTION"]		= "Makes hazards (toxic, cold, hot, radiation) harsher. Also increases chances for special weather events (TOrnadoes, Lightning, etc.) and adjusts their properties.",
["MOD_AUTHOR"]			= "Xen0nex",
