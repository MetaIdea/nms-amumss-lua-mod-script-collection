ModName = "PTSd Higher Frigate Challenge"
GameVersion = "5_57"
...
PercentChanceOfDamageOnFailedEvent = 				20.000000	--20.000000
...
function AddDifficultyModifier (Number)
    return
[[
<Property name="DifficultyModifier" value="]]..Number..[[" />]]
end

DifficultyModifierChanges =
{
	{
		{
			"DifficultyModifier"				
		...
		{	--Old value		New value		(Listed in reverse order from how it appears in GCFLEETGLOBALS.GLOBAL.MBIN)		
			{45,			ThreeStarMissionDifficultyMod},			--45
			{30,			TwoStarMissionDifficultyMod},			--30
			{15,			OneStarMissionDifficultyMod},			--15
			{0,				ZeroStarMissionDifficultyMod}			--0
		}
	}
}
...
local ChangesToFrigates = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][1]["MXML_CHANGE_TABLE"]
...
for i = 1, #DifficultyModifierChanges do
	local Name = DifficultyModifierChanges[i][1][1]
	local Values = DifficultyModifierChanges[i][2]
