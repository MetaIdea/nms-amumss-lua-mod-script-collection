...
CorvetteModuleBonuses =
{
	...
	{
		{"CV_S_SHLD"},		--Defence Field
		{
			{"Ship_Armour_Shield_Strength", 					0.33},		--0.05-0.1
			{"Ship_Cargo_Slots", 								1},			--N/A (0)		(Added by PTSd)
		},
	},
	{
		{"CV_S_SHLE"},		--Aeron Powershield
		{
			{"Ship_Armour_Shield_Strength", 					0.107},		--0.05-0.1
			{"Ship_Hyperdrive_JumpsPerCell", 					0.5},		--N/A (0)		(Added by PTSd)
			{"Ship_PulseDrive_MiniJumpSpeed", 					1.07},		--N/A (1)		(Added by PTSd)
		},
	},
	--Weapon damage bonuses adjusted to be ~0.25x the total damage of a weapon with 5x S Class upgrades
	{
		{"CV_SROC3"},		--Torpedo Launcher
		{
			{"Ship_Weapons_Guns_Damage", 						3000},			--400-500
	...
	{
		{"CV_SBLOB3"},		--Cyclotron Defense Cannon
		{
			{"Ship_Weapons_Guns_Damage", 						936},			--8-12
			--{"Ship_Weapons_Guns_Rate", 							1.1},			--1.05-1.1		(Removed in PTSd)
			{"Ship_Weapons_Guns_HeatTime", 						1.05},			--1.25-1.3
			{"Ship_Armour_Shield_Strength", 					-0.05},			--N/A (0)		(Added by PTSd)		If this value is too large (e.g. -0.2), it can cause issues with negative shield strength when multiple modules are installed
		},
	},
	{
		{"CV_SMINI3"},		--Infra-Knife Platform
		{
			{"Ship_Weapons_Guns_Damage", 						45},			--8-12
			--{"Ship_Weapons_Guns_Rate", 							1.021},			--1.05-1.1		(Removed in PTSd)
			{"Ship_Weapons_Guns_HeatTime", 						1.03},			--1.05-1.07
			{"Ship_Armour_Shield_Strength", 					-0.05},			--N/A (0)		(Added by PTSd)		If this value is too large (e.g. -0.2), it can cause issues with negative shield strength when multiple modules are installed
		},
	},
	{
	...
	},
	{
		...
		{
			{"Ship_Launcher_TakeOffCost", 						0.97},		--0.85-0.9
			{"Ship_BoostManeuverability", 						1.02},		--N/A (1)		(Added by PTSd)
			{"Ship_Maneuverability", 							1.001},		--N/A (1)		(Added by PTSd)
			--{"Ship_Boost", 										1.025},		--1.02-1.05		(Removed in PTSd)
			{"Ship_PulseDrive_MiniJumpFuelSpending", 			0.955},		--N/A (1)		(Added by PTSd)
		},
	},
	{
		{"CV_LAUN2"},		--Thunderbird Landing Thrusters
		{
			{"Ship_Launcher_TakeOffCost", 						0.955},		--0.85-0.9
			{"Ship_Boost", 										1.02},		--1.02-1.05
			{"Ship_PulseDrive_MiniJumpFuelSpending", 			0.97},		--N/A (1)		(Added by PTSd)
		},
	},
	{
		{"CV_PULSEA"},		--All 3 rear-mounted thrusters with dual jets (Twin Echo Jets, Twin Dynamo Jets, Twin Sublight Jets)
		{
			--{"Ship_PulseDrive_MiniJumpSpeed", 					1.015},		--N/A (1)		(Removed in PTSd)	(Replaces Ship_PulseDrive_MiniJumpFuelSpending by PTSd)
			{"Ship_Boost", 										1.016},		--1.1-1.15
			{"Ship_BoostManeuverability", 						1.044},		--1.01-1.12
			{"Ship_Maneuverability", 							1.0022},	--1.005-1.005
			--{"Ship_Launcher_TakeOffCost", 						1.03},		--N/A (1)		(Added by PTSd)
		},
	},
	{
		{"CV_PULSEB"},		--All 4 rear-mounted thrusters with a single jet, except for Kineostream Thruster (Pyrodrive Booster, Widebody Thruster, Firebox Thruster, Longshore Thruster)
		{
			--{"Ship_PulseDrive_MiniJumpSpeed", 					1.015},		--N/A (1)		(Removed in PTSd)	(Replaces Ship_PulseDrive_MiniJumpFuelSpending by PTSd)
			{"Ship_Boost", 										1.024},		--1.1-1.15
			{"Ship_BoostManeuverability", 						1.036},		--1.01-1.12
			{"Ship_Maneuverability", 							1.0018},	--1.005-1.005
			--{"Ship_Launcher_TakeOffCost", 						1.03},		--N/A (1)		(Added by PTSd)
		},
	},
	{
		{"CV_PULSEC"},		--Kineostream Thruster
		{
	...
	{
		{"CV_PULSE2"},		--All 3 Sublight Thrusters
		{
			{"Ship_PulseDrive_MiniJumpSpeed", 					1.06},		--N/A (1)		(Replaces Ship_PulseDrive_MiniJumpFuelSpending by PTSd)
	...
	{
		{"CV_PULSE3"},		--All 4 Heavy Boosters
		{
	...
	{
		{"CV_PULSED"},		--Aeron Drive
		{
			{"Ship_PulseDrive_MiniJumpSpeed", 					1.05625},	--N/A (1)		(Replaces Ship_PulseDrive_MiniJumpFuelSpending by PTSd)
			{"Ship_Boost", 										1.0375},	--1.1-1.2
			--{"Ship_BoostManeuverability", 						1.01},		--1.05-1.16		(Removed in PTSd)
			--{"Ship_Maneuverability", 							1.005},		--1.005-1.005		(Removed in PTSd)
			--{"Ship_Launcher_TakeOffCost", 						1.03},		--N/A (1)		(Added by PTSd)
		},
...
NMS_MOD_DEFINITION_CONTAINER = {
	...
	MBIN_CHANGE_TABLE	= {
	{
		...
		MXML_CHANGE_TABLE	= {
			...
			},
			{
				["SPECIAL_KEY_WORDS"] = {"Table", "GcProceduralTechnologyData"},
				["ADD_OPTION"]  = "ADDafterSECTION",
				["ADD"] = AddNewLandingTech ("CV_LAUNB", "4")
			},
			{
				["SPECIAL_KEY_WORDS"] = {"Table", "GcProceduralTechnologyData"},
				["ADD_OPTION"]  = "ADDafterSECTION",
				["ADD"] = AddNewLandingTech ("CV_LAUNC", "3")
			},
			{
			...
			},
			{
				["SPECIAL_KEY_WORDS"] = {"Table", "GcProceduralTechnologyData"},
				["ADD_OPTION"]  = "ADDafterSECTION",
				["ADD"] = AddNewEngineTech ("CV_PULSEC", "4")
			},
			{
				["SPECIAL_KEY_WORDS"] = {"Table", "GcProceduralTechnologyData"},
				["ADD_OPTION"]  = "ADDafterSECTION",
				["ADD"] = AddNewEngineTech ("CV_PULSED", "4")
			},
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "CV_PULSEC",		"StatLevels", "GcProceduralTechnologyStatLevel"},
				["ADD_OPTION"] = "ADDafterSECTION",
				["ADD"] = AddBonusStat ("Ship_PulseDrive_MiniJumpFuelSpending", "1.000000")
			},
			...
			--[[
			{
				["SPECIAL_KEY_WORDS"] = {
                     ...
                     {"ID", "CV_PULSEC",		"StatLevels", "GcProceduralTechnologyStatLevel"},
			...
			},
			{
				["SPECIAL_KEY_WORDS"] = {"Table", "GcProceduralTechnologyData"},
				["ADD_OPTION"]  = "ADDafterSECTION",
				["ADD"] = AddNewShieldTech ("CV_S_SHLD", "2")
			},
			{
				["SPECIAL_KEY_WORDS"] = {"Table", "GcProceduralTechnologyData"},
				["ADD_OPTION"]  = "ADDafterSECTION",
				["ADD"] = AddNewShieldTech ("CV_S_SHLE", "3")
			},
			{
			...
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "CV_S_SHLD",		"StatLevels", "GcProceduralTechnologyStatLevel"},
				["ADD_OPTION"] = "ADDafterSECTION",
				["ADD"] = AddBonusStat ("Ship_Cargo_Slots", "1.000000")
			},
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "CV_S_SHLE",		"StatLevels", "GcProceduralTechnologyStatLevel"},
				["ADD_OPTION"] = "ADDafterSECTION",
				["ADD"] = AddBonusStat ("Ship_Hyperdrive_JumpsPerCell", "0.500000")
			},
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "CV_S_SHLE",		"StatLevels", "GcProceduralTechnologyStatLevel"},
				["ADD_OPTION"] = "ADDafterSECTION",
			...
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "CV_LAUNB",		"StatLevels", "GcProceduralTechnologyStatLevel"},
				["ADD_OPTION"] = "ADDafterSECTION",
				["ADD"] = AddBonusStat ("Ship_BoostManeuverability", "1.020000")
			},
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "CV_LAUNB",		"StatLevels", "GcProceduralTechnologyStatLevel"},
				["ADD_OPTION"] = "ADDafterSECTION",
				["ADD"] = AddBonusStat ("Ship_Maneuverability", "1.001000")
			},
			{
				["SPECIAL_KEY_WORDS"] = {
			...
			{
				["SPECIAL_KEY_WORDS"] = {
                     {"ID", "CV_PULSEC",		"StatsType", "Ship_BoostManeuverability"},
                     {"ID", "CV_PULSEC",		"StatsType", "Ship_Maneuverability"},
                   },
				["SECTION_UP"] = 1,
				["REMOVE"] = "SECTION"
			},
			{
				["SPECIAL_KEY_WORDS"] = {
                     {"ID", "CV_PULSED",		"StatsType", "Ship_BoostManeuverability"},
                     {"ID", "CV_PULSED",		"StatsType", "Ship_Maneuverability"},
                   },
				["SECTION_UP"] = 1,
				["REMOVE"] = "SECTION"
			},
			...
			{
				["SPECIAL_KEY_WORDS"] = {
                     {"ID", "CV_SGUN3",		"StatsType", "Ship_Weapons_Guns_Rate"},
					 {"ID", "CV_SSHOT3",	"StatsType", "Ship_Weapons_Guns_Rate"},
					 {"ID", "CV_SBLOB3",	"StatsType", "Ship_Weapons_Guns_Rate"},
					 {"ID", "CV_SMINI3",	"StatsType", "Ship_Weapons_Guns_Rate"},
                   },
				["SECTION_UP"] = 1,
				["REMOVE"] = "SECTION"
			},
			{
				["SPECIAL_KEY_WORDS"] = {
					 ...
					 {"ID", "CV_SBLOB3",	"StatLevels", "GcProceduralTechnologyStatLevel"},
					 {"ID", "CV_SMINI3",	"StatLevels", "GcProceduralTechnologyStatLevel"},
                   },
				["ADD_OPTION"] = "ADDafterSECTION",
	...
	},
	{
		...
		MXML_CHANGE_TABLE	= {
			...
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "B_SHL_D"},
				["VALUE_CHANGE_TABLE"] 	=
				{
					{"BuildableShipTechID", "CV_S_SHLD"},
				}
			},
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "B_SHL_E"},
				["VALUE_CHANGE_TABLE"] 	=
				{
					{"BuildableShipTechID", "CV_S_SHLE"},
				}
			},
			{
			...
			{
				["SPECIAL_KEY_WORDS"] = {"ID", "B_LND_C"},
				["VALUE_CHANGE_TABLE"] 	=
				{
					{"BuildableShipTechID", "CV_LAUNC"},
				}
			},
			{
				["SPECIAL_KEY_WORDS"] = {
