...
-- KIBBLES_DECOR_NOSNAP = -- ENTRIES WITHOUT SNAPPOINTS
-- {
-- }
...
EXPORT_GROUPS_LIST = {"<!-- KIBBLES GROUPS -->"}
for i,j in pairs(KIBBLES_GROUPS) do
	EXPORT_GROUPS_LIST[i+1] = GetGroupData(j["ID"],j["Name"],j["Icon"],j["SubGroups"])
end

EXPORT_KNOWNPRODUCTS_LIST = {"<!-- KIBBLES -->"}
EXPORT_BASEOBJECTS_LIST = {"<!--KIBBLES PRODUCT-->"}
EXPORT_PRODUCTS_LIST = {"<!--KIBBLES-->"}
EXPORT_PARTS_LIST = {"<!--KIBBLES-->"}
EXPORT_AUTOPARTDATA_LIST = {"<!--KIBBLES-->"}
EXPORT_COST_LIST = {"<!-- KIBBLES OBJECT COSTS-->"}

-- JOINING THE OBJECT LISTS
-- for i,j in pairs(KIBBLES_DECOR_NOSNAP) do
	-- KIBBLES_OBJPROD[#KIBBLES_OBJPROD + 1] = j
-- end
...
-- for i,j in pairs(KIBBLES_SNAPGROUPS) do
...
EXPORT_COST_LIST[#EXPORT_COST_LIST + 1] = "<!-- KIBBLES OBJECT COSTS END-->"
EXPORT_BASEOBJECTS_LIST[#EXPORT_BASEOBJECTS_LIST + 1] = "<!--KIBBLES PRODUCT END-->"
EXPORT_GROUPS_LIST[#EXPORT_GROUPS_LIST + 1] = "<!-- KIBBLES GROUPS END-->"
EXPORT_PRODUCTS_LIST[#EXPORT_PRODUCTS_LIST + 1] = "<!--KIBBLES END-->"
EXPORT_PARTS_LIST[#EXPORT_PARTS_LIST + 1] = "<!--KIBBLES END-->"
EXPORT_AUTOPARTDATA_LIST[#EXPORT_AUTOPARTDATA_LIST + 1] = "<!--KIBBLES END-->"
