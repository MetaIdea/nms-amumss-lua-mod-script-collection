...
function GetSubGroupMigrate(SUBGROUP, NAME, FROM, TO)
...
for i=#SUBGROUP_MOVE_TABLE,1,-1 do
	...
	table.insert(CHANGE_LEOPARDON, GetSubGroupMigrate(SUBGROUP_MOVE_TABLE[i]["SubGroup"], SUBGROUP_MOVE_TABLE[i]["Name"], SUBGROUP_MOVE_TABLE[i]["From"], SUBGROUP_MOVE_TABLE[i]["To"]))
end


NMS_MOD_DEFINITION_CONTAINER = 
{
["MOD_FILENAME"] 			= "CUMinBuM.pak",
["MOD_AUTHOR"]				= "WinderTP, Babscoole",
["MOD_DESCRIPTION"]			= "Categorisation Utility Module in Build Menu",
["NMS_VERSION"]				= "",
["MODIFICATIONS"] 			= 
	{
		{
