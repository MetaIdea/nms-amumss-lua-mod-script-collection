...
{
  ["MOD_FILENAME"]          = "MyScript",     --the name of the pak created (if not combined) - REQUIRED
    ...
    {
        {
            ...
            {
                {
                    ["MBIN_FILE_SOURCE"]    = {"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\LUSH\LUSHOBJECTSFULL.MBIN",},  --{ a_comma_separated_list_of.MBINs, }
                    ["EXML_CHANGE_TABLE"] =
                    {
                        {
