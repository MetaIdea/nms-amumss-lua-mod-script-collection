...
------------------------------------------------------------------------------------------------------
local _SpawnFrequencyMulti = 1.25  --Spawn Frequencies within T1-T3 and Pirate economies.
------------------------------------------------------------------------------------------------------
...
local function modifyAISpaceshipModelDataArray()
    local change_table = {}
...
local function modifyAISpaceshipWeightingData()
    return {
        {
...
NMS_MOD_DEFINITION_CONTAINER =
{
    ...
    ["MODIFICATIONS"]   =
    {
        {["MBIN_CHANGE_TABLE"] = modifyAISpaceshipModelDataArray()},
        {["MBIN_CHANGE_TABLE"] = modifyAISpaceshipWeightingData()},
    },
}
