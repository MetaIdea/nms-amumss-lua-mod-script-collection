local modfilename = "AutoScannerPlus-EXPEDITION"
local lua_author  = "Silent"
local lua_version = "5.1"
local mod_author  = "Silent369"
local contributor = ""
local nms_version = "6.23"
...
local m_ScanRange = 10000.000000
local m_ScanTime  = 30.000000
local m_RangeMult = 1.000000
local m_ShowRange = 10000.000000
local m_Override  = 10.000000
...
function CreateScannableComponentData(ScanRange, ScanName, ScanTime, RangeMult, ShowRange, DisplayIcon, AllowMerge, Override, Wrapper)
    local Content = [[
			<Property name="GcScannableComponentData">
				...
				<Property name="HideCompassInAlwaysShowRange" value="true" />
				...
				<Property name="ForceCompassMarkerOnForScannerIcon" value="false" />
			</Property>]]
...
AddCargoSpec   = CreateScannableComponentData(m_ScanRange, "UI_SCAN_PHYSICS_CARGO_SPEC",  m_ScanTime, m_RangeMult, m_ShowRange, "GravityGunCargo",    "true",  m_Override, false)
