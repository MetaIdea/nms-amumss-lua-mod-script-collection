...
FILE_METADATA_MODULAR_PRODS = "METADATA\REALITY\TABLES\NMS_MODULARCUSTOMISATIONPRODUCTS.MBIN"
...
function BuildItemList(list)
    ...
    local ListEntries = {}
    local EntryStart = [[<Property name="AlwaysPresentProducts" value="]]
    local EntryEnd = [[" />]]
    ...
    {
        {
            ["MBIN_CHANGE_TABLE"]   =
            {
                ...
                {
                    --------------------------------------------------
                    -- modular products table MBIN
                    --------------------------------------------------
                    ["MBIN_FILE_SOURCE"] = FILE_METADATA_MODULAR_PRODS,
                    ["EXML_CHANGE_TABLE"] =
                    {
                        {
