...
function BuildWikiList(list)
  ...
  local EntryStart = [[<Property name="Items" value="]]
  local EntryEnd = [[" />]]
  local ListEntries = {}
...
function BuildWikiPage(button,label,list) return
{
    ...
    {   ["SEC_EDIT"] = "SEC_WIKI_ITEMS",   ["SKW"] = {"IconOn","TkTextureResource",},    ["VCT"] ={{"Filename","TEXTURES/UI/FRONTEND/ICONS/WIKI/WIKI.BUILD.POWER.ON.DDS",},},           },
    {   ["SEC_EDIT"] = "SEC_WIKI_ITEMS",   ["SKW"] = {"IconOff","TkTextureResource",},   ["VCT"] ={{"Filename","TEXTURES/UI/FRONTEND/ICONS/WIKI/WIKI.BUILD.POWER.OFF.DDS",},},          },
