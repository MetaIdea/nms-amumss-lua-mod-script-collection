...
FILE_MISSIONS_FLEET =       "METADATA\\SIMULATION\\MISSIONS\\TABLES\\FLEETMISSIONTABLE.MBIN"
FILE_MISSIONS_PIRATE =      "METADATA\\SIMULATION\\MISSIONS\\TABLES\\PIRATEMISSIONTABLE.MBIN"
    ...
    {
        {
            ["MBIN_CHANGE_TABLE"] =
            {
...

                {
                    ...
                    {
                        {
                            ["SKW"] = {"MissionID","PIRATE_STATION",},
                            ["VCT"] = {{"RepeatLogic","None",},},
                        },
