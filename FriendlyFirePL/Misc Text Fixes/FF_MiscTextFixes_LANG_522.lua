...
Devilin Pixy, Lenni, members of NMS Discord
pointing out typos
...
-- QUEST - missing entry for "hide and seek" mission
TEXT_HIDEANDSEEK_FOUND = 
[[
Missing person located!&#xA;
Approach the lifeform
]]

-- ITEM - added missing space in description of Industry Grade Battery ("miningoperations")
TEXT_TRADE_ITEM_SPACE =
[[
...
-- MISC - fixed typo in one of flora notes ("Hallucigenic")
TEXT_FLORA_NOTE = "Hallucinogenic Bark"

-- TECH - changed wording in description of Warp Core Resonator blueprint ("resonation")
TEXT_FREIGHTER_RESONANCE =
[[
An augmentation for the colossal hyperdrive engine of an &lt;STELLAR&gt;interstellar freighter&lt;&gt;.&#xA;&#xA;
Quantum resonance improves the robustness of the drive during FTL travel, granting the ability to leap to stars previously out of reach.
]]
...
-- TECH - changed wording for Amplified Cartridges blueprint ("effective manufacturing more shots")
TEXT_PULSE_SPITTER_MAG = 
[[
Specialist harmonic resonators allow the &lt;TECHNOLOGY&gt;Pulse Spitter&lt;&gt; to split inserted ammunition, effectively manufacturing additional shots from provided materials.&#xA;&#xA;
...
-- ITEM - changed wording in description of Supply Depot ("can be located a long distances") and joined with 1st part of description
TEXT_STORAGE_SILO_DESCR =
[[
Automated storage unit that can be set up at long distances from the extraction site. Connect to a &lt;TRADEABLE&gt;Supply Grid&lt;&gt; using &lt;TECHNOLOGY&gt;Pipelines&lt;&gt;.&#xA;&#xA;
Automatically stores the output of various &lt;STELLAR&gt;Mineral&lt;&gt; and &lt;STELLAR&gt;Gas Extractors&lt;&gt;, allowing for increased capacity and more efficient siting. 
]]
...
-- ITEM - fixed a typo in description of Seeds of Glass ("in the their")
TEXT_SEEDS_OF_GLASS =
[[
A &lt;STELLAR&gt;biomechanical construct&lt;&gt;, created to the design of an anonymous host.&#xA;&#xA;
Capsules of genetic material, encased in a film of living glass. Shared memories swim in their reflective surfaces, waiting for their chance to shape the life within.
]]

-- TECH - changed wording in description of Self Greasing Servos ("dispenser reduce and encourage")
TEXT_MECH_FUEL_FRICTION =
[[
An automatically-regulated lubricant dispenser fitted to the leg joints of the Minotaur, this apparatus reduces friction and encourages fuel-efficient motion.&#xA;&#xA;
Significantly &lt;STELLAR&gt;reduces fuel burn&lt;&gt; in the Minotaur's Daedalus Engine.
]]

-- ITEM - fixed a typo in Repair Kit description ("techology")
TEXT_REPAIR_KIT_TECHNOLOGY =
[[
...
While repairing a piece of technology, the Repair Kit can be applied to any damaged subcomponent in place of the usual requirements.
]]
...
-- TECH - fixed typo in Atmospheric Control Unit description ("capable of generated")
TEXT_FREIGHTER_LIFESUPPORT =
[[
A critical freighter subsystem, vital for maintaining a habitable and safe environment for all on-board organic lifeforms.&#xA;&#xA;
Capable of generating a limited &lt;STELLAR&gt;breathable atmosphere&lt;&gt; even when damaged or unpowered, but only for a short period of time.
]]

-- ITEM - fixed a typo in Moon Ether description ("and a function")
TEXT_MOON_EHTER_FUNCTION =
[[
A vat of highly volatile liquid. Its fumes are extremely flammable and function as a powerful sedative.&#xA;&#xA;
...
-- TECH - removed info about AI mining from Liquidators Body exomech technology module
TEXT_EXOMECH_LIQUIDATORS =
[[
...
Will function as a semi-autonomous &lt;TECHNOLOGY&gt;artificial pilot plugin&lt;&gt;. Installation allows the Minotaur to &lt;STELLAR&gt;traverse planets itself&lt;&gt; and engage in &lt;STELLAR&gt;combat&lt;&gt; activities to support its primary operator.&#xA;&#xA;
The AI pilot will always cede control to the primary operator when they enter the cockpit.
]]
...
LIST_FIXES =
{
    ...
    UI_HIDE_SEEK_OBJ                = TEXT_HIDEANDSEEK_FOUND,
    UI_TRADE_ITEM_ENERGY_2_DESC     = TEXT_TRADE_ITEM_SPACE,
    PLANT_NOTES_23                  = TEXT_FLORA_NOTE,
    UI_FREIGHTER_DRIVE1_DESC        = TEXT_FREIGHTER_RESONANCE,
    ...
    UT_SMG_DESC                     = TEXT_PULSE_SPITTER_MAG,
    ...
    BLD_U_SILO_DESC                 = TEXT_STORAGE_SILO_DESCR,
    ...
    UI_BIOSHIP_COMP4_DESC           = TEXT_SEEDS_OF_GLASS,
    UI_MECH_FUEL_DESC               = TEXT_MECH_FUEL_FRICTION,
    UI_REPAIR_KIT_DESC              = TEXT_REPAIR_KIT_TECHNOLOGY,
    ...
    UI_FREI_LIFESUPP_DESC           = TEXT_FREIGHTER_LIFESUPPORT,
    UI_ILLEGAL_PROD3_DESC           = TEXT_MOON_EHTER_FUNCTION,
