...
FILE_MODELS_CORVETTE_LANDINGZONE =      "MODELS\COMMON\SPACECRAFT\BIGGS\BIGGSLANDINGZONE.SCENE.MBIN"

-- new files
FILE_MODDED_CORVETTE_LANDINGZONE =      "MODELS\COMMON\SPACECRAFT\BIGGS\MODDEDLANDINGZONE.SCENE.MBIN"
    ...
    {
        {
            ...
            {
                {
                    -- create new scene file for corvette zone
                    ["MBIN_FILE_SOURCE"] = {{   FILE_MODELS_CORVETTE_LANDINGZONE,  FILE_MODDED_CORVETTE_LANDINGZONE,   "REMOVE"    },},
                },

                {
                    --------------------------------------------------
                    -- new corvette landing scene MBIN
                    --------------------------------------------------
                    ["MBIN_FILE_SOURCE"] = FILE_MODDED_CORVETTE_LANDINGZONE,
                    ["MXML_CHANGE_TABLE"] =
                    {
                        {
                            -- remove node
                            ["SKW"] = {"Name","REFLandingZoneVFX",},
                            ["REMOVE"] = "SECTION",
                        },
                    },
                },

                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
                        ...
                        {
                            -- edit template - link new landing scene
                            ["SEC_EDIT"] = "SEC_CORVETTE_DOCK",
                            ["SKW"] = {"Name","SCENEGRAPH",},
                            ["VCT"] = {{"Value",FILE_MODDED_CORVETTE_LANDINGZONE,},},
                        },
