            ...
            {
                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
                        ...
                        {   
                            -- change label for tertiary colour picker
                            ["SEC_EDIT"] = "SEC_COLOUR_TERTIARY",
                            ["VCT"] = {{"Title","UI_SOLAR_SAIL_NAME_L",},},
                        },
                        ...
                        {   
                            -- change label for secondary colour picker
                            ["SEC_EDIT"] = "SEC_COLOUR_SECONDARY",
                            ["VCT"] = {{"Title","BINOC_CONTROL",},},
                        },
                        ...
                        {   
                            -- change label for primary colour picker
                           ["SKW"] = {"Skiff","GcCustomisationUI","Title","CUSTOMISE_PRIMARY",},
                            ["VCT"] = {{"Title","BLD_FRE_EXT_NAME_L",},},
                        },
                    }
                },
