...
{   ["SEC_EDIT"] = "SEC_OPTIONS",   ["SKW"] = {id,old,},    ["REPLACE_TYPE"] = "onceINSIDE",    ["VCT"] = {{id,new,},},     }
end
            ...
            {
                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
...

                        {
                            ...
                            ["SKW"] = {"SlotID","SHUTTLE_COCKPIT","SlotEmptyPreviewCustomisation","GcModularCustomisationSlotItemData",},
...

                        {
                            ...
                            ["CREATE_HOS"] = "TRUE",
                            ["ADD"] = [[<Property name="AssociatedNonProcNodes" value="_SClassShip_Royal" />]],
                        },
...

                        {
                            ...
                            ["SKW"] = {"SlotID","SHUTTLE_WING","SlotEmptyPreviewCustomisation","GcModularCustomisationSlotItemData",},
                        ...
                        {
                            -- change default preview to engine A, 
                            ["SKW"] = {"SlotID","SHUTTLE_HULL","SlotEmptyPreviewCustomisation","GcModularCustomisationSlotItemData",},
                            ["VCT"] = {{"ActivatedDescriptorGroupID","EXOTIC_ENGINEA",},},
                        },

                        {
                            -- change label and icon for engine slot, point line to locator node
...

                        {
                            ...
                            ["SKW"] = {"Shuttle","GcModularCustomisationConfig","Title","CUSTOMISE_SECONDARY",},
                            ["REMOVE"] = "SECTION",
                        },
...

                        {
                            ...
                            ["SKW"] = {"Shuttle","GcModularCustomisationConfig","Title","CUSTOMISE_PRIMARY",},
                            ["VCT"] = {{"DefaultColourIndex",9,},},
                        },

                        {
                            -- change default accent colour (blue)
                            ["SKW"] = {"Shuttle","GcModularCustomisationConfig","Title","CUSTOMISE_TERTIARY",},
...

                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
                        ...
                        FillInField("Descriptors","_ENGINE_B","_TopWing_A"),
                        FillInField("Descriptors","_ENGINE_C","_TopWing_B"),
                        FillInField("Descriptors","_ENGINE_D","_TopWing_C"),

                        {
                            ...
                            ["PKW"] = "Descriptors",
                            ["ADD"] = [[<Property name="Descriptors" value="_SClassShip_Royal" />]]
                        },
                        ...
                        FillInField("Descriptors","_ENGINE_B","_Wings_A"),
                        FillInField("Descriptors","_ENGINE_C","_Wings_B"),
                        FillInField("Descriptors","_ENGINE_D","_Wings_C"),
                        ...
                        FillInField("Descriptors","_ENGINE_B","_Engine_A"),
                        FillInField("Descriptors","_ENGINE_C","_Engine_B"),
                        FillInField("Descriptors","_ENGINE_D","_Engine_C"),
...

                {
                    ...
                    {                        
...

                        {
                            ...
                            ["VCT"] =
                            {
                                {"Tips","PC_SETTINGS_CUSTOM",},
                                {"Tips","UI_PAINT_YELLOW",},
                                {"Tips","UI_PAINT_BLUE",},
                                {"Tips","UI_PAINT_RED",},
                                {"Tips","UI_PAINT_WHITE",},
                                {"Tips","UI_PAINT_ORANGE",},
...

                        {
                            ...
                            {
                                {"Tips","PC_SETTINGS_CUSTOM",},
                                {"Tips","UI_MEDAL_RANK_2",},
                                {"Tips","UI_MEDAL_RANK_3",},
                            },
                        },
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
...

                        {
                            ...
                            ["VCT"] = 
                            {
                                {"Name","BLACK",},
                                {"Probability",0,},
                                {"TextureName","TEXTURES/COMMON/SPACECRAFT/S-CLASS/ROYALSCLASS_TRIM.OVERLAY.BLACK.DDS",},
                            },
                        },
...

                        {
                            ...
                            ["VCT"] = 
                            {
                                {"Name","PAINTED",},
                                {"Probability",0,},
                                {"TextureName","TEXTURES/COMMON/SPACECRAFT/S-CLASS/ROYALSCLASS_TRIM.OVERLAYMETAL.GOLD.DDS",},
                            },
                        },
...

                        {
                            ...
                            ["SKW"] = {"Name","PAINTED","Palette","TkPaletteTexture",},
                            ["REPLACE_TYPE"] = "ONCEINSIDE",
                            ["VCT"] = {{"Palette","Paint",},{"ColourAlt","Alternative2",},},
                        },
                    }
                },
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
...

                        {
                            ...
                            ["VCT"] = 
                            {
                                {"Name","PAINTED",},
                                {"Probability",0,},
                                {"TextureName","TEXTURES/COMMON/SPACECRAFT/S-CLASS/DETAILS.OVERLAYMETAL.GOLD.DDS",},
                            },
                        },
