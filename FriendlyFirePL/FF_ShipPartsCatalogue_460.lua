...
METADATA_MOD_DESC       = "This mod adds new sections to Recipies section of Catalogue and Guide showcasing all the available parts for ship assembly. Modifies the METADATA\\REALITY\\CATALOGUERECIPES.MBIN file."
