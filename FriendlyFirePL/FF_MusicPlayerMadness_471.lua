...
{   ["SEC_EDIT"] = "SEC_ITEM_PLAYER",   ["VCT"] = {{"ID",[[ITEM_]]..name,},{"Name",[[TEXT_]]..name..[[_N]],},{"NameLower",[[TEXT_]]..name..[[_L]],},{"Description",[[TEXT_]]..name..[[_D]],},},     }
end
            ...
            ["MBIN_CHANGE_TABLE"] =
            {
...

                {
                    ...
                    ["EXML_CHANGE_TABLE"] =
                    {
                        ...
                        {   ["SEC_EDIT"] = "SEC_ITEM_PACKET",   ["VCT"] = {{"ID","ITEM_PACKET",},{"Name","TEXT_PACKET_N",},{"NameLower","TEXT_PACKET_L",},
                                                                {"Subtitle","TEXT_PACKET_S",},{"Description","TEXT_PACKET_D",},{"CanSendToOtherPlayers","False",},},    },
                        ...
                        {   ["SEC_EDIT"] = "SEC_ITEM_PLAYER",   ["VCT"] = {{"Subtitle","TEXT_ITEM_S",},{"CanSendToOtherPlayers","False",},},                                                                        },
                        ...
                        PlayerVCT("T01"),PlayerAdd(),
                        PlayerVCT("T02"),PlayerAdd(),
                        PlayerVCT("T03"),PlayerAdd(),
                        PlayerVCT("T04"),PlayerAdd(),
                        PlayerVCT("T05"),PlayerAdd(),
                        PlayerVCT("T06"),PlayerAdd(),
                        PlayerVCT("T07"),PlayerAdd(),

                        -- build player items - collections
                        PlayerVCT("T11"),PlayerAdd(),
                        PlayerVCT("T12"),PlayerAdd(),
                        PlayerVCT("T13"),PlayerAdd(),
                        PlayerVCT("T14"),PlayerAdd(),
                        PlayerVCT("T15"),PlayerAdd(),
                    },
                },
