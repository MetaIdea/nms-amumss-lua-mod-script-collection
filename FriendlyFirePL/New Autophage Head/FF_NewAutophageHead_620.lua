            ...
            ["MBIN_CHANGE_TABLE"]   =
            {
...

                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
                        ...
                        {   ["SEC_EDIT"] = "SEC_NODE_HEAD",     ["SKW"] = {"Name","HeadNPCRobotEyesMech",},    ["ADD_OPTION"] = "ADDafterSECTION",   ["SEC_ADD_NAMED"] = "SEC_CLOTH_0",  }, 
                        {   ["SEC_EDIT"] = "SEC_NODE_HEAD",     ["SKW"] = {"Name","HeadNPCRobotEyesMech",},    ["ADD_OPTION"] = "ADDafterSECTION",   ["SEC_ADD_NAMED"] = "SEC_CLOTH_1",  }, 
                        {   ["SEC_EDIT"] = "SEC_NODE_HEAD",     ["SKW"] = {"Name","HeadNPCRobotEyesMech",},    ["ADD_OPTION"] = "ADDafterSECTION",   ["SEC_ADD_NAMED"] = "SEC_CLOTH_2",  }, 
                        {   ["SEC_EDIT"] = "SEC_NODE_HEAD",     ["SKW"] = {"Name","HeadNPCRobotEyesMech",},    ["ADD_OPTION"] = "ADDafterSECTION",   ["SEC_ADD_NAMED"] = "SEC_CLOTH_3",  },
                    ...
                    {
                        {
                            ...
                            ["SKW"] = {"Id","_BHEAD_4","Children","TkModelDescriptorList",},
...

                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
...

                        {
                            ...
                            {
                                {"GroupID","BHEAD_20",},
                                {"LinkedProductOrSpecialID","",},
                                {"Tip","UI_FREI_LIFESUPP_NAME_L",},
                            },
                        },

                        {
                            -- clear out descriptors list
                            ["SEC_EDIT"] = "SEC_DESCR_GROUP",
                            ["PKW"] = "Descriptors",
                            ["CREATE_HOES"] = "TRUE",
                        },
                        ...
                        {
                            -- add the new head node descriptor
                            ["SEC_EDIT"] = "SEC_DESCR_GROUP",
                            ["PKW"] = "Descriptors",
                            ["CREATE_HOS"] = "TRUE",
                            ["ADD"] = [[<Property name="Descriptors" value="_Head_Build4" />]]
                        },
...

                        {
                            ...
                            ["PKW"] = "Descriptors",
                            ["ADD_OPTION"] = "ADDendSECTION",
                            ["ADD"] = [[<Property name="Descriptors" value="_BH4Cloth_Null" />]],
                        },

                        {
                            ...
                            ["PKW"] = "Descriptors",
                            ["ADD_OPTION"] = "ADDendSECTION",
                            ["ADD"] = [[<Property name="Descriptors" value="_BH4Cloth_1" />]],
                        },

                        {
                            ...
                            ["PKW"] = "Descriptors",
                            ["ADD_OPTION"] = "ADDendSECTION",
                            ["ADD"] = [[<Property name="Descriptors" value="_BH4Cloth_2" />]],
                        },

                        {
                            ...
                            ["PKW"] = "Descriptors",
                            ["ADD_OPTION"] = "ADDendSECTION",
                            ["ADD"] = [[<Property name="Descriptors" value="_BH4Cloth_3" />]],
                        },
                    }
                },
                    ...
                    {
                        {
                            ...
                            ["SKW"] = {{"Name","BASE",}},
                            ["VCT"] = {{"TextureName","TEXTURES/COMMON/ROBOTS/ROBOTHEADMAIN.BASE.DDS",},},
                        },
                    ...
                    {
                        {
                            -- assign new textures to base layer
                            ["SKW"] = {{"Name","BASE",}},
                            ["VCT"] = {{"TextureName","TEXTURES/COMMON/ROBOTS/ROBOTHEADDETAIL.BASE.DDS",},},
                        },
