...
{   ["SKW"] = {"ID","SLOT05GRP",},  ["SECTION_UP_SPECIAL"] = 2,     ["SEC_SAVE_TO"] = "SEC_UI_SLOT",    }
end
...
{   ["SKW"] = {"ID",id,},   ["SECTION_UP_SPECIAL"] = 2,     ["ADD_OPTION"] = "ADDafterSECTION",     ["SEC_ADD_NAMED"] = "SEC_UI_SLOT",  }
end
    ...
    {
        {
            ["MBIN_CHANGE_TABLE"] =
            {
...

                {
                    ...
                    ["MXML_CHANGE_TABLE"] = {} -- table populated by functions below
                },
...

                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
                        ...
                        {   ["SKW"] = {"ID","DOT04",},      ["SECTION_UP_SPECIAL"] = 2,     ["SEC_SAVE_TO"] = "SEC_UI_DOT",                                             },
                        {   ["SEC_EDIT"] = "SEC_UI_DOT",    ["VCT"] = {{"ID","DOT05",},{"Position X","@+10",},},                                                         },
                        {   ["SKW"] = {"ID","DOT04",},      ["SECTION_UP_SPECIAL"] = 2,     ["ADD_OPTION"] = "ADDafterSECTION",     ["SEC_ADD_NAMED"] = "SEC_UI_DOT",   },
                        {   ["SKW"] ={{"ID","DOT01",},{"ID","DOT02",},{"ID","DOT03",}, {"ID","DOT04",},{"ID","DOT05",},},   ["VCT"] = {{"Position X","@-5",},},          },
                    }
                },

                {
                    ...
                    ["MXML_CHANGE_TABLE"] =
                    {
                        ...
                        {   ["SKW"] = {"ID","PRODUCT",},    ["SECTION_UP_SPECIAL"] = 2,     ["SEC_SAVE_TO"] = "SEC_ITEM",  },
                        {   ["SEC_EDIT"] = "SEC_ITEM",      ["VCT"] = {{"ID","SUBSTANCE",},},   },
                        {   ["SKW"] = {"ID","BACKGROUND_NO",},  ["SECTION_UP_SPECIAL"] = 2,     ["PKW"] = "Children",   ["ADD_OPTION"] = "ADDendSECTION",   ["SEC_ADD_NAMED"] = "SEC_ITEM",     },
                    }
                },
            }
        }
...
function Modules_RemoveIndex() return
{   ["SEC_EDIT"] = FUNCTION_SECTION,    ["SKW"] = {"Slots","GcModularCustomisationSlotConfig",},    ["ADD_OPTION"] = "REPLACEatLINE",   ["ADD"] = [[<Property name="Slots" value="GcModularCustomisationSlotConfig">]]    }
end
...
function Modules_SetEmptyPreview(descr) return
{   ["SEC_EDIT"] = FUNCTION_SECTION,    ["SKW"] = {"SlotEmptyPreviewCustomisation","GcModularCustomisationSlotItemData",},      ["VCT"] = {{"ActivatedDescriptorGroupID",descr,},},  }
end
...
{   ["SKW"] = {"Shuttle","GcModularCustomisationConfig",},  ["PKW"] = "Slots",  ["ADD_OPTION"] = "ADDendSECTION",   ["SEC_ADD_NAMED"] = slotid, }
end
...
{   ["SEC_EDIT"] = FUNCTION_SECTION,    ["PKW"] = "AssociatedNonProcNodes",     ["CREATE_HOS"] = "TRUE",
    ["ADD"] = [[<Property name="AssociatedNonProcNodes" value="]]..id..[[" />]],      }
end
...
{   ["SEC_EDIT"] = FUNCTION_SECTION,    ["SKW"] = {id,old,},    ["REPLACE_TYPE"] = "onceINSIDE",    ["VCT"] = {{id,new,},},     }
end
...
function Descr_Add(id,list)
    ...
    for i=1, #list do
        ListAdd[#ListAdd+1] = [[<Property name="Descriptors" value="]]..list[i]..[[" />]]
    end
...
function Modules_BuildChangeTable(exml)
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_SetEmptyPreview("SENT_PIT_A"),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_FLAPS_A"),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_A1S6A2"),
        Modules_RemoveItems(ITEMS),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_WO_NONE"),
        Modules_RemoveItems(ITEMS),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_WU_NONE"),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_WH_NONE"),
        Modules_RemoveItems(ITEMS),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_WB_NONE"),
        Modules_RemoveItems(ITEMS),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_GRILL_NULL"),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_FLAME_1"),
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_RemoveIndex(),
        Modules_ApplyVCT(VCT),
        Modules_SetEmptyPreview("SENT_ADDON_NONE"),
        Modules_RemoveItems(ITEMS),
...
function Descriptors_BuildChangeTable(exml)
    ...
    local INSTRUCTIONS =
    {
        ...
        Descr_Fill("Descriptors","_ENGINE_B","_Pit_A"),
        Descr_Fill("GroupID","FIGHT_ENGIC","SENT_PIT_B"),
        Descr_Fill("Descriptors","_ENGINE_C","_Pit_B"),
        Descr_Fill("GroupID","FIGHT_ENGID","SENT_PIT_C"),
        Descr_Fill("Descriptors","_ENGINE_D","_Pit_C"),
        Descr_AddNewGroup(),
    }
...
local EXML_MODULES = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][1]["MXML_CHANGE_TABLE"]
Modules_BuildChangeTable(EXML_MODULES)

local EXML_DESCRIPTORS = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][2]["MXML_CHANGE_TABLE"]
