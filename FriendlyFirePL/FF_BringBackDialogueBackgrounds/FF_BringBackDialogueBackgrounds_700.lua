...
FILE_UI_JUDGEMENT_PAGE =        "UI\INTERACTIONJUDGEMENTPAGE.MBIN"
    ...
    {
        {
            ["MBIN_CHANGE_TABLE"] =
            {
                ...
                {
                    --------------------------------------------------
                    -- settlement judgement interaction UI MBIN
                    --------------------------------------------------
                    ["MBIN_FILE_SOURCE"] = FILE_UI_JUDGEMENT_PAGE,
                    ["MXML_CHANGE_TABLE"] =
                    {
                        {
                            -- resize the text background
                            ["SKW"] = {"Image","/TEXTURES/UI/FRONTEND/COMPONENTS/DIALOG.TALK.DDS",},
                            ["VCT"] = {{"Width",1080,},},
                        },

                        {
                            -- restore the coloured border on the text background
                            ["SKW"] = {"Image","/TEXTURES/UI/FRONTEND/COMPONENTS/DIALOG.TALK.DDS",},
                            ["VCT"] = {{"Stroke Size",1,},{"Stroke Size",1,},{"Stroke Size",1,},},
                        },

                        {
                            -- resize the text container to fit the smaller background
                            ["SKW"] = {"ID","TEXT",},
                            ["SECTION_ACTIVE"] = 0,
                            ["VCT"] = {{"Width",1200,},},
                        },
                        ...
                        {
                            -- make text smaller to fit the container
                            ["SKW"] = {"ID","TEXT",},
                            ["SECTION_ACTIVE"] = 0,
                            ["SECTION_UP_SPECIAL"] = 1,
                            ["VCT"] = {{"Font Height",28,},{"Font Height",28,},{"Font Height",28,},},
                        },
