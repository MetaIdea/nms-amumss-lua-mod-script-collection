...
LIST_DONE_EXPEDS =
{
    ...
    {"ID","PATCH16",},{"ID","PATCH17",},{"ID","PATCH18",},
}

-- list of keywords for hardcoded empty entries
LIST_REMOVED_EXPEDS =
{
    {"ID","PATCH19",},{"ID","PATCH20",},
                    ...
                    {
                        {
                            ...
                            ["SKW"] = {"NameIDLower","UI_JM_TITLE_SEASON","IconOn","TkTextureResource",},
                            ["VCT"] = {{"Filename","TEXTURES\UI\FRONTEND\ICONS\MISSIONS\MISSION.SEASONAL.ON.DDS",},},
                        },

                        {
                            -- change the non-active icon to expedition marker
                            ["SKW"] = {"NameIDLower","UI_JM_TITLE_SEASON","IconOff","TkTextureResource",},
