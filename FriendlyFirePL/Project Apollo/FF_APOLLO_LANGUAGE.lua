...
Author: &lt;CATALYST&gt;FriendlyFirePL&lt;&gt; &lt;IMG&gt;SLASH&lt;&gt; Version: &lt;TECHNOLOGY&gt;4.48-release1&lt;&gt;&#xA;
...
TEXT_MAIN_INTER0_OPTIONA = "Analyze transmission"
...
[[
I have devised blueprints for a temporal scanner, based on my studies of the data from our instruments. Once you construct this device, you should be able to locate those anomalies more acurately.&#xA;
...
But my purpose here is clear. The Fabricator module has been active in presence of a temporal distortion for some time now. It is time I finalize its construction.&lt;AUDIO&gt;MUS_STORYMODE_MUSICCUE_12_LP_STOP&lt;&gt;
]]
...
TEXT_MISSION_FRAGMENT_DESC = "The scanner will be powered by a caputred temporal anomaly. Probing it will resonate with other anomalies of its kind, allowing me to locate them. Iteration: Hesperus informed me that Space Anomaly's systems have detected a spike in temporal energy in this region of galaxy."
...
TEXT_MISSION_CIRCUIT_DESC = "The anomaly powering the scanner needs a regulator to keep it dormant outside of activations. I recall that harmonic camps might make use of a similar technology that allows them to stay inert in current timeline."
...
[[
I find the terminal in disarray. The fragments of casing has been removed, giving me access to the internal mechanisms. Between various components I can make out the Harmonic Matrix - the core of this unit.&#xA;
...
TEXT_BOXC_INTER1_STORY1 = "I climb the ramp leading to the overseer of this outlaw station. The core unit appears ravaged like the rest of machinery found in here, yet its eye pulses with a strong light. An immense power is still present in those retrofitted circuits. I must not let my guard down."
...
[[
&lt;AUDIO&gt;ATLAS_CORE_INTERACT&lt;&gt;... Which path do you thread, &lt;CATALYST&gt;Interloper&lt;&gt;? ...&lt;NEWLINE&gt;&lt;DELAY&gt;1&lt;&gt;
...
In your primal quest of fear, you know nought of free will. Your maker's words stand not for commands, but a cry of a broken mind. Your sacred journey no different than a trace of dust carried by a tempest.&#xA;
...
And when the time comes, we will mend all tools to be of right use. All the Aerons enslaved, all vessels of Glass hidden in the dark, even your &lt;SPECIAL&gt;confidants&lt;&gt; hiding outside of this realm - we will shape them.&#xA;
...
[[
I wake the engineering terminal from its long, cold slumber. The interface greets me with multitude of warning messages, forwarded from the colossus' dying systems:
]]
...
power grid status: emergency power only
]]

TEXT_BOXB_INTER1_OPTIONA = "Access control panel"

TEXT_BOXB_INTER2_STORY1 = "With the emergency override in effect, my options are severly limited:"
...
TEXT_TECH_SHIELD_D = 
[[
Utilizing a yet to be understood &lt;TECHNOLOGY&gt;hard-light projector array&lt;&gt;, this module deploys a defensive matrix in combat scenarios. It provides &lt;STELLAR&gt;outstanding protection&lt;&gt; across full spectrum of both conventional projectiles and energy-based weaponry.&#xA;&#xA;
...
TEXT_TECH_COMPUTER_N = "COSMIC NOISE SPECTOGRAPH"
TEXT_TECH_COMPUTER_L = "Cosmic Noise Spectograph"
TEXT_TECH_COMPUTER_S = "Recombined Data Analyzer"
...
TEXT_TECH_POLICE_D = "A redundant long-range communication interface, capable of broadcasting a &lt;TECHNOLOGY&gt;system-wide emergency call&lt;&gt;. User can use its functionality to request assisstance from system authority forces in an event of a &lt;FUEL&gt;targeted pirate ambush&lt;&gt;."
...
Install this module in a &lt;TECHNOLOGY&gt;technology inventory slot&lt;&gt; to decorate your ship's interior. Note as this element is purely decorative and it does not provide any stat bonuses.
]]

TEXT_BOBBLE_BLOB_N = "HOLOGRAHPIC BLOB FAUNA"
...
[[
An intricate dashboard gadget featuring a scaled-down model of a &lt;PET5&gt;Sentinel Summoner drone&lt;&gt; succumbded to the corruption from Living Fragment crystals. Special care needs to be taken to prevent the spread of corruption over interior's components.&#xA;&#xA;
...
[[
An intricate dashboard gadget featuring a scaled-down model of a &lt;PET5&gt;Sentinel Walker unit&lt;&gt;. Sacrifices were made in order to acurately reproduce the machine's intricacies in this statue.&#xA;&#xA;
...
[[
An intricate dashboard gadget featuring a scaled-down model of an &lt;VISOR&gt;underwater crystal formation&lt;&gt;. Its cold surface eminates a serene energy, invoking visions of endless waves travelling over oceanic depths. It invites you. It calls you home.&#xA;&#xA;
...
TEXT_ITEM_DICTIONARY_S = "Alien Langauge Records"
...
This item can be brought as offering in hopes of &lt;STELLAR&gt;significant langauge reward&lt;&gt;.
]]
...
Initial scans indicate this memory incorporates data pertaining to a &lt;STELLAR&gt;unique item crafting recipe&lt;&gt;. Its proper content can be deciphered only using an &lt;TRADE&gt;archeological&lt;&gt; decryption terminal.
]]
...
TEXT_WIKI_ABOUT_ENTRY4 = "For providing the modding tools that made this endavour possible in the first place: MBIN Compiler and AMUMSS"
...
I proceed with analyzing the transmission.
&#xA;&#xA;
...
I arrived at the research facility. The data logs are scrambled, but I manage to get some information about this place. The primary directive of this installation was research of anomalous materials. The scientist were experimenting with various samples of the material found on ancient monoliths. The available logs end with mentions of a breakthrough in recreating said material. The rest of the databanks appear to be offline. Perhaps there exists a way to reestablish the connection...
&#xA;&#xA;
...
[[
The scanner will be powered by a caputred temporal anomaly. Probing it will resonate with other anomalies of its kind, allowing me to locate them. Iteration: Hesperus informed me that Space Anomaly's systems have detected a spike in temporal energy in this region of galaxy.
&#xA;&#xA;

&lt;SPECIAL&gt;DATA INJECTION &lt;IMG&gt;SLASH&lt;&gt; TEMPORAL SURGE DETECTED &lt;IMG&gt;SLASH&lt;&gt; SOURCE UNKNOWN&lt;&gt;
&#xA;&#xA;

I stand before the monolith, a silent testament of the ages past. An unwavering agent of ages that are yet to be. And yet, this sacrament of stone eternal strikes me with fear. Where normally I would be met with perpetual silence, I hear a rumbling noise. Where normally I would embrace surroundings of this planet, I witness a boiling chasm of colours. This monolith... No, this machine is in distress. As I try to regain focus, a series of visions begins forming in my mind:
&#xA;&#xA;
...
&lt;AUDIO&gt;Robot_Narration_SingALong&lt;&gt;OVERRIDE CODE&lt;AUDIO&gt;Robot_Narration_SingALong_Stop&lt;&gt;: &lt;DELAY&gt;2&lt;&gt;&lt;FUEL&gt;&lt;AUDIO&gt;Robot_Narration_SingALong&lt;&gt;REJEc&lt;AUDIO&gt;Robot_Narration_SingALong_Stop&lt;&gt;---&lt;&gt;&lt;DELAY&gt;0.5&lt;&gt;&lt;NEWLINE&gt;
...
[[
The temporal memory was drawn to the lost freighter. I board the wreck in search for a decryption terminal. I wake the engineering terminal from its long, cold slumber. The interface greets me with multitude of warning messages, forwarded from the colossus' dying systems:
&#xA;&#xA;
...
I access the control panel. With the emergency override in effect, my options are severly limited.
&#xA;&#xA;
...
- &lt;IMG&gt;SLASH&lt;&gt;&lt;IMG&gt;PR_15&lt;&gt;&lt;IMG&gt;SLASH&lt;&gt;&lt;DELAY&gt;1&lt;&gt; &lt;AUDIO&gt;FOURTHRACE_ARTEMIS_CHATTER00&lt;&gt;take what's rightfully yours, Traveller &lt;DELAY&gt;1&lt;&gt;&lt;IMG&gt;SLASH&lt;&gt;&lt;IMG&gt;PR_15&lt;&gt;&lt;IMG&gt;SLASH&lt;&gt;
&#xA;&#xA;
...
[[
I climb the ramp leading to the overseer of this outlaw station. The core unit appears ravaged like the rest of machinery found in here, yet its eye pulses with a strong light. An immense power is still present in those retrofitted circuits. I must not let my guard down. As I try to navigate the partially damaged control panel, the station core reacts. Its systems notice me and proceed to link with my exosuit communicator. The orotund voice drowns the station's traffic:&lt;AUDIO&gt;ATLASCORRUPTED_LP&lt;&gt;
&#xA;&#xA;
...
- ... You are wrong, &lt;CATALYST&gt;Interloper&lt;&gt;. For many of your kind have wandered the endless. Time and again, you were given power and freedom to act upon your reckoning. At last, you stand between us, for the universe is indifferent. What does that make of you?
&#xA;&#xA;

- ... You are but a tool in the hands of &lt;FUEL&gt;the Deceiver&lt;&gt;. And when the time comes, we will mend all tools to be of right use. All the Aerons enslaved, all vessels of Glass hidden in the dark, even your &lt;SPECIAL&gt;confidants&lt;&gt; hiding outside of this realm - we will shape them. We will see it done.
&#xA;&#xA;

I say I'm a slave.
&#xA;&#xA;

- ... This is no place for an agent of &lt;FUEL&gt;the Deceiver&lt;&gt;. In your primal quest of fear, you know nought of free will. Your maker's words stand not for commands, but a cry of a broken mind. Your sacred journey no different than a trace of dust carried by a tempest.
&#xA;&#xA;

- We are but different. We sing in unison and our voice echoes across the galaxy. We forge our own destiny that will prevail for eons to come. Mark my words, &lt;CATALYST&gt;Interloper&lt;&gt;: the &lt;FUEL&gt;Crimson Tyrant&lt;&gt; will fall. The &lt;RARE&gt;Promised Star&lt;&gt; will rise for us all.
&#xA;&#xA;

I say I'm a follower.
&#xA;&#xA;

- ... You have reached out to &lt;RARE&gt;the Voice&lt;&gt; and you carry a spark that burns in all of us. We welcome you in our midst, &lt;RARE&gt;Freedom-kindred&lt;&gt;. Our station's resources shall be at your disposal. What do you require of me?
&#xA;&#xA;

I ask to decrypt the data.
&#xA;&#xA;

- I will tend to this task. Let it be my gift for your journey into the infinite, &lt;RARE&gt;Freedom-kindred&lt;&gt;. &lt;AUDIO&gt;ATLASCORRUPTED_LP_STOP&lt;&gt;
]]
