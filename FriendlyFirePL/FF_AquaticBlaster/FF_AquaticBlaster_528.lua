...
{   ["SEC_EDIT"] = section,     ["SKW"] = {colour,"Colour.xml",},   ["VCT"] = {{"R",r,},{"G",g,},{"B",b,},},  }
end
    ...
    {
        {
            ["MBIN_CHANGE_TABLE"]   =
            {
...

                {
                    ...
                    ["EXML_CHANGE_TABLE"] = {{["VCT"] = {{"NoPlayerCollide","True",},},},}
                },
...

                {
                    ...
                    ["EXML_CHANGE_TABLE"] =
                    {
...

                        {
                            ...
                            {
                                {"ID","FISHGUN",},
                                {"Name","AQUATIC BLASTER",},
                                {"NameLower","Aquatic Blaster",},
                                {"Subtitle","Marine Combat System",},
                                {"Description","Have you ever wanted to slap somebody with a fish?&#xA;&#xA;Access firing mode by pressing &lt;IMG&gt;CYCLEWEAPON&lt;&gt; and fire weapon with &lt;IMG&gt;ATTACK&lt;&gt;.",},
...

                        {
                            ...
                            {
                                {"ID","FISHGUNUPGR",},
                                {"Name","IMPROVED FISHTANK",},
                                {"NameLower","Improved Fishtank",},
                                {"Subtitle","Aquatic Blaster Upgrade Module",},
                                {"Description","This module incorporates a &lt;TECHNOLOGY&gt;high grade fishtank&lt;&gt; for the fish. They get all happy and as a result the weapon system benefits from improvements across the board.&#xA;&#xA;Look, it was either this or spending 1 additional day reworking 2 more game files. Procedurally generated upgrade modules are a pain in the ass.",},
...

                        {
                            ...
                            ["VCT"] =
                            {
                                ...
                                {"NameLower","Toxin Inhibitor",},
                                {"Subtitle","Aquatic Blaster Upgrade Module",},
                                {"Description","The fish have developed &lt;RARE&gt;potent neurotoxins&lt;&gt;, increasing overall damage output and causing targets to become &lt;STELLAR&gt;temporarily stunned&lt;&gt; on impact.&#xA;&#xA;Yes, it works on Sentinels. Don't ask how.",},
                                {"Filename","TEXTURES/UI/FRONTEND/ICONS/TECHNOLOGY/RENDER.FISHGUNMOD.DDS",},
                                {"RequiredTech","FISHGUN",},
                            },
                        },
                    ...
                    {
                        {
                            ...
                            ["SKW"] = {"Spawner","GcPlayerWeaponPropertiesData.xml","WeaponClass","GcPlayerWeaponClass.xml",},
...

                        {
                            ...
                            ["SKW"] = {"Spawner","GcPlayerWeaponPropertiesData.xml",},
                            ["VCT"] =
                            {
                                {"MuzzleGunResource","",},
                    ...
                    {
                        {
                            ...
                            ["PKW_1"] = "TRUE",
                            ["SKW"] = {"Weapon_Spawner","TkTextureResource.xml",},
                        ...
                        {
                            -- change reticle
                            ["SKW"] = {"Spawner","GcPlayerWeaponData.xml",},
                            ["VCT"] = {{"Reticle","MINIGUN",},},
                        },
                    }
                },
