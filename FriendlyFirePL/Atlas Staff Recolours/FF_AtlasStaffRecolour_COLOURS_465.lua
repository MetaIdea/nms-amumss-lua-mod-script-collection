...
--------------------------------------------------
-- vanilla files used as template
--------------------------------------------------
    ...
    {
        {
            ["MBIN_CHANGE_TABLE"]   =
            {
                    ...
                    {
                        {
                            ...
                            ["VCT"] = {{"x",RGB[COLOUR][1],},{"y",RGB[COLOUR][2],},{"z",RGB[COLOUR][3],},},
                        },
                    },
                },
...

                {
                    ...
                    ["EXML_CHANGE_TABLE"] =
                    {
                        -- change name to be sure
                        {   ["VCT"] = {{"Name","Models\\Effects\\Weapons\\STAFFORB.SCENE.MXML"},},      },

                        -- point the new scene to new individual effect files x5
                        {   ["SKW"] = {"Name","Mist","Name","DATA",},           ["VCT"] = {{"Value",FILE_MODDED_MIST_PARTICLE},},           },
                        {   ["SKW"] = {"Name","LightGlow","Name","DATA",},      ["VCT"] = {{"Value",FILE_MODDED_LIGHTGLOW_PARTICLE},},      },
                        {   ["SKW"] = {"Name","ElecPower","Name","DATA",},      ["VCT"] = {{"Value",FILE_MODDED_ELECPOWER_PARTICLE},},      },
                        {   ["SKW"] = {"Name","EmberBits","Name","DATA",},      ["VCT"] = {{"Value",FILE_MODDED_EMBERBITS_PARTICLE},},      },
                        {   ["SKW"] = {"Name","Glow","Name","DATA",},           ["VCT"] = {{"Value",FILE_MODDED_GLOW_PARTICLE},},           },    
                    },
                },
                    ...
                    {
                        {
                            ...
                            ["SKW"] = {{"ColourStart","Colour.xml",},{"ColourMiddle","Colour.xml",},{"ColourEnd","Colour.xml",},},
                            ["VCT"] = {{"R",RGB[COLOUR][1],},{"G",RGB[COLOUR][2],},{"B",RGB[COLOUR][3],},},
                        },
                    },
                },
            }
