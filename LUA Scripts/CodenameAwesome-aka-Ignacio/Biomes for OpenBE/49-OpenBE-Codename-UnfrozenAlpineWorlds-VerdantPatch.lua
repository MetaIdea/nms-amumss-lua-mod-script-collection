...
RENDER_DISTANCE_MULTIPLIER = 3 --Can be float or integer
...
NMS_MOD_DEFINITION_CONTAINER = 
{
  ...
  ["MOD_DESCRIPTION"]		= "Applies Verdan optimized/extended grass render distance to the new Alpine object lists. This script requires the UnfrozenAlpineWorlds.lua file.",
