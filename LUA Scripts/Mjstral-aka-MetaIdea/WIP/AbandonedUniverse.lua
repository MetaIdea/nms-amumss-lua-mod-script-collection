...
{
["MOD_FILENAME"] 			= "AbandonedUniverse.pak",
["MOD_AUTHOR"]				= "Mjstral aka MetaIdea",
["NMS_VERSION"]				= "3.13+",
["MOD_DESCRIPTION"]			= "Removes: Buildings and outposts on planets, ship fly bys on planets, sentinels and pirates, all spacestations abandoned, and every other sign of life that is not a creature or plant",
["MODIFICATIONS"] 			= 
	{
		{
					...
					{
						{
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"AbandonedSystemShipSpawnProbablity",	"0"},
								{"FlybyCloseOdds",	"0"},
							}
						}
					}
					...
					{
						{
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"SpaceStationFile", "MODELS/SPACE/SPACESTATION/SPACESTATION_ABANDONED.SCENE.MBIN"},
							}
						}
					}
				}
