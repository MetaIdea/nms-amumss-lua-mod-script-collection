...
MEDIUM = "Médio"
HIGH = "Alto"
CLASS_TECH = "Tecnologia"
CLASS_MINING = "Mineração"
CLASS_TRADE = "Negociação"
CLASS_MANUFACT = "Fabricação"
CLASS_ALLOY = "Materiais avançados"
CLASS_SCIENCE = "Científico"
CLASS_POWER = "Geração de energia"

NMS_MOD_DEFINITION_CONTAINER = 
{
  ["MOD_FILENAME"] 			= "NEN_Portuguese_everything_AMUMSS.pak",
	...
	{
		{
			...
			{ 
				{
					["MBIN_FILE_SOURCE"] 	= "LANGUAGE/NMS_UPDATE3_PORTUGUESE.MBIN",
					["EXML_CHANGE_TABLE"] = 
					{
						-- ECONOMY LEVEL
