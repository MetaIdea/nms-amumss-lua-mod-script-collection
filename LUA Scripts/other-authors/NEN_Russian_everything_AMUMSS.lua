...
MEDIUM = "Середина"
HIGH = "Высокая"
CLASS_TECH = "Технология"
CLASS_MINING = "Добыча"
CLASS_TRADE = "торговый"
CLASS_MANUFACT = "Производство"
CLASS_ALLOY = "Современные материалы"
CLASS_SCIENCE = "научный"
CLASS_POWER = "Выработка энергии"

NMS_MOD_DEFINITION_CONTAINER = 
{
  ["MOD_FILENAME"] 			= "NEN_Russian_everything_AMUMSS.pak",
