...
CLASS_MINING = "Mijnbouw"
CLASS_TRADE = "Handel"
CLASS_MANUFACT = "Productie"
CLASS_ALLOY = "Geavanceerde materialen"
CLASS_SCIENCE = "Wetenschappelijk"
CLASS_POWER = "Stroomopwekking"

NMS_MOD_DEFINITION_CONTAINER = 
{
  ["MOD_FILENAME"] 			= "NEN_Dutch_everything_AMUMSS.pak",
	...
	{
		{
			...
			{ 
				{
					["MBIN_FILE_SOURCE"] 	= "LANGUAGE/NMS_UPDATE3_DUTCH.MBIN",
					["EXML_CHANGE_TABLE"] = 
					{
						-- ECONOMY LEVEL
