...
{
["MOD_FILENAME"]    = "BBB Wonder Woman Explorer and Royal Ships - Invisible Interior.pak",
["MOD_AUTHOR"]      = "BigBuffaloBill & Babscoole",
["NMS_VERSION"]     = "5.1.1",
["MOD_DESCRIPTION"] = "Removes many of the front interior parts of Explorer Ships and for Royal Ships (they actually use the same interior from a design standpoint) for the purposes of useful exploration while in 1st person mode or in VR",
["MODIFICATIONS"]   =
    {
        {
            ["MBIN_CHANGE_TABLE"] =
