...
{
["MOD_FILENAME"]  = "FlourishingFauna-NormalAnimals-NormalFlourish.pak",
["MOD_AUTHOR"]    = "Burryaga",
                    ...
                    {
                        {
                            ...
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"RideSpeedSlow",                      "0.625"},
                                {"RideSpeedFast",                      "3.1"},
                                {"MaxEcosystemCreaturesNormal",        "55"},
                                {"MaxEcosystemCreaturesLow",           "25"},
                                {"FishSpeedMax",                       "6.25"},
                                {"MaxSpeed",                           "37.5"},
                                ...
                                {"PauseBetweenCreatureSpawnRequests",  "3000"},
                            }
                        },
                    }
                },
