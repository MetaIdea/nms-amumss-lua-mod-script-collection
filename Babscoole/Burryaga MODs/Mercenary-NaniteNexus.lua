...
{
["MOD_FILENAME"]  = "Mercenary-NaniteNexus.pak",
["MOD_AUTHOR"]    = "Burryaga",
            ...
            {
                {
                    ...
                    ["EXML_CHANGE_TABLE"] =
                    {
                        ...
                        {
                            ["SPECIAL_KEY_WORDS"] = {"Id", "R_NEXUS_QS", "Currency", "GcCurrency.xml"},
                            ["REPLACE_TYPE"] = "ONCEINSIDE", 
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"Currency", "Nanites"},
                        ...
                        {
                            ["SPECIAL_KEY_WORDS"] = {"Id", "R_NEXUS_QS_PQ", "Currency", "GcCurrency.xml"},
                            ["REPLACE_TYPE"] = "ONCEINSIDE", 
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"Currency", "Nanites"},
