REWARD_ID    = "RS_S22_S3M4_R"
REWARD_ICON  = "TEXTURES/UI/FRONTEND/ICONS/SPECIALSHOP/EXPEDITION.S22.TROPHYR.DDS"
REWARD_TITLE = "PRISMATIC_CORE_R"
REWARD_ABBR  = "PCR"

NMS_MOD_DEFINITION_CONTAINER =
{
["MOD_FILENAME"]    = "Prismatic Core R Unlocker",
					...
					<Property name="List" value="GcRewardTableItem">
						...
						<Property name="Reward" value="GcRewardSpecificSpecial">
							<Property name="GcRewardSpecificSpecial">
								<Property name="ID" value="SWARM_TROPHY_R" />
