REWARD_ID    = "RS_S22_S3M4_B"
REWARD_ICON  = "TEXTURES/UI/FRONTEND/ICONS/SPECIALSHOP/EXPEDITION.S22.TROPHYB.DDS"
REWARD_TITLE = "PRISMATIC_CORE_B"
REWARD_ABBR  = "PCB"

NMS_MOD_DEFINITION_CONTAINER =
{
["MOD_FILENAME"]    = "Prismatic Core B Unlocker",
					...
					<Property name="List" value="GcRewardTableItem">
						...
						<Property name="Reward" value="GcRewardSpecificSpecial">
							<Property name="GcRewardSpecificSpecial">
								<Property name="ID" value="SWARM_TROPHY_B" />
