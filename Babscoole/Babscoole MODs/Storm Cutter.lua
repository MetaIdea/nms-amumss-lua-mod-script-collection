      ...
      ["MBIN_CHANGE_TABLE"] =
      {
        ...
        },
        {
          ...
          ["MXML_CHANGE_TABLE"] =
          {
            ...
            {
              ["PRECEDING_KEY_WORDS"] = {"Fog", "Settings"},
              ["VALUE_CHANGE_TABLE"] =
              {
                {"Thickness", "0.5"},
              }
            ...
            {
              ["PRECEDING_KEY_WORDS"] = {"Fog", "Settings", "Settings", "Settings"},
              ["VALUE_CHANGE_TABLE"] =
              {
                {"Alpha1", "0.5"},
                {"Alpha2", "0.5"},
          ...
          {
            {
              ...
              ["VALUE_CHANGE_TABLE"] =
              {
                {"Dust", "METADATA/SIMULATION/SOLARSYSTEM/WEATHER/CLEARWEATHER.MXML"},
                {"Snow", "METADATA/SIMULATION/SOLARSYSTEM/WEATHER/CLEARWEATHER.MXML"},
                {"Toxic", "METADATA/SIMULATION/SOLARSYSTEM/WEATHER/CLEARWEATHER.MXML"},
                {"Scorched", "METADATA/SIMULATION/SOLARSYSTEM/WEATHER/CLEARWEATHER.MXML"},
                {"Radioactive", "METADATA/SIMULATION/SOLARSYSTEM/WEATHER/CLEARWEATHER.MXML"},
              }
            },
          }
        },
