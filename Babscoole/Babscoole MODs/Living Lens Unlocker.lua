REWARD_ID    = "R_LIVING_LINK"
REWARD_ICON  = "TEXTURES/UI/FRONTEND/ICONS/TECHNOLOGY/TECH.S22LINK.DDS"
REWARD_TITLE = "LIVING_LENS"
REWARD_ABBR  = "LL"

NMS_MOD_DEFINITION_CONTAINER =
{
["MOD_FILENAME"]    = "Living Lens Unlocker",
          ...
          {
            {
              ...
              ["ADD"] =
[[
				<Property name="Rewards" value="GcGenericRewardTableEntry" _id="R_LIVING_LINK">
					<Property name="Id" value="R_LIVING_LINK" />
							...
							<Property name="List" value="GcRewardTableItem" _index="0">
								...
								<Property name="Reward" value="GcRewardSpecificTech">
									<Property name="GcRewardSpecificTech">
										<Property name="TechId" value="S22_LINK" />
