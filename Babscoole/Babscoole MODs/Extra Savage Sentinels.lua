                    ...
                    {
                        {
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                ...
                                {"CorruptedDroneRepairInteruptCooldownTime", 3},
                            }
                        },
                        {
                        ...
                        },
                        {
                            ["PRECEDING_FIRST"] = "TRUE",
                            ["PRECEDING_KEY_WORDS"] = {"DroneControlData"},
                            ["SPECIAL_KEY_WORDS"] = {"Id", "STONE FLOATER"},
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"SpinAttackCooldown",        4},
                                {"SpinAttackHomingStrength",  25},
                                {"SpinAttackDamageRadius",    4},
                                {"MeleeAttackWindUpTime",     0.7},
                                {"MeleeAttackDamageRadius",   2},
                                {"MeleeAttackHomingStrength", 15},
                                {"MeleeAttackMaxTime",        10},
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                ...
                                {"ProjectileFireInterval", 0.03},
                                {"ProjectileNumShotsMin",  45},
                                {"ProjectileNumShotsMax",  75},
                                {"IdealRange",             20},
                                {"MinRange",               10},
                                {"MaxRange",               70},
                            }
                        ...
                        },
                        {
                            ...
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"ProjectileSpread",       0.07},
                                {"ProjectileFireInterval", 0.03},
                                {"ProjectileNumShotsMin",  50},
                                {"ProjectileNumShotsMax",  70},
                                {"CooldownTimeMin",        2},
                                {"CooldownTimeMax",        4},
                                {"IdealRange",             8},
                                {"MinRange",               1},
                        ...
                        {
                            ["SPECIAL_KEY_WORDS"] = {"Id", "RUINMECH_GREN"},
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"ProjectilesPerShot",        3},
                                {"ProjectileSpread",          0.5},
                                {"ProjectileFireInterval",    0.2},
                                {"ProjectileNumShotsMin",     1},
                                {"ProjectileNumShotsMax",     3},
                                {"MinRange",                  20},
                                {"MaxRange",                  60},
                                {"ProjectileExplosionRadius", 0.5}
                            }
                        },
                        {
                            ["SPECIAL_KEY_WORDS"] = {"Id", "RUINMECHLASER"},
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"ProjectileSpread",       0},
                                {"ProjectileFireInterval", 0.1},
                                {"LaserFireTimeMin",       4.5},
                                {"LaserFireTimeMax",       7},
                                {"CooldownTimeMin",        5},
                                {"CooldownTimeMax",        10},
                                {"ProjectileNumShotsMin",  4},
                                {"ProjectileNumShotsMax",  8},
                                {"MinRange",               5},
                                {"MaxRange",               50}
                            }
                        },
                        {
                            ["SPECIAL_KEY_WORDS"] = {"Id", "STONEGRENADE"},
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                {"NumProjectiles",   1},
                                {"ProjectileSpread", 0},
