      ...
      ["MBIN_CHANGE_TABLE"] =
      {
        ...
        },
        {
          ["MBIN_FILE_SOURCE"] =
          {
            ...
            "MODELS\PLANETS\CREATURES\FISH\DEEPFISHFLOCK\ENTITIES\DEEPFISHFLOCKDATA.ENTITY.MBIN",
            "MODELS\PLANETS\CREATURES\FISH\DEEPSEAFISH\ENTITIES\_DATA_1.ENTITY.MBIN",
            "MODELS\PLANETS\CREATURES\FISH\DEEPSEAFISHLARGE\ENTITIES\DEEPFISHLARGEDATA.ENTITY.MBIN",
            ...
            "MODELS\PLANETS\CREATURES\FISH\MYSTERYFISH\ENTITIES\DATA.ENTITY.MBIN",
            ...
            "MODELS\PLANETS\CREATURES\PRAWN\PRAWN\ENTITIES\PRAWNDATA.ENTITY.MBIN",
...
local Change_Table_Array = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][7]["MXML_CHANGE_TABLE"]
  ...
  Change_Table_Array[#Change_Table_Array + 1] =
  {
    ...
    ["VALUE_CHANGE_TABLE"] =
    {
      ...
      {"PetEggLayingDuration",   "0.100000"},             --Original "0.7"
