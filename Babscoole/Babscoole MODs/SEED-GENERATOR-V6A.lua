...
SELECTED_SEED_TYPES =
{
  ...
  -- "SCIENCEFRIG", "SUPPORTFRIG", "INDUSTRIALFRIG", "COMBATFRIG", "DIPLOMATICFRIG", "LIVINGFRIG", "GHOSTFRIG", "SWARMFRIG",
...
SEED_TYPE_PATH =
{
  ...
  -- ["SWARMFRIG"]="MODELS/COMMON/SPACECRAFT/SWARM/SWARMFRIGATE.SCENE.MBIN",
