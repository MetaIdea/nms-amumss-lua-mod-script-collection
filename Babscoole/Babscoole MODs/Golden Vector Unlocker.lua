REWARD_ID       = "RS_S1_SHIP"
REWARD_ICON     = "TEXTURES/UI/FRONTEND/ICONS/SPECIALSHOP/SPECIAL.EXPEDITION.SHIP01.DDS"
REWARD_TITLE    = "Golden Vector"


NMS_MOD_DEFINITION_CONTAINER =
{
["MOD_FILENAME"]    = "Golden Vector Unlocker.pak",
