...
for i=1,#Foods,1 do
    table.insert(DEFAULTREALITY_ADDING_Foods,GetDefaultReality(Foods[i]))
end
...
{
["MOD_FILENAME"]    = "Better Space Stations Sell Everything (EISS)-WOSP.pak",
