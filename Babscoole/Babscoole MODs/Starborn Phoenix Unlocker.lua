REWARD_ID       = "R_TGA_SHIP01"
REWARD_ICON     = "TEXTURES/UI/FRONTEND/ICONS/SPECIALSHOP/SPECIAL.THGASHIP.DDS"
REWARD_TITLE    = "Starborn Phoenix"


NMS_MOD_DEFINITION_CONTAINER =
{
["MOD_FILENAME"]    = "Starborn Phoenix Unlocker.pak",
