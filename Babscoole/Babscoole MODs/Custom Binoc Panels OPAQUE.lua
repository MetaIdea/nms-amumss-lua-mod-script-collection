...
local colorTable = {
  {R = 0.040, G = 0.040, B = 0.060, A = 0.9},
  {R = 0.000, G = 0.284, B = 0.706, A = 0.9},
  {R = 0.055, G = 0.792, B = 0.104, A = 0.9},
  {R = 0.675, G = 0.088, B = 0.088, A = 0.9},
  {R = 1.000, G = 0.078, B = 0.476, A = 0.9},
  {R = 1.000, G = 0.884, B = 0.000, A = 0.9},
  {R = 0.910, G = 0.431, B = 0.000, A = 0.9},
}
...
E_NOTICE = GUIF({false, [[Do you want to remove "Press E to place Custom Marker" notification?  Default = N.  Press ENTER for default value.]]},0)
