...
{
["MOD_FILENAME"]  = "_XSS_Creature_Behavior_Aggressive.pak",
                    ...
                    {
                        {
                            ...
                            ["VALUE_CHANGE_TABLE"] =
                            {
                                ...
                                {"PredatorPerceptionDistance",        "70"},
                                {"PassiveFleePlayerDistance",         "15"},
                                {"PredatorApproachTime",              "2"},
                                {"PredatorNoticePauseTime",           "1"},
                                {"PredatorChargeDist",                "17"},
                                {"PredatorChargeDistScale",           "0.5"},
                                {"FishPredatorChargeDist",            "15"},
                                {"PredatorBoredomDistance",           "120"},
                                {"PlayerPredatorBoredomDistance",     "180"},
                                {"PredatorRegainInterestTime",        "10"},
                                {"PlayerPredatorRegainInterestTime",  "1"},
                                {"PredatorRoarProbAfterHit",          "0.3"},
                                {"PredatorRoarProbAfterMiss",         "0.5"},
