...
{
["MOD_FILENAME"]  = "_FastTextView"..Version,
          ...
          {
            {
              ...
              {
                {"Delay",        "0.003000"},
                {"DefaultDelay", "0.003000"},
              }
            },
            {
              ["SPECIAL_KEY_WORDS"] =
              {
                {"Default",    "GcPunctuationDelayData"},
                {"Gek",        "GcPunctuationDelayData"},
                {"Korvax",     "GcPunctuationDelayData"},
                {"Vykeen",     "GcPunctuationDelayData"},
                {"FourthRace", "GcPunctuationDelayData"},
                {"Builders",   "GcPunctuationDelayData"},
              },
              ["PRECEDING_KEY_WORDS"] = {"PunctuationList"},
              ["ADD"] =
[[
        <Property name="PunctuationList" value="GcPunctuationDelay">
          <Property name="Punctuation" value=" " />
          <Property name="Delay" value="0.003000" />
        </Property>
        <Property name="PunctuationList" value="GcPunctuationDelay">
