          ...
          {
            {
              ...
              ["ADD"] =
[[
    <Property name="Emotes" value="GcPlayerEmote" _id="PSI_TERMINUS">
      <Property name="Title" value="Summon Terminus" />
      <Property name="ChatText" value="UI_EMOTE_CHAT_HOLO_SYSTEM" />
      <Property name="ChatUsesPrefix" value="false" />
      <Property name="EmoteID" value="PSI_TERMINUS" />
      <Property name="AnimationName" value="1H_IDLE_HOLO_01" />
      <Property name="PropData" value="GcPlayerEmotePropData">
        <Property name="Model" value="MODELS/PLANETS/BIOMES/COMMON/BUILDINGS/PARTS/COMMONPARTS/TELEPORTER_STATION.SCENE.MBIN" />
