			...
			{
				{
					...
					{ 
						{ 
							...
							[[MODELS\COMMON\ROBOTS\WALKER_COMPANION.SCENE.MBIN]],
							"REMOVE"
						}, 
					},
				},
							...
							{
								{
									...
									[[MODELS\COMMON\ROBOTS\WALKER\ENTITIES\WALKER_COMPANION.ENTITY.MBIN]],
								},
								{
									[[MODELS\COMMON\ROBOTS\WALKER\ENTITIES\CRITICAL.ENTITY.MBIN]],
									[[MODELS\COMMON\ROBOTS\WALKER\ENTITIES\WALKER_COMPANION.ENTITY.MBIN]],
								},
							}
						}
