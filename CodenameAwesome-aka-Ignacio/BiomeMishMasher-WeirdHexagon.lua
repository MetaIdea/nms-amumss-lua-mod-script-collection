...
{
["MOD_FILENAME"] 			= "_CodenameAwesome.MishMashBiomes-HEXAGON.pak",
			...
			["MBIN_CHANGE_TABLE"] 	= 
				{
					{-- ~~HEXAGON BIOME~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\HEXAGONOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\LANDMARKS\HEXAGONOBJECTSDEAD.MBIN"},
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\HEXAGONOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\OBJECTS\HEXAGONOBJECTSDEAD.MBIN"},
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\HEXAGONOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\DETAILOBJECTS\HEXAGONOBJECTSDEAD.MBIN","REMOVE"},
						},
					},
					-- Remove any irrelevant parts of these files
					{--Fix up Landmarks files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\LANDMARKS\HEXAGONOBJECTSDEAD.MBIN"
						},
					...
					{--BIG Hydro landmarks
						["MBIN_FILE_SOURCE"] 	= {
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\LANDMARKS\HEXAGONOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\LANDMARKS\BIGHEXAGONOBJECTSDEAD.MBIN"}
						},
					},
					{
						["MBIN_FILE_SOURCE"] 	= {
						"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\LANDMARKS\BIGHEXAGONOBJECTSDEAD.MBIN"
						},
						["EXML_CHANGE_TABLE"] 	= -- Remove everything but Objects>Landmarks
						{
							{--Scale
					...
					{--Fix up Objects files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\OBJECTS\HEXAGONOBJECTSDEAD.MBIN",
						},
					...
					{--Fix up DetailObjects files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\DETAILOBJECTS\HEXAGONOBJECTSDEAD.MBIN",
						},		   
					...
					{-- ~~BONUS OBJECTS~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\LANDMARKS\HEXAGONOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\BONUSOBJECTS\HEXAGONOBJECTSDEAD.MBIN"},
						},
					},
					{-- ~~BONUS OBJECTS~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\BONUSOBJECTS\HEXAGONOBJECTSDEAD.MBIN",
						},
						["EXML_CHANGE_TABLE"] =
						{
					...
					{--Create Mish Mash HEXAGON Biome File
						["MBIN_FILE_SOURCE"] 	= {{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\HEXAGONBIOME.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\MISHMASHHEXAGONBIOME.MBIN","REMOVE"}}
					},
					{--Update Object Lists
						["MBIN_FILE_SOURCE"] 	= {"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\HEXAGON\MISHMASHHEXAGONBIOME.MBIN"},
						["EXML_CHANGE_TABLE"] 	=
						{
...
[[	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/HEXAGON/LANDMARKS/HEXAGONOBJECTSDEAD.MBIN" />
		</Property>
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/HEXAGON/LANDMARKS/BIGHEXAGONOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>
	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/HEXAGON/OBJECTS/HEXAGONOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>
	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/HEXAGON/DETAILOBJECTS/HEXAGONOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>]],
