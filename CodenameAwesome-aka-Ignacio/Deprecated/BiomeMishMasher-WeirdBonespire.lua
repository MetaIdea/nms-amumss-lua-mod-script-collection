...
{
["MOD_FILENAME"] 			= "_CodenameAwesome.MishMashBiomes-BONESPIRE.pak",
			...
			["MBIN_CHANGE_TABLE"] 	= 
				{
					{-- ~~BONESPIRE BIOME~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\BONESPIREOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\LANDMARKS\BONESPIREOBJECTSDEAD.MBIN"},
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\BONESPIREOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\OBJECTS\BONESPIREOBJECTSDEAD.MBIN"},
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\BONESPIREOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\DETAILOBJECTS\BONESPIREOBJECTSDEAD.MBIN","REMOVE"},
						},
					},
					-- Remove any irrelevant parts of these files
					{--Fix up Landmarks files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\LANDMARKS\BONESPIREOBJECTSDEAD.MBIN"
						},
					...
					{--BIG Hydro landmarks
						["MBIN_FILE_SOURCE"] 	= {
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\LANDMARKS\BONESPIREOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\LANDMARKS\BIGBONESPIREOBJECTSDEAD.MBIN"}
						},
					},
					{
						["MBIN_FILE_SOURCE"] 	= {
						"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\LANDMARKS\BIGBONESPIREOBJECTSDEAD.MBIN"
						},
						["EXML_CHANGE_TABLE"] 	= -- Remove everything but Objects>Landmarks
						{
							{--Scale
					...
					{--Fix up Objects files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\OBJECTS\BONESPIREOBJECTSDEAD.MBIN",
						},
					...
					{--Fix up DetailObjects files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\DETAILOBJECTS\BONESPIREOBJECTSDEAD.MBIN",
						},		   
					...
					{-- ~~BONUS OBJECTS~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\LANDMARKS\BONESPIREOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\BONUSOBJECTS\BONESPIREOBJECTSDEAD.MBIN"},
						},
					},
					{-- ~~BONUS OBJECTS~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\BONUSOBJECTS\BONESPIREOBJECTSDEAD.MBIN",
						},
						["EXML_CHANGE_TABLE"] =
						{
					...
					{--Create Mish Mash BONESPIRE Biome File
						["MBIN_FILE_SOURCE"] 	= {{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\BONESPIREBIOME.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\MISHMASHBONESPIREBIOME.MBIN","REMOVE"}}
					},
					{--Update Object Lists
						["MBIN_FILE_SOURCE"] 	= {"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\BONESPIRE\MISHMASHBONESPIREBIOME.MBIN"},
						["EXML_CHANGE_TABLE"] 	=
						{
...
[[	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/BONESPIRE/LANDMARKS/BONESPIREOBJECTSDEAD.MBIN" />
		</Property>
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/BONESPIRE/LANDMARKS/BIGBONESPIREOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>
	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/BONESPIRE/OBJECTS/BONESPIREOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>
	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/BONESPIRE/DETAILOBJECTS/BONESPIREOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>]],
