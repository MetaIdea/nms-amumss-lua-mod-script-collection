...
{
["MOD_FILENAME"] 			= "_CodenameAwesome.MishMashBiomes-MSTRUCTURES.pak",
			...
			["MBIN_CHANGE_TABLE"] 	= 
				{
					{-- ~~MSTRUCT BIOME~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\MSTRUCTOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\LANDMARKS\MSTRUCTOBJECTSDEAD.MBIN"},
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\MSTRUCTOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\OBJECTS\MSTRUCTOBJECTSDEAD.MBIN"},
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\MSTRUCTOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\DETAILOBJECTS\MSTRUCTOBJECTSDEAD.MBIN","REMOVE"},
						},
					},
					-- Remove any irrelevant parts of these files
					{--Fix up Landmarks files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\LANDMARKS\MSTRUCTOBJECTSDEAD.MBIN"
						},
					...
					{--BIG Hydro landmarks
						["MBIN_FILE_SOURCE"] 	= {
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\LANDMARKS\MSTRUCTOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\LANDMARKS\BIGMSTRUCTOBJECTSDEAD.MBIN"}
						},
					},
					{
						["MBIN_FILE_SOURCE"] 	= {
						"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\LANDMARKS\BIGMSTRUCTOBJECTSDEAD.MBIN"
						},
						["EXML_CHANGE_TABLE"] 	= -- Remove everything but Objects>Landmarks
						{
							{--Scale
					...
					{--Fix up Objects files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\OBJECTS\MSTRUCTOBJECTSDEAD.MBIN",
						},
					...
					{--Fix up DetailObjects files
						["MBIN_FILE_SOURCE"] 	= {
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\DETAILOBJECTS\MSTRUCTOBJECTSDEAD.MBIN",
						},		   
					...
					{-- ~~BONUS OBJECTS~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\LANDMARKS\MSTRUCTOBJECTSDEAD.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\BONUSOBJECTS\MSTRUCTOBJECTSDEAD.MBIN"},
						},
					},
					{-- ~~BONUS OBJECTS~~
						["MBIN_FILE_SOURCE"] 	= {--First copy all the files into three or four different folders (DistantObjects,Landmarks,Objects,DetailObjects).
							"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\BONUSOBJECTS\MSTRUCTOBJECTSDEAD.MBIN",
						},
						["EXML_CHANGE_TABLE"] =
						{
					...
					{--Create Mish Mash MSTRUCT Biome File
						["MBIN_FILE_SOURCE"] 	= {{"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\MSTRUCTBIOME.MBIN","METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\MISHMASHMSTRUCTBIOME.MBIN","REMOVE"}}
					},
					{--Update Object Lists
						["MBIN_FILE_SOURCE"] 	= {"METADATA\SIMULATION\SOLARSYSTEM\BIOMES\WEIRD\MSTRUCTURES\MISHMASHMSTRUCTBIOME.MBIN"},
						["EXML_CHANGE_TABLE"] 	=
						{
...
[[	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/MSTRUCTURES/LANDMARKS/MSTRUCTOBJECTSDEAD.MBIN" />
		</Property>
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/MSTRUCTURES/LANDMARKS/BIGMSTRUCTOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>
	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/MSTRUCTURES/OBJECTS/MSTRUCTOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>
	<Property value="GcExternalObjectListOptions.xml">
	  ...
	  <Property name="Options">
		<Property value="NMSString0x80.xml">
		  <Property name="Value" value="METADATA/SIMULATION/SOLARSYSTEM/BIOMES/WEIRD/MSTRUCTURES/DETAILOBJECTS/MSTRUCTOBJECTSDEAD.MBIN" />
		</Property>
	  </Property>
	</Property>]],
