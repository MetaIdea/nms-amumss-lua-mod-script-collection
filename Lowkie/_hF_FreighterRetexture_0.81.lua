...
{
["MOD_FILENAME"]	= "_hF_FreighterRetexture_0.81.pak",
			...
			{ 
				...
				},
				{
					["MBIN_FILE_SOURCE"] 	= 
					{
						...
						"MODELS/COMMON/SPACECRAFT/INDUSTRIAL/FREIGHTERTINY_PROC/HANGARA_EXTERIOR/FREIGHTERPROC_MAT.MATERIAL.MBIN",
					},	
					["EXML_CHANGE_TABLE"] 	= 
					{
						{								
				...
				},
				{
					...
					{
						{								
							["SPECIAL_KEY_WORDS"] = {"Name", "Diffuse", "Name", "NORMAL"},
							["VALUE_CHANGE_TABLE"]	= {
								{ "Diffuse",  DIFFUSES1X }, --Original "TEXTURES/COMMON/SPACECRAFT/INDUSTRIAL/SHARED/DECALS/SMALL_STRIPES.BASE.DOUBLEX.DDS"								
							}
						}
					}
				},
				{
					["MBIN_FILE_SOURCE"] 	= 
					{
						"TEXTURES/COMMON/SPACECRAFT/INDUSTRIAL/SHARED/DECALS/STRIPLE_SINGLE.TEXTURE.MBIN",
					},	
					["EXML_CHANGE_TABLE"] 	= 
					{
						{								
							["SPECIAL_KEY_WORDS"] = {"Name", "Diffuse", "Name", "NORMAL"},
							["VALUE_CHANGE_TABLE"]	= {
								{ "Diffuse",  DIFFUSES2X }, --Original "TEXTURES/COMMON/SPACECRAFT/INDUSTRIAL/SHARED/DECALS/STRIPE_SINGLE.BASE.SPLITX.DDS"								
							}
						}
					},
					{
						{								
							["SPECIAL_KEY_WORDS"] = {"Name", "Diffuse", "Name", "NORMAL"},
							["VALUE_CHANGE_TABLE"]	= {
								{ "Diffuse",  DIFFUSES3X }, --Original "TEXTURES/COMMON/SPACECRAFT/INDUSTRIAL/SHARED/DECALS/STRIPE_SINGLE.BASE.DOUBLEX.DDS"								
							}
						}
					},
					{
						{								
							["SPECIAL_KEY_WORDS"] = {"Name", "Diffuse", "Name", "NORMAL"},
							["VALUE_CHANGE_TABLE"]	= {
								{ "Diffuse",  DIFFUSES4X }, --Original "TEXTURES/COMMON/SPACECRAFT/INDUSTRIAL/SHARED/DECALS/STRIPE_SINGLE.BASE.SINGLEX.DDS"								
							}
						}
					}
				},
