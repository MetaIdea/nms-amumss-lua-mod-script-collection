	...
	{
		{
			...
			{ 
				{
					["MBIN_FILE_SOURCE"] 	= "MODELS\COMMON\SPACECRAFT\SHARED\COCKPITINTERIORS\COCKPITCHAIR\COCKPITCHAIR.SCENE.MBIN",
					["EXML_CHANGE_TABLE"] 	= 
					{
						{
							["SPECIAL_KEY_WORDS"] = { "Name", "ChairJNT" },
	...
	<Property value="TkSceneNodeData.xml">
	  ...
	  <Property name="Children" />
		...
		},
		{
			...
			{
				{
					["MBIN_FILE_SOURCE"] 	= "MODELS\COMMON\SPACECRAFT\SHARED\COCKPITINTERIORS\COCKPITCHAIR\COCKPITCHAIR\ENTITIES\COCKPITSEAT.ENTITY.MBIN",
					["EXML_CHANGE_TABLE"] 	= 
					{
						{
