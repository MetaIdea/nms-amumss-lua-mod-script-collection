...
function GetComponents(TRIGGER_ACTION, COMPONENTS)
return [[
...
if REWARDTABLE == "" then table.remove(NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"], 3) end
