...
--MODELS/PLANETS/BIOMES/TOXIC/SMALL/SMALLTOXICEGG.SCENE.MBIN
						...
						},
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"FlatDensity", 			VanillaDensity1}, --Low = lowest
						...
						},
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"FlatDensity", 			VanillaDensity2}, --Low = lowest
...
{
["MOD_FILENAME"] 			= "LASAGNA_Env_Low_v6.0h.pak",
...
--------------------------------------------------------------------------------------------------------------------------------------------------
				{
					...
					["EXML_CHANGE_TABLE"] 	=  BiomesNewVanilla(0.9, 0.7)
				},
...

				{
					...
					["EXML_CHANGE_TABLE"] 	=  BiomesNewVanilla(0.7, 0.5)---------------------------Lower density
				},
...
--------------------------------------------------------------------------------------------------------------------------------------------------

				{
					["MBIN_FILE_SOURCE"] 	= 
					{
						...
						{"CUSTOMBIOMES/DEAD/GHOSTLYDEAD25.MBIN","CUSTOMBIOMES/FLOAT/GHOSTLYDEAD25.MBIN"},
