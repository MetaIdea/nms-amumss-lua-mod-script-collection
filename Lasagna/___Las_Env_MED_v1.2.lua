...
["MOD_FILENAME"] 			= "___Las_Env_MED_v1.2.pak",
			...
			{ 
				...
				--Copy vanilla files to custombiomes folder
				{
					...
					["EXML_CHANGE_TABLE"] 	= {
						...
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","Objects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddObjectProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/SMALLCRYSTAL.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 40, 1.6, 2, 0.9, 1.1, 0.9, 5, 180, 0, 0, "TRUE", "TRUE", "FALSE", "FALSE", 0.2, 0.5, 0, 3), }, --## 3d_biome_obj
					...
					["EXML_CHANGE_TABLE"] 	= {
						...
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","Objects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddObjectProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/CRYSTAL.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 60, 1.6, 70, 1, 1, 0.75, 45, 180, 0, -2, "TRUE", "TRUE", "FALSE", "FALSE", 0.295, 0.0059, 0.0059, 2), }, --## 3d_biome_obj
					...
					["EXML_CHANGE_TABLE"] 	= {
						{ ["PRECEDING_KEY_WORDS"] = {"Objects",}, ["ADD"] = replaceObjects, ["ADD_OPTION"]  = "ADDafterSECTION", },
						{ ["PRECEDING_KEY_WORDS"] = {"Objects",}, ["REMOVE"] = "SECTION" },
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","DistantObjects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddDistantProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/CRYSTAL.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 60, 1, 19, 0.9, 1.1, 0.75, 0, 180, -3, -4, "TRUE", "TRUE", "TRUE", "FALSE", 0.118, 0.33, 0, 3), }, --## 3b_biome_dist
					...
					["EXML_CHANGE_TABLE"] 	= {
						...
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","Objects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddObjectProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/SMALLCRYSTAL.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 40, 1.5, 2.4, 0.9, 1.1, 0.5, 45, 180, 0, 0, "TRUE", "TRUE", "FALSE", "FALSE", 0.25, 0.0042, 0.0042, 1), }, --## 3d_biome_obj
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","DetailObjects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddGrassProp("MODELS/PLANETS/BIOMES/COMMON/GRASS/LONGALTGRASS.SCENE.MBIN", "FLORACLUMP", 1, 128, 0, 180, 1.5, 4.375, 1, 1.2, 0, 0, 180, 0, 0, "TRUE", "TRUE", "FALSE", "TRUE", 0.4, 0.01, 0.008, 1), }, --## 3e_biome_detail
					}, }, --## 3f_biome_end
					...
					["EXML_CHANGE_TABLE"] 	= {
						...
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","DetailObjects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddRockProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/CRYSTALTINY.SCENE.MBIN", "GRASS", -1, 128, 0, 75, 0.9, 1.1, 1, 1, 0.1, 0, 180, 0, 0, "TRUE", "TRUE", "FALSE", "FALSE", 1, 0.05, 0.05, 3), }, --## 3e_biome_detail
					}, }, --## 3f_biome_end
					...
					["EXML_CHANGE_TABLE"] 	= {
						{ ["PRECEDING_KEY_WORDS"] = {"Objects",}, ["ADD"] = replaceObjects, ["ADD_OPTION"]  = "ADDafterSECTION", },
						{ ["PRECEDING_KEY_WORDS"] = {"Objects",}, ["REMOVE"] = "SECTION" },
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","DistantObjects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddDistantProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/CRYSTAL.SCENE.MBIN", "FLORACLUMP", -128, -25, 0, 30, 1.28, 2, 0.9, 1.1, 0, 45, 180, -3, -4, "TRUE", "TRUE", "TRUE", "FALSE", 0.25, 0.0064, 0.01, 1.5), }, --## 3b_biome_dist
					...
					["EXML_CHANGE_TABLE"] 	= {
						{ ["PRECEDING_KEY_WORDS"] = {"Objects",}, ["ADD"] = replaceObjects, ["ADD_OPTION"]  = "ADDafterSECTION", },
						{ ["PRECEDING_KEY_WORDS"] = {"Objects",}, ["REMOVE"] = "SECTION" },
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","DistantObjects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddDistantProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/CRYSTAL.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 60, 1.6, 70, 1, 1, 0.75, 45, 180, -3, -4, "TRUE", "TRUE", "TRUE", "FALSE", 0.295, 0.0059, 0.0059, 2), }, --## 3b_biome_dist
					...
					["EXML_CHANGE_TABLE"] 	= {
						...
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","Landmarks",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddLandmarkProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/CRYSTAL.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 60, 1, 19, 1, 1, 0.75, 0, 180, 0, -2, "TRUE", "TRUE", "FALSE", "FALSE", 0.118, 0.33, 0, 3), }, --## 3c_biome_landm
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","Objects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddObjectProp("MODELS/PLANETS/BIOMES/IRRADIATED/MEDIUM/MEDIUMROCK.SCENE.MBIN", "ROCKCLUMP", -1, 128, 0, 90, 0.8, 2, 1, 1, 0.3, 0, 360, 0, 0, "TRUE", "TRUE", "FALSE", "FALSE", 0, 0.016, 0, 3), }, --## 3d_biome_obj
					...
					["EXML_CHANGE_TABLE"] 	= {
						...
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","Objects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddObjectProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/SMALLCRYSTAL.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 40, 2.4, 3, 0.9, 1.1, 0.9, 5, 180, 0, 0, "TRUE", "TRUE", "FALSE", "FALSE", 0.2, 0.45, 0, 3), }, --## 3d_biome_obj
