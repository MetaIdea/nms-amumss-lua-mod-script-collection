...
-------------------------------------------------------------------------------------------------------------------------------------------------
-- The goal of this modification is to increase LOD, preserve performance, and maintain or increase immersive atmosphere
-- Removed all 90 degree angle placement to increase performance (less grass to draw)
-- Removed all additional added grass to increase performance
-- Slightly increases MaxRegionRadius and MaxImposterRadius from 1.8 to 2.0
-- Slightly increases FadeOutStart and EndDistance from 1.8 to 2.0
-- Slightly decreases coverage of numerous grasses to increase performance
...
-- Reduces MaxScale for immersion in VR, high grass is disorienting and prevents player from being able to see
						...
						--MULTIPLY:
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								...
								{"SlopeDensity",			0.35},
								{"MaxRegionRadius",			2.0},
								{"MaxImposterRadius",		2.0},
								{"FadeOutStartDistance",	2.0},
								{"FadeOutEndDistance",		2.0},
								{"MaxScale", 				1.35},
							}
						},
						{
						...
						},
						{
							...
							{ 
								...
								{"FadeOutStartDistance",	2.0},
								{"FadeOutEndDistance",		2.0},
								{"MaxScale", 				1.35}, 	--Too large = above eye level
							}
						},
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"Coverage",			    0.14}, 	--Too much = weird faded lod in distance
