...
Change the above to one of the following to get a different mod version (changes density)
...
local title = "ForestRealm_"..modName.."_v1.0p.pak"
...
function AddTrees(treeNum, giantNum)
	...
	--Add num tree props
	for z = 1, treeNum do
		forestProp = forestProp .. AddForestProp(1,7, Placement, 1, 8, MinScale, MaxScale)
		forestProp = forestProp .. AddForestProp(1,7, Placement, 2, 8, MinScale, MaxScale)
	end
	...
	if odds == 1 then
		...
		for z = 1, 1 do
			forestProp = forestProp .. AddForestProp(2,2, FreqObjPlacement, 1, 3, MinScaleBig, MaxScaleBig)
		end
	end
...
function AddRocks(rockNum)
	...
	--Add num small-med-large prop
	for y = 1, rockNum do
		rockProp = rockProp .. AddRockProp(0.032)
	end
...
function AddForestProp(minIt, maxIt, placem, placeStartI, placeEndI, minSc, maxSc)

	local densityMed = Density[math.random(1, 7)]
...
return [[
      <Property value="GcObjectSpawnData.xml">
        ...
        <Property name="Type" value="Instanced" />
        <Property name="Resource" value="GcResourceElement.xml">
          <Property name="Filename" value="]] .. MedObjPath[math.random(1, 87)] .. [[.SCENE.MBIN" />
          <Property name="ResHandle" value="GcResource.xml">
            <Property name="ResourceID" value="0" />
          </Property>
          <Property name="Seed" value="GcSeed.xml">
...
return [[
      <Property value="GcObjectSpawnData.xml">
        ...
        <Property name="Type" value="Instanced" />
        <Property name="Resource" value="GcResourceElement.xml">
          <Property name="Filename" value="]] .. DetailPropPath[math.random(1, 15)] .. [[.SCENE.MBIN" />
          <Property name="ResHandle" value="GcResource.xml">
            <Property name="ResourceID" value="0" />
          </Property>
          <Property name="Seed" value="GcSeed.xml">
