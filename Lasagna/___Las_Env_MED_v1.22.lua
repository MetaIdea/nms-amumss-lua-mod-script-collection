...
if maxScale > 4 and string.lower(isFloatingIsland) == "false" then --it's a big prop and is not an island, make it so it won't disappear
	propType = "Single"
	maxRaise = 0
	maxLower = 0
...
if maxScale > 5 and string.lower(isFloatingIsland) == "false" then
	propType = "Single"
	maxRaise = 0
	maxLower = 0
	isFloatingIsland = "TRUE"
...
["MOD_FILENAME"] 			= "___Las_Env_MED_v1.22.pak",
