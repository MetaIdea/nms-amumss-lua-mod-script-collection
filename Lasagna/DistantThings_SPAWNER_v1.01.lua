...
"Proof of concept" LUA, not needed to run DistantThings.
...
["MOD_FILENAME"] 			= "DistantThings_SPAWNER_v1.01.pak",
				...
				
				{
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						--## 12_biome_tiletype_options
						{
							["PRECEDING_KEY_WORDS"] = { "Options", },
							["ADD_OPTION"] 	= "ADDafterLINE",
							["ADD"] = addBiomeOptions("METADATA/SIMULATION/SOLARSYSTEM/BIOMES/FROZEN/FROZENHQOBJECTSMID.MBIN"),
						},
					} --## 10_each_biome_start
				},
