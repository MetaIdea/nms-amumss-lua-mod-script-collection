...
["MOD_FILENAME"] 			= "___Las_Ground_Detail_v1.2.pak",
			...
			{ 
				...
				--Copy vanilla files to custombiomes folder
				{
					...
					["EXML_CHANGE_TABLE"] 	= {
						...
						{ ["PRECEDING_KEY_WORDS"]	= {"Objects","DetailObjects",}, ["ADD_OPTION"] 	= "ADDafterLINE", ["ADD"] = AddRockProp("MODELS/PLANETS/BIOMES/WEIRD/HOUDINIPROPS/CRYSTALTINY.SCENE.MBIN", "FLORACLUMP", -1, 128, 0, 45, 1.5, 3, 0.9, 1.1, 0.5, 20, 180, 0, 0, "TRUE", "TRUE", "FALSE", "FALSE", 0.3, 0.05, 0.05, 3), }, --## 3e_biome_detail
