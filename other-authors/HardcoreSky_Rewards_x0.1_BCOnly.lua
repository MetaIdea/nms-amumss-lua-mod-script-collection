...
NMS_MOD_DEFINITION_CONTAINER =
{
  ...
  MOD_DESCRIPTION = "Reduce global rewards by 90% (except Quicksilver) and restrict all module drops to class B or C only (no A/S). Forces Illegal & Sentinel modules to C-class. Includes 0->1 clamp to avoid zero-reward bug.",
  MODIFICATIONS   =
  {{
    MBIN_CHANGE_TABLE =
    {
