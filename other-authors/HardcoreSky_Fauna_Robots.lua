local MOD_NAME     = "HardcoreSky_Fauna_Robots"
...
NMS_MOD_DEFINITION_CONTAINER = {
  ...
  MOD_DESCRIPTION = "Fauna overhaul: every system spawns ROBOT ground creatures only. Works in normal and abandoned systems.",
  MODIFICATIONS   = {{
