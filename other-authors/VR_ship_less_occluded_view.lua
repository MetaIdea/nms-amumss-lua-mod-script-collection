	...
	{
		{
			MBIN_CHANGE_TABLE = 
				...
				--Ceiling
							...
							--},
							{
								SPECIAL_KEY_WORDS = {"Name", "SUB2CeilingTop","Name", "MATERIAL"}, 	--changing ceiling texture to transparent one, so that "SUB1CeilingTop" and "SUB2CeilingTop" could stay
								VALUE_CHANGE_TABLE =
								{
							...
							--{
							--	SPECIAL_KEY_WORDS = {"Name", "RightCeilingFront","Name", "MATERIAL"},	--changing texture to transparent one
							--	VALUE_CHANGE_TABLE =
							--	{
							--		{"Value", "MODELS\COMMON\SPACECRAFT\S-CLASS\BIOPARTS\INTERIOR\CANOPYA_INTERIOR\BIOSHIPFLASHINNERMAT.MATERIAL.MBIN"} --
							--	}
							...
							--{
							--	SPECIAL_KEY_WORDS = {"Name", "LeftCeilingFront","Name", "MATERIAL"},	--changing texture to transparent one
							--	VALUE_CHANGE_TABLE =
							--	{
							--		{"Value", "MODELS\COMMON\SPACECRAFT\S-CLASS\BIOPARTS\INTERIOR\CANOPYA_INTERIOR\BIOSHIPFLASHINNERMAT.MATERIAL.MBIN"} --
							--	}
				...
				--Floor
							...
							--},
							{
								SPECIAL_KEY_WORDS = {"Name", "Floor","Name", "MATERIAL"}, --changing floor texture to transparent one, so that "SUB1Floor" could stay	
								VALUE_CHANGE_TABLE =
								{
									{"Value", "MODELS\COMMON\SPACECRAFT\S-CLASS\BIOPARTS\INTERIOR\CANOPYA_INTERIOR\BIOSHIPFLASHINNERMAT.MATERIAL.MBIN"} --
								}
				...
				--Dashboards
							--{
							--	SPECIAL_KEY_WORDS = {"Name", "CenterShape","Name", "MATERIAL"},	--central dashboard
							--	VALUE_CHANGE_TABLE =
							--	{
							--		{"Value", "MODELS\COMMON\SPACECRAFT\S-CLASS\BIOPARTS\INTERIOR\CANOPYA_INTERIOR\BIOSHIPFLASHINNERMAT.MATERIAL.MBIN"} --
							--	}
							...
							--{
							--	SPECIAL_KEY_WORDS = {"Name", "RightDash","Name", "MATERIAL"},
							--	VALUE_CHANGE_TABLE =
							--	{
							--		{"Value", "MODELS\COMMON\SPACECRAFT\S-CLASS\BIOPARTS\INTERIOR\CANOPYA_INTERIOR\BIOSHIPFLASHINNERMAT.MATERIAL.MBIN"} --
							--	}
							...
							--{
							--	SPECIAL_KEY_WORDS = {"Name", "LeftDash","Name", "MATERIAL"},
							--	VALUE_CHANGE_TABLE =
							--	{
							--		{"Value", "MODELS\COMMON\SPACECRAFT\S-CLASS\BIOPARTS\INTERIOR\CANOPYA_INTERIOR\BIOSHIPFLASHINNERMAT.MATERIAL.MBIN"} --
							--	}
				...
				--Planet Flight flame effects
							...
							--{	
							--	SPECIAL_KEY_WORDS = {"Name", "AtmosphereEffectTop"},		--removed in newer game versions
							--	REMOVE = "SECTION",
							--},
							...
							{	
								SPECIAL_KEY_WORDS = {"Name", "RightShell1"},		--
								REMOVE = "SECTION",
							},
							{	
								SPECIAL_KEY_WORDS = {"Name", "LeftShell1"},		--
								REMOVE = "SECTION",
							},
						},	
					},	
