	...
	},
	{
		...
		},
		{
			...
			{--MEDBOUNTY2
				...
				{
					{"Spread",	100,		100},
					{"Count",	4,			12}		--1,		1		(4,			12)	(in the original mod, it seems these entries accidentally changed the "Scale" for MEDBOUNTY2 instead of changing the "Spread")
				}
			},
			{--HARDBOUNTY1
				{
