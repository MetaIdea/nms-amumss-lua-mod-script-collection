...
UNITS_MULTI				= 1		-- Default value is 1 | Multiplys the amount of units you get
LOW_UNITS_MULTI			= 5	-- Default value is 1 | Terminals and other unit sources that have really low unit rewards (90 - 2000 units)
								-- are multiplied by this number on top of the regular unit multiplier (so by default = 5 * 10 = 50x multiplier)
								
NANITES_MULTI			= 1		-- Default value is 1 | Multiplys the amount of nanites you get
...
MISSION_UNITS_MULTI		= 2		-- Default value is 1 | Multiplys the amount of units you get from Mission Board (Space Station) Missions
MISSION_NANITES_MULTI	= 4		-- Default value is 1 | Multiplys the amount of nanites you get from Mission Board (Space Station) Missions

NEXUS_UNITS_MULTI		= 2		-- Default value is 1 | Multiplys the amount of units you get from Nexus Missions
NEXUS_NANITES_MULTI		= 4		-- Default value is 1 | Multiplys the amount of nanites you get from Nexus Missions

BOUNTY_UNITS_MULTI		= 2		-- Default value is 1 | Multiplys the amount of units you get from Bounty Board Missions (Pirate or outlaw run Space Stations)
BOUNTY_NANITES_MULTI	= 4		-- Default value is 1 | Multiplys the amount of nanites you get from Bounty Board Missions (Pirate or outlaw run Space Stations)
...
{
["MOD_FILENAME"] 	= "GunnerRev_BetterRewardsNoWR",
["MOD_BATCHNAME"]	= "GunnerRev_BetterRewardsNoWR",
["MOD_AUTHOR"]		= "MrTrack",
["NMS_VERSION"]		= "6.21",
