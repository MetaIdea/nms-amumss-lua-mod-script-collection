...
local AUTO_TRANSLATE_CHANCE = 0.95    -- 95% chance (was 33%)

NMS_MOD_DEFINITION_CONTAINER = {
    ["MOD_FILENAME"] = string.format("Auto Translate Words %s.%s", NMS_VERSION, MOD_VERSION),
    ["MOD_AUTHOR"] = "NilOutput",
    ["LUA_AUTHOR"] = "NilOutput",
    ["MOD_DESCRIPTION"] = "Dramatically increases the chance to automatically translate alien words without needing to learn them first.",
