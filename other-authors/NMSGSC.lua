    ...
    {
        {
          ...
          {
            {
              ["SPECIAL_KEY_WORDS"] = {"TradeSettings", "GcTradeSettings", "SuitTechSpecialist", "GcTradeData"},
  ...
  local RequirementsString = ""
    ...
    <Property name="Table" value="GcProductData">
      ...
      <Property name="Colour">
        <Property name="R" value="0.100000" />
        <Property name="G" value="0.100000" />
      ...
      <Property name="NormalisedValueOnWorld" value="5.12179504E-05" />
      <Property name="NormalisedValueOffWorld" value="5.12179504E-05" />
      ...
      <Property name="EconomyInfluenceMultiplier" value="1.000000" />
...
function CreateConsumableTableEntry(NewCTEID, NewCTERewardID)
    ...
    <Property name="Table" value="GcConsumableItem">
      ...
      <Property name="RequiresCanAffordCost" value="" />
...
function CreateSpecialsShopEntry(NewSSID)
  return
  [[
    <Property name="Table" value="GcPurchaseableSpecial">
...
local AddToSpecialShop  = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][4]["MXML_CHANGE_TABLE"]
...
local AddToDefaultSaveData = NMS_MOD_DEFINITION_CONTAINER["MODIFICATIONS"][1]["MBIN_CHANGE_TABLE"][5]["MXML_CHANGE_TABLE"]
local CITETable                 = {}
local RewardTable               = {}
