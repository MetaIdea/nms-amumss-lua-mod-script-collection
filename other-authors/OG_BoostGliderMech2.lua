...
{
["MOD_FILENAME"] 			= "OG_BoostGliderMechAI2.pak",
["MOD_AUTHOR"]		        = "OTBP",
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						},
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								...
								{"CenterMaxSpring",					"10"},
								{"CenterMaxSpeed",					"5"},
								--{"VelocityAnticipate",				"0.017"},
								--{"VelocityAnticipateSpringSpeed",	"1"},
								--{"VertMaxSpring",					"8"},
								--{"CenterStartSpeed",				"0.15"},
								--{"LookStickLimitAngle",				"16"},		--Oribital	"20"	View L/R U/D of interior of Cockpit
								--{"PushForwardDropoffLR",			"0.2"},
								--{"PushForwardDropoffUD", 			"0"},		--	Oribital "0.2"
							}
						},
						{
