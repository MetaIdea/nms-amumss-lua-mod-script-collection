NMS_MOD_DEFINITION_CONTAINER = {
	...
	-- v1.8: bays A and B collision radius 1.226539 -> 0.226539 (leftover test value)
	MOD_FILENAME 		= 'Jank7.Exterior_Ramp_Control_B_v1.8',
	MOD_BATCHNAME 		= 'Jank7_Ultimate_Landing_Bays_B_v2.0',
	MOD_AUTHOR			= 'Jank7',
	NMS_VERSION			= '7.03',
