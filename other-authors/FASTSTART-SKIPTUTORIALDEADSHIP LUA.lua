...
{
["MOD_FILENAME"] 			    = "FastStart-VANILLA DEAD SHIP.pak",
["MOD_DESCRIPTION"]		    = "Skip Intro and Tutorial- DEAD SHIP at START",
    ...
    },
		{
				 ...
				 },
         {
          ...
          ["EXML_CHANGE_TABLE"]  =
           {
             {
             ["PRECEDING_KEY_WORDS"] = "ShipInventory",
             ["SPECIFIC_KEY_WORDS"]  = "LAUNCHER",
             ["LINE_OFFSET"] = "+6",
             ["REMOVE"] =  "LINE",
             },
             {
