...
CLASS_MINING = "Estrazione"
CLASS_TRADE = "Commercio"
CLASS_MANUFACT = "Produzione"
CLASS_ALLOY = "Materiale avanzato"
CLASS_SCIENCE = "Scientifico"
CLASS_POWER = "Produzione di energia"

NMS_MOD_DEFINITION_CONTAINER = 
{
  ["MOD_FILENAME"] 			= "NEN_Italian_everything_AMUMSS.pak",
	...
	{
		{
			...
			{ 
				{
					["MBIN_FILE_SOURCE"] 	= "LANGUAGE/NMS_UPDATE3_ITALIAN.MBIN",
					["EXML_CHANGE_TABLE"] = 
					{
						-- ECONOMY LEVEL
