local MOD_NAME     = "HardcoreSky_Fauna_Alien"
...
NMS_MOD_DEFINITION_CONTAINER = {
  ...
  MOD_DESCRIPTION = "Fauna overhaul: every system (normal and abandoned) spawns ALIEN ground creatures only.",
  MODIFICATIONS   = {{
