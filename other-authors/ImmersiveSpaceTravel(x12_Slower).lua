NMS_MOD_DEFINITION_CONTAINER = {
    MOD_FILENAME    = "ImmersiveSpaceTravel(x12_Slower)",
            ...
            MBIN_CHANGE_TABLE = {
                {
                    ...
                    MXML_CHANGE_TABLE = {
                        {
                            VALUE_CHANGE_TABLE = {
                                {"MiniWarpSpeed", "2500"},  -- default 30000
                            }
                        },
                    }
                },
                ...
                },
                {
                    ...
                    MXML_CHANGE_TABLE = {
                        {
                            VALUE_CHANGE_TABLE = {
                                {"PulseEncounterCheckTimer", "12.0"},  -- default 1.000000
                            }
                        },
                    }
                },
