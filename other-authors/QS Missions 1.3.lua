...
MB_Low_QS_Max_Amount = "50" 					-- 50 - Use the original values as a reference when editing
...
{
  ["MOD_FILENAME"] 			= "QS Missions 1.3.pak",
  ["MOD_AUTHOR"]				= "JustRuthless",
  ["LUA_AUTHOR"]				= "JustRuthless",
  ["MOD_DESCRIPTION"]		= 
  [[
  QS Missions adds quicksilver rewards to normal missions at the nexus, space station mission boards, and outlaw bounty masters.
  The mod settings are customizable in the top section of the lua script. (AMUMSS Required) 
  Changeable settings include: 
  Quicksilver / Units / Nanites min/max amounts and percentage chance of the rewards on all mission types.
  ]],
  ["NMS_VERSION"]				= "3.89",
  ["MODIFICATIONS"] 		=
	{
