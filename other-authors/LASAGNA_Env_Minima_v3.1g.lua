...
{
["MOD_FILENAME"] 			= "LASAGNA_Env_Minima_v3.1g.pak",
...
-------------------------------------------------------------------------------------------------------------------------------------------------
						...
						},
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"FlatDensity",			    DensityLowMultiplier}, --***Fixes invisible grass bug
								{"SlopeDensity",			DensityLowMultiplier}, --***Fixes invisible grass bug
								{"MaxRegionRadius",			GrassRadiusMultiplier},
								{"MaxImposterRadius",		GrassRadiusMultiplier},
								{"FadeOutStartDistance",	GrassRadiusMultiplier},
								{"FadeOutEndDistance",		GrassRadiusMultiplier},
