-- Custom Stats for No Man's Sky - MultiTool - MAX
-- Mod_Version = "0.1.2"
...
-- File Settings --
FileName    = "CustomStats_0.1.2_MT_MAX.pak"
ModAuthor   = "Elsia"
LuaAuthor   = "Elsia"
ModMaintenance = "Probably Elsia"
Description = "Change base stats for multitools to maximize their potential while respecting their type and class."
NMS_Version = "4.65"
