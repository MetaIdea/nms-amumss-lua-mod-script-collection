...
--     * x30min (facil, materiales de inicio en GRANDES cantidades): 5 JELLY + 10 RADIO1 + 250 CATALYST1
--     * x20min / x15min: ingrediente duro unico (como en v1.0)
local PROT       = 1200
local GEL_CHARGE = 150
local ING1_ID, ING1_TYPE, ING1_AMOUNT = "JELLY", "Product", 5
local ING2_ID, ING2_TYPE, ING2_AMOUNT = "RADIO1", "Substance", 10
...
NMS_MOD_DEFINITION_CONTAINER = {
  MOD_FILENAME    = "HardcoreSky_GelFedLifeSupport_x20min.zip",
  MOD_AUTHOR      = "Azunain",
  LUA_AUTHOR      = "Azunain",
  NMS_VERSION     = "7.02",
