...
{
    ["MOD_FILENAME"] = "Realistic Space Station Docking - RAF Compatible.pak",
    ["MOD_DESCRIPTION"] = "Slower and smoother space station docking, landing and takeoff. Compatible with Realistic Atmospheric Flight.",
    ["MOD_AUTHOR"] = "DrBrown5",
    ["NMS_VERSION"] = "6.45.1",
