...
{
  {
    ...
    ["Languages"] =
    {
      ...
      {Languages["USEnglish"], "Stellar Extractor: Exotic Materials", "Moar Useful Elements", "Naturally occurring in Stars, Helium is the product of the nuclear fusion of hydrogen atoms. New synthesis technologies allow for Helium to be created in refiners.", "Harvest Exotic Materials"},
  ...
  },
{
    ...
    ["Requirements"] =
    {
      ...
      ["Languages"] =
      {
        ...
        {Languages["USEnglish"], "Stellar Extractor: Gasses", "Moar Stellar Extractors", "A modified variant of the standard Stellar Extractor, this Extractor Harvests Gasses like Carbon, Di-Hydrogen, and Ammonia from matter-dense Nebulae.", "Harvest Space Gasses"},
  ...
  },
{
    ...
    ["Languages"] =
    {
      ...
      {Languages["USEnglish"], "Stellar Extractor: Metals", "Moar Stellar Extractors", "A modified variant of the standard Stellar Extractor, this Extractor Harvests Metals like Pure Ferrite, Cobalt, and Salt from matter-dense Nebulae.", "Harvest Deep Space Metals"},
    }
  },
{
    ...
    ["Languages"] =
    {
      ...
      {Languages["USEnglish"], "Stellar Extractor: Stellar Materials", "Moar Stellar Extractors", "A modified variant of the standard Stellar Extractor, this Extractor Harvests Stellar Materials like Copper, Cadmium, and Indium from matter-dense Nebulae.", "Harvest Stellar Materials"},
    }
  }
}
