--[[
  5x Industrial Waste Spawn + Specialist Hazardous Waste
  
  Increases SCRAPHEAP (waste heaps) and P_JUNK (junk piles) spawn density by ~5x.
...
--  Uses the same 5x-boosted values as P_JUNK_SMALL (PatchSize=102, RegionScale=2.1)
-- ============================================================================
local function SpecialistDensity(name, idx)
  return [[
        <Property name="DensityList" value="GcSpawnDensity" _index="]] .. idx .. [[">
          ...
          <Property name="PatchSize" value="102.000000" />
          <Property name="RegionScale" value="2.100000" />
        </Property>]]
end

-- ============================================================================
--  Helper: Generate GcObjectSpawnData MXML for a specialist waste crate
--  Template based on P_JUNK_SMALL entry with 5x-boosted spawn values
-- ============================================================================
        ...
        <Property name="Objects" value="GcObjectSpawnData" _index="]] .. idx .. [[">
          ...
          <Property name="QualityVariants">
            <Property name="QualityVariants" value="GcObjectSpawnDataVariant" _id="STANDARD">
              ...
              <Property name="Coverage" value="35.000000" />
              <Property name="FlatDensity" value="0.005000" />
              <Property name="SlopeDensity" value="0.005000" />
          ...
          <Property name="QualityVariantData" value="GcObjectSpawnDataVariant">
            <Property name="ID" value="STANDARD" />
            <Property name="Coverage" value="35.000000" />
            <Property name="FlatDensity" value="0.045000" />
            <Property name="SlopeDensity" value="0.045000" />
            <Property name="SlopeMultiplier" value="0.000000" />
            <Property name="LodDistances">
              <Property name="LodDistances" value="0.000000" _index="0" />
              <Property name="LodDistances" value="20.000000" _index="1" />
...
NMS_MOD_DEFINITION_CONTAINER = {
  MOD_FILENAME    = "5x_Industrial_Waste_Spawn.pak",
  MOD_AUTHOR      = "Javapower77",
  MOD_DESCRIPTION = "Increases Specialist Industrial Waste (SCRAPHEAP) and junk pile (P_JUNK) spawns by ~5x.\n"
      ...
      MBIN_CHANGE_TABLE = {
        ...
        -----------------------------------------------------------------------
        {
          ...
          MXML_CHANGE_TABLE = {
            ...
            -- PatchSize 185 → 83  (vanilla/√5 ≈ 5x denser grid)
            -- RegionScale 0.54 → 1.1  (2x wider regions)
            {
            ...
            -- PatchSize 450 → 201  (vanilla/√5)
            -- RegionScale 0.25 → 0.5
            {
            ...
            --  Same grid values as 5x-boosted P_JUNK_SMALL
            -----------------------------------------------------------
            {
              SPECIAL_KEY_WORDS = {"Name", "P_JUNK_LARGE"},
