local MOD_NAME     = "HardcoreSky_Fauna_AerialAquatic"
...
local GROUND_ARCHS = ""
local AIR_ARCHS    = "ONLYAIR,BIGBIRDS,FLYINGSNAKE,FLYINGLIZARD,ONLYSNAKE,ONLYLIZARD"
local WATER_ARCHS  = "T_ALLNEWFISH,T_FISH,T_JUSTFISH,T_JELLYFISH,T_SQUID,WATERWORLD,WATERGLOW,CRABS,T_FLOCK,T_FLOCK2,T_FLOCK3,T_DEEPFLOCK,T_FLOCKMANTA,T_FLOCKSEAHORSE,T_FLOCKPRAWN"
local CAVE_ARCHS   = "DEFAULT"
...
NMS_MOD_DEFINITION_CONTAINER = {
  ...
  MOD_DESCRIPTION = "Fauna overhaul: only flying, aquatic and cave creatures - no ground fauna - in every system (normal and abandoned).",
  MODIFICATIONS   = {{
