...
{
["MOD_FILENAME"] 			= "_ShipSpeed0.pak",
["MOD_AUTHOR"]		        = "OTBP",
["NMS_VERSION"]				= "v4.34.0.1",
["MOD_DESCRIPTION"]			= "Ship Hover Zero Speed, w/Reverse Interceptor",
					...
					{						
					    ...
					    },
						{
						    ...
						    ["VALUE_CHANGE_TABLE"] 	= 
							{
								...
								{ "MinSpeed", 							"0" }, 		--The minimum speed of standard thrusters. Setting to 0 for space will allow full-stops and reversing; for planets it allows hovering. [Default "1"]
							}
					    }
				    }
