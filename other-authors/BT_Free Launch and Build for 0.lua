...
{
["MOD_FILENAME"] 			= "Free Launch and Build for 0.pak",
["MOD_AUTHOR"]				= "Biostar Ten",				 -- mod author, only mentioned for documentaion
["NMS_VERSION"]				= "3.90",					 -- NMS version on first mod release, only mentioned for documentaion
["MODIFICATIONS"] 			= 
	{
		{
			...
			{ 
				{
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						{				
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"Amount",	"0"} 					-- Original 1    -- use "IGNORE" for first entry to skip property match check
							}
						}
					}
				},			
