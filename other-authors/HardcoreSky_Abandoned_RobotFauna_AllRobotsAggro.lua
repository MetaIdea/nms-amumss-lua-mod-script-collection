-- All robots aggro
local MOD_NAME      = "HardcoreSky_Abandoned_RobotFauna_AllRobotsAggro"
...
local CHANGES_ROBOT_AGGRO = {
  {
    REPLACE_TYPE       = "ALL",
    VALUE_CHANGE_TABLE = {{"CreatureRole","PlayerPredator"}}
  }
}
...
NMS_MOD_DEFINITION_CONTAINER = {
  ...
  MOD_DESCRIPTION = "Abandoned systems spawn only ground robots; all robot creatures are aggressive towards players.",
  MODIFICATIONS   = {{
    MBIN_CHANGE_TABLE = {
      {
        MBIN_FILE_SOURCE = {
      ...
      },
      {
        ...
        MXML_CHANGE_TABLE = CHANGES_ROBOT_AGGRO
      }
    }
  }}
}