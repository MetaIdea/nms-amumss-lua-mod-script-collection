...
NMS_MOD_DEFINITION_CONTAINER =
{
  ...
  MOD_DESCRIPTION = "Reduce rewards to 25% (x0.25), downgrade reward outcomes to B-class, force Illegal & Sentinel modules to C-class, leave Quicksilver unaffected, and include 0->1 clamp.",
  MODIFICATIONS   =
  {{
    MBIN_CHANGE_TABLE =
    {
        ...
        {
          {
            ...
            MATH_OPERATION     = "*",
            VALUE_CHANGE_TABLE = { {"AmountMin", MULT}, {"AmountMax", MULT} }
          },
          ...
          { REPLACE_TYPE="ALL", VALUE_MATCH=4, VALUE_CHANGE_TABLE={{"ProcTechQuality",2}} },
          { REPLACE_TYPE="ALL", VALUE_MATCH=3, VALUE_CHANGE_TABLE={{"ProcTechQuality",2}} },
        }
      },
      {
