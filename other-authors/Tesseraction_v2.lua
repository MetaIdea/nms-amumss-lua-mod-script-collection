...
NMS_MOD_DEFINITION_CONTAINER =
{
  ...
  ["MOD_AUTHOR"] = "Babscoole after Korro after TheLich after Sparky after WinderTP",
				...
				{ --Basic Floor SnapPoint Additions (Standard angle snap set used)
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						{ --ADD Snap Angle Set at offset to Floor SnapPoint N
							["SPECIAL_KEY_WORDS"] = {"Name","SnapPoint_N","Name","FloorTile_Out_"},
						...
						{ --ADD Snap Angle Set at offset to Floor SnapPoint E
							["SPECIAL_KEY_WORDS"] = {"Name","SnapPoint_E","Name","FloorTile_Out_"},
							["ADD_OPTION"]  = "ADDafterSECTION", 
						...
						{ --ADD Snap Angle Set at offset to Floor SnapPoint S
							["SPECIAL_KEY_WORDS"] = {"Name","SnapPoint_S","Name","FloorTile_Out_"},
							["ADD_OPTION"]  = "ADDafterSECTION", 
						...
						{ --ADD Snap Angle Set at offset to Floor SnapPoint W
							["SPECIAL_KEY_WORDS"] = {"Name","SnapPoint_W","Name","FloorTile_Out_"},
							["ADD_OPTION"]  = "ADDafterSECTION", 
