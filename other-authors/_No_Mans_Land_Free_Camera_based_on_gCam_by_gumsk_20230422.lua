tartAuthor = "Gumsk+Azzinoth"-- just little value adjustment in an attempt to give even more freedom of camera rotation by youngneil1
ModName = "gCam, modified for No Mans Land"
ModNameSub = "Offset, No Mans Land"
