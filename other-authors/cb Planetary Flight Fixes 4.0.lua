MINSPEED = 		0.001 -- This value sets the minimum possible speed while being inside a planet's atmosphere;
						-- Set to a value close to zero for hover (eg. 0.001); Set to 0 or -1 for backwards flight capability; Base game default = 20;
...
COSTMULT = 		0.20  -- This sets the ship launch fuel cost; The lower the number, the cheaper it gets; Tweak to your liking;
