                    ...
                    {
                        {
                            ...
                            {
                                {"JetpackFillRate", "1.5"},
                                {"JetpackFillRateMidair", "0.75"},
                                {"JetpackMinLevel", "0.25"},
                                {"JetpackUpForce", "40"},
                                ...
                                {"JetpackBrake", "0.9"},
                                {"JetpackDrainHorizontalFactor", "1.0"},
                                {"JetpackForce", "50"},
                                {"MaxFallSpeed", "49"},
                                {"HardLandMin", "999"},
                                {"HardLandMax", "9999"},
