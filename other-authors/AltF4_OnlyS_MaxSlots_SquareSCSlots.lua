...
-- Minimum and maximum inventory slots for ships and living ships
MinInventorySlotsShip = 120
MaxInventorySlotsShip = 120
MinInventorySlotsLivingShip = 120
MaxInventorySlotsLivingShip = 120

-- Minimum and maximum technology slots for ships and living ships
MinTechSlotsShip = 60
MaxTechSlotsShip = 60
MinTechSlotsLivingShip = 60
MaxTechSlotsLivingShip = 60

-- Minimum and maximum inventory slots for multitools
MinInventorySlotsMultiTool = 24
MaxInventorySlotsMultiTool = 24

-- Minimum and maximum inventory slots for freighters
...
-- Maximum inventory capacity for different ship classes
...
{
    ["MOD_FILENAME"] = "AltF4_OnlyS_MaxSlots_SquareSCSlots.pak",
    ["MOD_AUTHOR"] = "AltF4",
	["LUA_AUTHOR"] = "AltF4",
    ["NMS_VERSION"] = "4.45",
                    ...
                    ["EXML_CHANGE_TABLE"] = 
                    {
						...
						},
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								...
								{ "B", CClassMaxInventorySize },
								{ "A", CClassMaxInventorySize },
								{ "S", CClassMaxInventorySize },
							}
						},
					}
				},
