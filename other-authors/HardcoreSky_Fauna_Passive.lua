local MOD_NAME     = "HardcoreSky_Fauna_Passive"
local GAME_VERSION = "7.02"
local MOD_FILENAME = MOD_NAME..".zip"

local DO_ARCH    = 0
local DO_SAND    = 0
local ROLE_VALUE = "Passive"
...
NMS_MOD_DEFINITION_CONTAINER = {
  ...
  MOD_DESCRIPTION = "Optional behaviour add-on: every creature is peaceful (Passive). Stacks with any fauna pack.",
  MODIFICATIONS   = {{
