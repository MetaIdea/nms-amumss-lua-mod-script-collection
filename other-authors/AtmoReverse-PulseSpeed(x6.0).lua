...
--                             /\ --------------------- Pulse speed examples --------------------- /\
--
PULSE_SPEED_DEFINED          = 6 -- Define your pulse speed on this line by changing the number one immediately after the equals symbol (=)
--
...
{
["MOD_FILENAME"]             = "AtmoReverse-PulseSpeed(x6.0)",
