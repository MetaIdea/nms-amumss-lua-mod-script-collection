      ...
      <Property name="Template" value="GcInteractionComponentData.xml">
        ...
        <Property name="RendererAlt" value="TkModelRendererData.xml">
          <Property name="Camera" value="TkModelRendererCameraData.xml">
            ...
            <Property name="Offset" value="Vector3f.xml">
              <Property name="x" value="0.50" /> --0.05 --this is distance from the menu to the right
              <Property name="y" value="1.25" /> --1.75
              <Property name="z" value="0" />
            </Property>
            <Property name="Roll" value="0" />
          ...
          <Property name="FocusOffset" value="Vector3f.xml">
            <Property name="x" value="0" />
            <Property name="y" value="0" /> --nothing
            <Property name="z" value="0" />
          </Property>
          <Property name="FocusInterpTime" value="0" />
          <Property name="BlendInTime" value="0.8" />
        ...
        <Property name="InWorldUIScaler" value="0.6" /> -- 0.6
        <Property name="InWorldUIMinDistOverride" value="0" />
        <Property name="InWorldUIMinDistOverrideV2" value="0" />
        <Property name="InWorldUIForcedOffset" value="0.2" /> -- 0.2 and 10 does nothing
        <Property name="InWorldUIForcedOffsetV2" value="-3.0" /> -- 0
...
{
["MOD_FILENAME"] = "BBB_SavePoint_Teleporter.pak",
["MOD_AUTHOR"] = "BigBuffaloBill, credit: Aristotale, Babscoole",
["LUA_AUTHOR"]    = "BigBuffaloBill, credit: Aristotale, Babscoole",
["NMS_VERSION"]   = "5.25",
["MODIFICATIONS"] =
    {
        {
            ["MBIN_CHANGE_TABLE"] =
            {
                ...
                {
                    --[[ ["MBIN_FILE_SOURCE"] = "MODELS/PLANETS/BIOMES/COMMON/BUILDINGS/PARTS/BUILDABLEPARTS/DECORATION/SPOOKHEATER/ENTITIES/SPOOKHEATER.ENTITY.MBIN",]]
...
--[[			{
                    ["MBIN_FILE_SOURCE"] = "MODELS/PLANETS/BIOMES/COMMON/BUILDINGS/PARTS/BUILDABLEPARTS/TECH/VEHICLE_SUMMONER.SCENE.MBIN",
                    ["EXML_CHANGE_TABLE"] =
                    {
                        {
                            ["SPECIAL_KEY_WORDS"] = {"Name", "MODELS\\PLANETS\\BIOMES\\COMMON\\BUILDINGS\\PARTS\\BUILDABLEPARTS\\TECH\\VEHICLE_SUMMONER"},
