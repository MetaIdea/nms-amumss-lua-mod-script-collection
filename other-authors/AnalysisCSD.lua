...
{
["MOD_FILENAME"] 			= "AnalysisCSD.pak",
["MOD_AUTHOR"]		        = "OTBP",
["NMS_VERSION"]				= "5.20",
["MOD_DESCRIPTION"]			= "Target scanning trigger time mimimized, +Cargo Scan Deflector",
["MODIFICATIONS"] 			= 
	{
		{
					...
					{
						{
							...
							["VALUE_CHANGE_TABLE"] 	= 
							{
								...
								{"BinocTimeBeforeScan",					"0"}, 		-- WayPoint "0.5"
								{"BinocMinScanTime",					"0"},		-- WayPoint "2.2"
								{"BinocScanTime",						"0"}, 		-- WayPoint "2.2"
