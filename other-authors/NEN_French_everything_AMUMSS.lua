...
MEDIUM = "Moyen"
HIGH = "Haute"
CLASS_TECH = "La technologie"
CLASS_MINING = "Exploitation minière"
CLASS_TRADE = "Commerce"
CLASS_MANUFACT = "Fabrication"
CLASS_ALLOY = "Matériaux avancés"
CLASS_SCIENCE = "Scientifique"
CLASS_POWER = "La production d'énergie"

NMS_MOD_DEFINITION_CONTAINER = 
{
  ["MOD_FILENAME"] 			= "NEN_French_everything_AMUMSS.pak",
	...
	{
		{
			...
			{ 
				{
					["MBIN_FILE_SOURCE"] 	= "LANGUAGE/NMS_UPDATE3_FRENCH.MBIN",
					["EXML_CHANGE_TABLE"] = 
					{
						-- ECONOMY LEVEL
