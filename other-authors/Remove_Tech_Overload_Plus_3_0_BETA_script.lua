...
{
	["MOD_FILENAME"]             = "_Remove_Tech_Overload_Plus_3_0_BETA.pak", 
	["MOD_AUTHOR"]               = "chronicallybored",
	["NMS_VERSION"]              = "4.00",
	["MOD_DESCRIPTION"]          = "Removes technology overload , enables tech in cargo slots, fixes UI/inventory bounds and expands inv/tech slots of just about anything depending on it's class",
	["MODIFICATIONS"]            = 
