--THIS MOD IS CONFIGURED FOR 165FPS AND OVER

HOT_WIDTH = 4       --DEFINES WIDTH FOR NORMAL, EMERIL, CADMIUM, GOLDEN AND STEALTH TRAILS.
HOT_LENGTH = 5      --DEFINES LENGTH FOR NORMAL, EMERIL, CADMIUM, GOLDEN AND STEALTH TRAILS. VALUES UNDER 3 PRODUCE NO TRAIL.
RAINBOW_WIDTH = 3.5 --DEFINES WIDTH FOR CHROMATIC (RAINBOW) TRAIL.
RAINBOW_LEGTH = 5   --DEFINES LENGTH FOR CHROMATIC (RAINBOW) TRAIL. VALUES UNDER 3 PRODUCE NO TRAIL.

--SPUTTERING, TEMPORAL AND PLASMA TRAILS WON'T BEHAVE NICELY WITH SHORTER TRAILS SO NO OPTIONS FOR THOSE.

NMS_MOD_DEFINITION_CONTAINER =
{
["MOD_FILENAME"]    = "Starship Trail Tweaks v1.0 - 165FPS AND OVER",
