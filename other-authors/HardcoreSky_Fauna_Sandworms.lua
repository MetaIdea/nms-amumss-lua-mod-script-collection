local MOD_NAME     = "HardcoreSky_Fauna_Sandworms"
...
NMS_MOD_DEFINITION_CONTAINER = {
  ...
  MOD_DESCRIPTION = "Optional add-on: sandworms everywhere (presence chance = 1.0 in every biome). Does not stack with the fauna packs.",
  MODIFICATIONS   = {{
