...
----------Plus: Expanded Tech Slots----------
	...
	--- Exosuit
	--- These values multiplied with each other (W * H = Total size, in this case 48) determine the size of your exosuit inventory, tech and cargo
	
	EXOSUIT_INV_WIDTH  	 = 8	-- Exosuit inventory size W
	EXOSUIT_INV_HEIGHT 	 = 10	-- Exosuit inventory size H
	EXOSUIT_CARGO_WIDTH  = 8	-- Exosuit cargo size W
	EXOSUIT_CARGO_HEIGHT = 10	-- Exosuit cargo size H
...
{
	["MOD_FILENAME"]             = "_Remove_Tech_Overload_Ultimate_3_0_BETA.pak", 
	["MOD_AUTHOR"]               = "chronicallybored",
	["NMS_VERSION"]              = "4.00",
	["MOD_DESCRIPTION"]          = "Removes technology overload , enables tech in cargo slots, fixes UI/inventory bounds, expands inv/tech slots of just about anything depending on it's class and increases stack sizes by x100",
	["MODIFICATIONS"]            = 
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						...
						},
						{
                            ...
                            {	--- Inv/Boundary fixes ---
                                ...
                                {"PersonalInventoryMinHeightMax",     10},
				...
				{	
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
						{	--- Exosuit expansion normal mode Tech and Cargo ---
							...
							["VALUE_CHANGE_TABLE"] 	= 	
							{
								{"PlayerPersonalInventoryTechWidth",	EXOSUIT_INV_WIDTH},
								{"PlayerPersonalInventoryTechHeight",	EXOSUIT_INV_HEIGHT},
