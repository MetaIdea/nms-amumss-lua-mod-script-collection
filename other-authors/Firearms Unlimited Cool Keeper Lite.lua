local ModName = "FireArmsUnlimitedCoolKeeperLite.pak"
    ...
    ["MBIN_CHANGE_TABLE"] = {
      {
        ...
        ["MXML_CHANGE_TABLE"] = {
          ...
          {["SPECIAL_KEY_WORDS"] = {"ID","SHIPMINIGUN"},      ["PRECEDING_KEY_WORDS"] = {"Ship_Weapons_Guns_Range"},    ["SECTION_UP"] = 1, ["VALUE_CHANGE_TABLE"] = {{"Bonus", ShipMini}}},
