...
STACK_MULTIPLIER = STACK * 100 --a script user operation on the variable value prior to it being replacment inside NMS_MOD_DEFINITION_CONTAINER by the tool

NMS_MOD_DEFINITION_CONTAINER = 
{
["MOD_FILENAME"] 			= "SuperStorage.pak",   -- for adaptive modname use: "StackMultiplierX" .. STACK_MULTIPLIER .. ".pak", 
["MOD_AUTHOR"]				= "Lemon",				 -- mod author, only mentioned for documentaion
["NMS_VERSION"]				= "3.98",					 -- NMS version on first mod release, only mentioned for documentaion
["MODIFICATIONS"] 			= 
	{
		{
