MainDiffuse = "TEXTURES/PLANETS/BIOMES/COMMON/BUILDINGS/SHARED/COMMON/HFHANGARCOMMON_REDCALIGO.DDS" -- MAIN DIFFUSE MAP
MainMasks = "TEXTURES/PLANETS/BIOMES/COMMON/BUILDINGS/SHARED/COMMON/HFHANGARCOMMON_REDCALIGO.MASKS.DDS" -- MAIN MASKS MAP
MainNormal = "TEXTURES/PLANETS/BIOMES/COMMON/BUILDINGS/SHARED/COMMON/HFHANGARCOMMON_REDCALIGO.NORMAL.DDS" -- MAIN NORMAL MAP

FloorDiffuse = "TEXTURES/PLANETS/BIOMES/COMMON/BUILDINGS/SHARED/COMMON/HFHANGARCOMMONSSR_REDCALIGO.DDS" -- FLOOR DIFFUSE MAP
FloorMasks = "TEXTURES/PLANETS/BIOMES/COMMON/BUILDINGS/SHARED/COMMON/HFHANGARCOMMONSSR_REDCALIGO.MASKS.DDS" -- FLOOR MASKS MAP
FloorNormal = "TEXTURES/PLANETS/BIOMES/COMMON/BUILDINGS/SHARED/COMMON/HFHANGARCOMMONSSR_REDCALIGO.NORMAL.DDS" -- FLOOR NORMAL MAP

MetalDiffuse = "TEXTURES/SPACE/SPACESTATION/INTERIOR/METALHORIZONTALPATTERN_HFFREIGHTERHANGAR_REDCALIGO.DDS" -- METAL DIFFUSE
MetalMasks = "TEXTURES/SPACE/SPACESTATION/INTERIOR/METALHORIZONTALPATTERN_HFFREIGHTERHANGAR_REDCALIGO.MASKS.DDS" -- METAL MASKS MAP
MetalNormal = "TEXTURES/SPACE/SPACESTATION/INTERIOR/METALHORIZONTALPATTERN_HFFREIGHTERHANGAR_REDCALIGO.NORMAL.DDS" -- METAL NORMAL MAP

hFArrow = "TEXTURES/COMMON/SPACECRAFT/INDUSTRIAL/HFARROW_RED.DDS" -- CENTER SUPPORT SIDE ARROWS
hFArrow2 = "TEXTURES/COMMON/SPACECRAFT/INDUSTRIAL/HFARROW2_RED.DDS" -- CENTER SUPPORT WALKWAY ARROWS
...
{
["MOD_FILENAME"]	= "_hF_fHangarRetexture_RedCaligo_"..Version..".pak",
["MOD_AUTHOR"]		= Mod_Author,
["LUA_AUTHOR"]		= Lua_Author,
["NMS_VERSION"]		= Game_Version,
["MOD_VERSION"] 	= Version,
["MOD_DESCRIPTION"]	= "Red Caligo: Freighter Hangar Retexture",
["MODIFICATIONS"]	= 
	{
		{
			["MBIN_CHANGE_TABLE"] 	= 
