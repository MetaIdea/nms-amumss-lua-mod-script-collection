...
local MOD_NAME     = "HardcoreSky_FishingDifficulty_Rare"
...
NMS_MOD_DEFINITION_CONTAINER =
{
  ...
  MOD_DESCRIPTION = "Fishing overhaul: min/max wait x2.0, react window x0.5. Rewards for Rare/Epic/Legendary releases only. No line feedback.",
  MODIFICATIONS   =
  {{
    MBIN_CHANGE_TABLE =
    {
