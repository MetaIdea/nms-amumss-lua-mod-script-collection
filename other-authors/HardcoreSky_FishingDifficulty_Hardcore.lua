local WAIT_MULT  = 3.0
local REACT_MULT = 0.35

local MOD_NAME     = "HardcoreSky_FishingDifficulty_Hardcore"
...
NMS_MOD_DEFINITION_CONTAINER =
{
  ...
  MOD_DESCRIPTION = "Fishing overhaul: min/max wait x3.0, react window x0.35. Rewards only on Legendary releases. No line feedback.",
  MODIFICATIONS   =
  {{
    MBIN_CHANGE_TABLE =
    {
