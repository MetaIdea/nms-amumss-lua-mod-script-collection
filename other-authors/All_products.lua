...
MinProductQuantity=10000
MaxProductQuantity=10000
MinSubstanceQuantity=10000
MaxSubstanceQuantity=10000
...
{
  ["MOD_FILENAME"] = "All_products.pak",
  ["MOD_AUTHOR"] = "TuZ1971",
  ["NMS_VERSION"] = "4.45",
  ["MOD_DESCRIPTION"] = "Этот мод добавляет большинство игровых предметов в торговый терминал космической станции.",
  ["MODIFICATIONS"] =
  {
    {
      ["MBIN_CHANGE_TABLE"] =
