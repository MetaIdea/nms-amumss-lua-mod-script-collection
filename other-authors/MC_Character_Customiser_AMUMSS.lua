...
{
    ["MOD_FILENAME"]    = "MC Character Customiser AMUMSS.pak",
    ["MOD_DESCRIPTION"] = "Turns the portable Save Point into a functional Character Customiser while retaining its normal Save interaction, and unlocks the Save Point on new saves.",
    ["MOD_AUTHOR"]      = "CRealEmSay",
    ["LUA_AUTHOR"]      = "G",
    ["NMS_VERSION"]     = "6.45",
            ...
            {
                {
                    ...
                    {
                        {
                            ["SPECIAL_KEY_WORDS"] = {"KnownProducts", "FRE_FACE_DOOR_A"},
                            ["ADD_OPTION"] = "ADDafterLINE",
                            ["ADD"] = [[
<Property name="KnownProducts" value="BUILDSAVE" />
]]
                        }
                    }
                },
	...
	<Property name="GcInteractionComponentData">
		...
		<Property name="Renderer" value="TkModelRendererData">
			<Property name="Camera" value="TkModelRendererCameraData">
				<Property name="Distance" value="3.899999" />
				<Property name="Offset">
					<Property name="X" value="1.180000" />
					<Property name="Y" value="1.080001" />
					<Property name="Z" value="0.000000" />
				</Property>
				<Property name="Roll" value="0.000000" />
				<Property name="Pitch" value="7.520000" />
				<Property name="Rotate" value="-156.799900" />
