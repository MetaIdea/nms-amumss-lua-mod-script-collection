...
{
    ["MOD_FILENAME"]    = "cb Planetary Flight Fixes Reverse",
    ["MOD_AUTHOR"]      = "chronicallybored",
    ["NMS_VERSION"]     = "7.04",
    ["MOD_DESCRIPTION"] = "Improves planetary ship speed, handling and reverse flight, plus ship interaction range, scanner performance and launch fuel cost.",
    ["MODIFICATIONS"]   =
    {
        {
            ["MBIN_CHANGE_TABLE"] =
