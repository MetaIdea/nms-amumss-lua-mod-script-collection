...
{
  ["MOD_FILENAME"] 			= "IanM32.Beam Me Up Gold.pak",     --the name of the pak created (if not combined) - REQUIRED
					...
					{
						{
							["VALUE_CHANGE_TABLE"] 	= 
							{
								{"Map", "TEXTURES\EFFECTS\PLAYER\WARPZONEGOLD.DDS"}, --Original --first is "property name/value", second is "new value" (one or the other can be "IGNORE" in some cases), see Script_Rules.txt
							}	
						},
					}
				},
                ...
                {
                    {
                        ["VALUE_CHANGE_TABLE"] 	= 
                        {
                            {"Map", "TEXTURES\EFFECTS\PLAYER\WARPEMBERGOLD.DDS"},
                        }	
                    },
                }
            },
