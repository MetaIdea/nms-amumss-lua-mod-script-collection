    ...
    ["MODIFICATIONS"] = {
        {
            ["MBIN_CHANGE_TABLE"] = {
                { -- METADATA/PROJECTILES/PROJECTILETABLE.MBIN
                    ...
                    ["EXML_CHANGE_TABLE"] = {
                        ...
                        -- pirate freighter small turret
                        {
                            ...
                            ["VALUE_CHANGE_TABLE"] = {
                                { "DefaultSpeed", 1000.0 }, -- 450
                            }
                        },
                    }
                },

                --#region cop freighter turret
                {
                    ["MBIN_FILE_SOURCE"]  =
                    ...
                    ["EXML_CHANGE_TABLE"] = {
                        {
                            ["VALUE_CHANGE_TABLE"] = {
                                { "TurretRange",                 1000000.0 },      -- 2000
                                { "TurretLaserShootTime",        1.0 },            -- 3
                                { "TurretLaserActiveTime",       0.5 },            -- 2
                                { "TurretMissileLaunchSpeed",    500.0 },          -- 125
                                { "TurretProjectileRange",       10000.0 },        -- 3000
                                { "TurretMissileRange",          100000.0 },       -- 6000
                ...
                --#region pirate freighter small turret
                {
                    ["MBIN_FILE_SOURCE"]  =
                    ...
                    ["EXML_CHANGE_TABLE"] = {
                        {
                            ["VALUE_CHANGE_TABLE"] = {
                                { "TurretRange",              5000.0 }, -- 2000
                                { "TurretShootPauseTime",     2.0 },    -- 7
                                { "TurretMissileLaunchSpeed", 500.0 },  -- 125
                                { "TurretProjectileRange",    5000.0 }, -- 450
                            }
                        },
                    }
                },
