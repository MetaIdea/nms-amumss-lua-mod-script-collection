...
SILENCE_SML_REFINER = false --Portable Refiner
SILENCE_MED_REFINER = false --Medium Base Refiner
SILENCE_LRG_REFINER = false --Large Base Refiner

modNameSub = "PersonalOnly"
