...
--Jetpack
	JetpackTank = 10											--2.75 ; Jetpack tank size
			JetpackDrain = 1											--1 ; Life support drain during jetpack use.
	JetpackRegen = 5											--1 ; 7x tank size = instant refill.

--Jetpack main upgrade (UT_JET)
			UT_JetpackTank = 0.3										--0.2 ; Jetpack tank size
			UT_JetpackRegen = 1.5										--1.1 ; 7x tank size = instant refill.
			UT_JetpackStamina = 0.2										--0.1 ; Stamina bonus from this upgrade
			UT_JetpackStaminaRegen = 1.4								--1.2 ; STamina regen bonus from this upgrade
...
--Starship Adjustments
	ShipTransferRange = 500										--How much distance does the Teleport Receiver tech add, in u? Original value "150"
...
--Mech Adjustments
	--Mech Jetpack
	MechVehicle_BoostTanks = 5							--1 - Infinite
