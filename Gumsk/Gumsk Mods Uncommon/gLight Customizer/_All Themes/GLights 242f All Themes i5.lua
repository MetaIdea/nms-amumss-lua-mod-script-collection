...
-- for x = 1,#GroupMbinArray do		--Iterate 1x/MBIN Group
	-- for i = 1,5 do					--Iterate 1x/intensity step desired in multiples of 0.33, 1 = 0.33, 3=vanilla
		-- for r = 0,3 do				--Iterate 1x/red step desired, base 0, multiples of 0.33
			-- for g = 0,3 do			--Iterate 1x/green step desired, base 0, multiples of 0.33
				-- for b = 0,3 do		--Iterate 1x/blue step desired, base 0, multiples of 0.33


for x = 1,#GroupMbinArray do
	for i = 1,6 do					--Iterate 1x/intensity step desired in multiples of 0.33, 1 = 0.33, 3=vanilla
		for r = 0,4 do				--Iterate 1x/red step desired, base 0, multiples of 0.33
			for g = 0,4 do			--Iterate 1x/green step desired, base 0, multiples of 0.33
				for b = 0,4 do		--Iterate 1x/blue step desired, base 0, multiples of 0.33
					NMS_MOD_DEFINITION_CONTAINER[(#NMS_MOD_DEFINITION_CONTAINER+1)] = {
						
						MOD_FILENAME		= "__"..ModName.." "..GameVersion..ModVersion.." "..ModNameSub.." "..LightSettingsArray[x+1][1].." i"..(round(i*StepSize,1)).." r"..(round(r*StepSize,2)).." g"..(round(g*StepSize,2)).." b"..(round(b*StepSize,2))..".pak",	--Build PAK filename
						...
						MBIN_FILE_SOURCE = GroupMbinArray[x],		--Pull the MBINs that are members of this group
