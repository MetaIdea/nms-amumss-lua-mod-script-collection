...
GameVersion = "262"
ModVersion = "a"
FileSource = "GCGAMEPLAYGLOBALS.GLOBAL.MBIN"
...
--Torch Adjustments
TorchFoV = 120							--Torch arc width, in degrees. 181+=360 degrees. Original value "100"
TorchStrength = 20						--Torch brightness. Original value "4.0"
TorchOffsetX = 0						--Torch source, + right, -left of centerline of character, in u. Original value "0"
TorchOffsetY = -0.4						--Torch source, + above, -below top of character head, in u. Original value "0.5"
TorchOffsetZ = -0.6						--Torch source, + behind, - in front of centerline of character, in u. Original value "0"
TorchRotation = 0.4						--???
...
LightStrength = 1						--1 ; Seems to be all lights, but still has a really fast dropoff. 4 is blinding in small areas or up close
AirLockDoorRange = 3					--3 ; 
DisableBasePowerHUDOverlay = "False"	--"False"
FourthRaceSpawnPercentage = 3			--3 ; How likely are you to see another Traveller on stations, in percent
