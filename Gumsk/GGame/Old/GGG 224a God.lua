...
TorchColourGreen = 0.55					--Torch color green saturation percent. Original value "0.993"
TorchColourBlue = 0.4					--Torch color blue saturation percent. Original value "0.944"
