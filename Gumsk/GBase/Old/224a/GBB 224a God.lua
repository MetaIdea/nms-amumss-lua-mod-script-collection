...
BaseBorderStartRadius = 9999	-- When you first build the base, how far out can you build? Original value "300"
BaseBorderBump = 1000			-- If you place an item on the edge of your border, how much does the border bump out? Original value "50"
...
Unknown0x284 = 9999999			-- How long can one segment of power line or teleporter cable be? Original value "200"
Unknown0x288 = 100				--?? Below 10 scales up base building objects and moves build camera. Original value "100"


NMS_MOD_DEFINITION_CONTAINER = 
{
["MOD_FILENAME"]	= "GBB 224a God.pak",
