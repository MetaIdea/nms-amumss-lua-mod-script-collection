BaseBorderStartRadius = 3500		-- When you first build the base, how far out can you build? Original value "300"
BaseBorderBump = 0				-- If you place an item on the edge of your border, how much does the border bump out? Original value "50"
BaseBorderMaxRadius = 3500			-- What is the absolute maximum border distance? Original value "1000"
MaximumWireSegmentLength = 9999					-- How long can one segment of power line or teleporter cable be? Original value "200"
MaximumPipeSegmentLength = 9999					-- Maximum supply pipe segment length, in u. Original value "400"
...
{
["MOD_FILENAME"]	= "GBase 241a Boundary Frigate.pak",
