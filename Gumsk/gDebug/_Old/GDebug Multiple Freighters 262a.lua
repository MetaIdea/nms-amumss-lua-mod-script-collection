...
MultiplePlayerFreightersInASystem = "True"	--False
	...
	AllowSavingOnAbandonedFreighters = "False"	--False
	RevealAllTitles = "False"					--False
	UnlockAllTitles = "False"					--False
	AlwaysAllowShipOperations = "False"			--False
	AlwaysAllowVehicleOperations = "False"		--False
	AlwaysAllowFreighterInventoryAccess = "False"--False

NMS_MOD_DEFINITION_CONTAINER = 
{
MOD_FILENAME		= "GDebug Multiple Freighters 262a.pak",
