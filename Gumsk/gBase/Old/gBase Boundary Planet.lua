Author = "Gumsk"
ModName = "gBase"
ModNameSub = "Boundary-Wire-Pipe Planet"
BaseDescription = "Base boundary and wire length extensions"
GameVersion = "365"
ModVersion = "a"
FileSource1 = "GCBUILDINGGLOBALS.GLOBAL.MBIN"

MinRadiusForBases = 9999999						-- When you first build the base, how far out can you build? Original value "300"
...
MaxRadiusForPlanetBases = 9999999				-- What is the absolute maximum border distance? Original value "1000"
MaxRadiusForSpaceBases = 9999999				-- Not sure yet. Original 400
BuildingPlacementMaxConnectionLength = 9999999	-- How long can one segment of power line or teleporter cable be? Original value "200"
