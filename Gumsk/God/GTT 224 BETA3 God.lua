...
--Jetpack Adjustments
	JetpackSuit = 9999999							--??? Original value "1"
	JetpackTank = 9999999						--How big is the jetpack tank? 2=1s burn? Original value "2.75"
	JetpackDrain = 0						--No effect. How quickly does the jetpack tank drain? Original value "1"
	JetpackIgnition = 1						--No apparent effect. What even is this? Original value "1"
	JetpackRefill = 9999999						--How quickly does the jetpack tank refill? 7x tank size = instant. Original value "1"
	--RocketBootsSpeed = 4					--Boost to speed granted by Rocket Boots. My addition. Inactive

--LandExo Adjustments
	--LandExo Engine Adjustments
		LandExoEngineChargeAmount = 9999999			--?? Original value "300"
		LandExoEngineChargeMultiplier = 9999999		--How many charge units is each resource unit worth? Original value "1"
		LandExoEngine = 9999999						--?? Original value "1"
		LandExoEngineDrain = 0					--How quickly does the LandExo engine drain fuel? Original value "1"
	--LandExo Movement Adjustments
		--LandExoAcceleration = 1				--How quickly does the LandExo vroom, in u/s? Original value ""
		LandExoMaxSpeed = 11					--How much can the LandExo vroom, in u/s? Original value "1"
		LandExoBoostSpeed = 9999999					-- Original value "1"
		LandExoBoostTanks = 5					-- Original value "1"
		LandExoGrip = 4							--How sticky-icky is the LandExo? Ice Cube = xxx, Snoop Dogg = xxx. Original value "1"
	...
	--LandExo Mining Laser Adjustments
		LandExoLaserChargeAmount = 9999999			--?? Original value "200"
		LandExoLaserChargeMultiplier = 9999999		--How many charge units is each resource unit worth? Original value "1"
		LandExoLaserDamage = 9999999				--How much damage does the LandExo laser do? Original value "240"
		LandExoLaserHeatTime = 0				-- Original value "1"
		--LandExoLaserDrain = 0					--How quickly does the LandExo mining laser drain fuel? Original value ""
		LandExoLaserUpgradeDamage = 9999999			-- Original value "50"
	
	--LandExo Cannon Adjustments
		LandExoCannonChargeAmount = 9999999			--Original value "200"
		LandExoCannonChargeMultiplier = 9999999		--How many charge units is each resource unit worth? Original value "1"
		LandExoCannonDamage = 9999999				--How much damage does the LandExo cannon do? Original value "220"
		LandExoCannonHeatTime = 0				-- Original value "1"
		LandExoCannonFireRate = 0.1				-- Original value "0.5"
...
--Nautilon Adjustments
	--Nautilon Engine Adjustments
		NautilonEngineChargeAmount = 9999999		--?? Original value "400"
		NautilonEngineChargeMultiplier = 9999999		--How many charge units is each resource unit worth? Original value "1"
		NautilonEngine = 9999999						--?? Original value "1"
		NautilonEngineDrain = 0					--How quickly does the Nautilon engine drain fuel? If set to 0, you will not need to recharge it. Original value ""

	--Nautilon Movement Adjustments
		--NautilonAcceleration = 1				--How quickly does the Nautilon vroom, in u/s? Original value ""
		NautilonMaxSpeed = 500					--How much can the Nautilon vroom, in u/s? Original value ""
	...
	--Nautilon Mining Laser Adjustments
		...
		NautilonLaserChargeAmount = 9999999		--How many charge units can the tank hold?
		NautilonLaserChargeMultiplier = 9999999		--How many charge units is each resource unit worth? Original value "1"
		NautilonLaserDamage = 9999999				--How much damage does the Nautilon laser do? Original value ""
		NautilonLaserDamageLevel = 3
		NautilonLaserHeatTime = 0				--How quickly does the laser drain? Original value "1"
	...
	--Nautilon Cannon Adjustments
		...
		NautilonCannonDamage = 9999999				--How much damage does the Nautilon cannon do? Original value ""
		NautilonCannonChargeAmount = 9999999		--Original value ""
		NautilonCannonChargeMultiplier = 9999999		--How many charge units is each resource unit worth? Original value "1"
		NautilonCannonHeatTime = 0				-- Original value "1"
		NautilonCannonFireRate = 0.1			-- Original value "0.5"
...
--Starship Adjustments
	...
	--Starship Basic Launcher (LAUNCHER)
		ShipLaunchCost = 1						--Original value "50"

	--Starship Efficient Thrusters (UT_LAUNCHER)
		ShipEfficientRate = 0.01					--Original value "0.8" 
		ShipEfficientAutoCharge = 100				--Original value "0"

	--Starship Launch Recharger (UT_LAUNCHCHARGE)
		ShipUTAutoCharge = 100					--Original value "1"
...
{
["MOD_FILENAME"]	= "GTT 224 BETA3 God.pak",
...
--Nautilon
	...
	{ --Change Nautilon Mining Laser from Vehicle Laser to Weapon Laser
	["SPECIAL_KEY_WORDS"] = {"ID", "SUB_LASER"},
