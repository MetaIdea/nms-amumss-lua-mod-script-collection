...
FileSource1 = "MODELS\EFFECTS\TRAILS\PLAYER\JETPACKREDTRAIL.MATERIAL.MBIN"
FileSource2 = "MODELS\EFFECTS\PLAYER\JETPACKEFFECTS\JETPACKRED\ENGINEJETDARKMAT.MATERIAL.MBIN"
FileSource3 = "MODELS\EFFECTS\PLAYER\JETPACKEFFECTS\JETPACKRED\ENGINEJETDARKCOREMAT.MATERIAL.MBIN"
...
},
{
	...
	["EXML_CHANGE_TABLE"] = {
	{["SPECIAL_KEY_WORDS"] = {"Name","JetpackLightR","Name","COL_R"},
		["VALUE_CHANGE_TABLE"] = {
			{"Value", RedAmount},
		}},
	{["SPECIAL_KEY_WORDS"] = {"Name","JetpackLightR","Name","COL_G"},
		["VALUE_CHANGE_TABLE"] = {
			{"Value", GreenAmount},
		}},
	{["SPECIAL_KEY_WORDS"] = {"Name","JetpackLightR","Name","COL_B"},
		["VALUE_CHANGE_TABLE"] = {
			{"Value", BlueAmount},
		}},
	}
