...
ShipPulseRange						= 3000		--1500
ShipChargeTime						= 1			--20
ToolPulseRange						= 1000		--200
ToolChargeTime						= 1			--20
...
["MBIN_CHANGE_TABLE"] = {
	...
	["EXML_CHANGE_TABLE"] = {
		...
		["VALUE_CHANGE_TABLE"] = {
			{"PulseRange",ShipPulseRange},
			{"ChargeTime",ShipChargeTime},
		}},
		
		{["SPECIAL_KEY_WORDS"] = {"ScanType","Tool"},
		["VALUE_CHANGE_TABLE"] = {
			{"PulseRange",ToolPulseRange},
			{"ChargeTime",ToolChargeTime},
		}},
