...
BonusSameTypeAdd = 0.04					--?? Original value "0.06"
BonusSameTypeMult = 0.02				--?? Original value "0.04"
BonusChildAdd = 0.03					--?? Original value "0.05"
...
TorchRotation = 0						--???
TorchColourRed = 1						--Torch color red saturation percent. Original value "0.95"
TorchColourGreen = 0.65					--Torch color green saturation percent. Original value "0.993"
TorchColourBlue = 0						--Torch color blue saturation percent. Original value "0.944"
...
{
MOD_FILENAME	= "GGG 224a Full.pak",
MOD_DESCRIPTION	= "Gameplay Globals changes",
MOD_AUTHOR		= "Gumsk",
NMS_VERSION		= "2.4",
MODIFICATIONS	=
{{
