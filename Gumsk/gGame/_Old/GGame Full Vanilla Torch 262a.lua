...
--Torch Adjustments
TorchFoV = 80							--Torch arc width, in degrees. 181+=360 degrees. Original value "100"
...
TorchColourGreen = 0.84					--Torch color green saturation percent. Original value "0.993"
TorchColourBlue = 0.67					--Torch color blue saturation percent. Original value "0.944"
...
SentinelsHigh = 7						--10 ; 
SentinelsLow = 40						--30 ; 
AtmosphereEntryTime = 0.01				--1.5 No effect
...
{
MOD_FILENAME	= "GGame Vanilla Torch 262a.pak",
