...
OutX = 2.0							--Output Multiplier relative to vanilla
...
New_Hotspot_Array = {
				...
				{(100*OutX),	(7*OutX),		(0.5*OutX),		(0.5*OutX),		(0.5*OutX),		(0.5*OutX)},	--C-class output. Units unknwon.
				{(200*OutX),	(7*OutX),		(1.0*OutX),		(1.0*OutX),		(1.0*OutX),		(1.0*OutX)}, 	--B-class output
				{(400*OutX),	(7*OutX),		(2.0*OutX),		(2.0*OutX),		(2.0*OutX),		(2.0*OutX)}, 	--A-class output
				{(800*OutX),	(7*OutX),		(4.0*OutX),		(4.0*OutX),		(4.0*OutX),		(4.0*OutX)}, 	--S-class output
				{0.95,			0.95,			0.95,			0.95,			0.95,			0.95} 			--DiscoverThreshold??
			}

NMS_MOD_DEFINITION_CONTAINER = {
MOD_FILENAME	= "GHot 233a Gohirro.pak",
