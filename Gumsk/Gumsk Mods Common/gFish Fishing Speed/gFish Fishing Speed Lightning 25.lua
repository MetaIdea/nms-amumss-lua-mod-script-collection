			...
			MBIN_CHANGE_TABLE = {
				{
					...
					EXML_CHANGE_TABLE = {
						{
							VALUE_CHANGE_TABLE = {
                {"FishCatchAfterBiteTime",25},           --2; Time to catch after success. Don't go higher than 25! Allows multiple catches in one success animation.
