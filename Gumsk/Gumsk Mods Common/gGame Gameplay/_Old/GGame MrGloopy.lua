...
--Torch Adjustments
TorchFoV = 40									--Torch arc width, in degrees. 181+=360 degrees. Original value "100"
...
TorchOffsetY = 0								--Torch source, + above, -below top of character head, in u. Original value "0.5"
