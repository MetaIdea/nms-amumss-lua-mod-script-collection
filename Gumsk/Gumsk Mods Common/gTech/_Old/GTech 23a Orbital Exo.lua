...
--Jetpack
	JetpackSuit = 1							--1 . ???
	JetpackTank = 10						--2.75 . How big is the jetpack tank? 2=1s burn?
...
--Jetpack main upgrade (UT_JET)
	...
	UT_JetpackTank = 1						--0.2 . How big is the jetpack tank? 2=1s burn?
	UT_JetpackRegen = 1.7					--1.1 . How quickly does the jetpack tank Regen? 7x tank size = instant.
...
--LandExo
	...
	--LandExo Movement Adjustments
		...
		LandExoMaxSpeed = 270				--How much can the LandExo vroom, in u/s? Original value "1"
		LandExoBoostSpeed = 550				-- Original value "1"
		LandExoBoostTanks = 3				-- Original value "1"
		LandExoGrip = 3						--How sticky-icky is the LandExo? Ice Cube = xxx, Snoop Dogg = xxx. Original value "1"
		LandExoSkidGrip = 2					--?? Original value "1"
	...
	--LandExo Mining Laser Adjustments
		...
		LandExoLaserDamage = 1000				--How much damage does the LandExo laser do? Original value "240"
	...
	--LandExo Cannon Adjustments
		...
		LandExoCannonDamage = 2000				--How much damage does the LandExo cannon do? Original value "220"
...
--Nautilon Adjustments
	...
	--Nautilon Mining Laser Adjustments
		...
		NautilonLaserDamage = 1000				--How much damage does the Nautilon laser do? Original value ""
	...
	--Nautilon Cannon Adjustments
		...
		NautilonCannonDamage = 2000				--How much damage does the Nautilon cannon do? Original value ""
...
{
MOD_FILENAME	= "GTech 23a Orbital Exo.pak",
