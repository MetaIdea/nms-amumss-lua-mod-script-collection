			...
			EXML_CHANGE_TABLE = {
				{
					...
					VALUE_CHANGE_TABLE = {
						...
						{"JetpackForce",47},						--31 ; lateral force added when pressing in a direction. Existing force remains until direction is released
						...
						{"JetpackMaxSpeed",25},						--5 ; Lateral speed adjustments while airborne, whether using jetpack or not
						{"JetpackMaxUpSpeed",60},					--30
						{"JetpackUpForce",57},						--30 ; Needs to be above about 20 to overcome standard gravity
						...
						{"JetpackUpForceDeadPlanetExtra",16},		--10
						{"JetpackForceDeadPlanetExtra",26},			--15
