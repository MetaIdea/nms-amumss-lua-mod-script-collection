...
Element_Quant_Array = { --How many bonuses on each item, min/max, per level B,A,S
   {"1","1"},
   {"2","2"},
   {"3","3"}
}
...
Water_Quant_Array = { --How many bonuses on each item, min/max, per level C,B,A
   {"1","1"},
   {"1","2"},
   {"2","2"}
}
         ...
         {
            {
               ...
               ["EXML_CHANGE_TABLE"] =
               {
                  ...
                  {
                     ["SPECIAL_KEY_WORDS"] = {"ID","UP_SHLD1","StatsType","Suit_Armour_Shield_Strength",},
                     ["SECTION_UP"] = 1,
                     ["VALUE_CHANGE_TABLE"] =
                     {
                        {"ValueMin","0.6"},
                  ...
                  {
                     ["SPECIAL_KEY_WORDS"] = {"ID","UP_SHLD1","StatsType","Suit_Armour_Health",},
                     ["SECTION_UP"] = 1,
                     ["VALUE_CHANGE_TABLE"] =
                     {
                        {"ValueMin","5"},
                  ...
                  {
                     ["SPECIAL_KEY_WORDS"] = {"ID","UP_SHLD2","StatsType","Suit_Armour_Shield_Strength",},
                     ["SECTION_UP"] = 1,
                     ["VALUE_CHANGE_TABLE"] =
                     {
                        {"ValueMin","0.7"},
                  ...
                  {
                     ["SPECIAL_KEY_WORDS"] = {"ID","UP_SHLD2","StatsType","Suit_Armour_Health",},
                     ["SECTION_UP"] = 1,
                     ["VALUE_CHANGE_TABLE"] =
                     {
                        {"ValueMin","10"},
                  ...
                  {
                     ["SPECIAL_KEY_WORDS"] = {"ID","UP_SHLD3","StatsType","Suit_Armour_Shield_Strength",},
                     ["SECTION_UP"] = 1,
                     ["VALUE_CHANGE_TABLE"] =
                     {
                        {"ValueMin","0.8"},
                  ...
                  {
                     ["SPECIAL_KEY_WORDS"] = {"ID","UP_SHLD3","StatsType","Suit_Armour_Health",},
                     ["SECTION_UP"] = 1,
                     ["VALUE_CHANGE_TABLE"] =
                     {
                        {"ValueMin","15"},
