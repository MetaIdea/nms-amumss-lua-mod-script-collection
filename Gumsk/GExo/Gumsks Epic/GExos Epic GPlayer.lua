...
SolarRegenFactor = 9.99								--0.01 ; No effect? Maybe just small
...
HardModeEnergyDischargeRateLow = 0.05				--0.08
HardModeEnergyDischargeRateMedium = 0.5				--0.8
HardModeEnergyDischargeRateHigh = 1					--2.2
...
NormalModeHazardTimeMultiplier = 1.5				--0.9
NormalModeHazardDamageRateMultiplier = 0.5			--0.8
...
LeanLeftMaxAngle = 30								--35
LeanRightMaxAngle = 30								--35
LeanAmount = 0.3									--0.4
...
MaxTimeInMeleeBoost = 30							--1.4

	WeaponZoomEnabled = "True"							--True
WeaponZoomFOV = 0.8									--0.7
...
ThirdPersonRecoilMultiplier = 1.3					--1.5
GunRecoilMin = 0.1									--0.15
GunRecoilMax = 1.0									--1.6
ProjectileDamageFalloff = 0.7						--1
...
LaserWeaponRange = 200								--100
LaserShipRange = 2000								--1000
TerrainLaserRange = 200								--100
...
WeaponRailFireTime = 0.3							--0.4
WeaponRailRechargeTime = 0.6						--0.8
	BulletBend = 0.01									--0.01
GrenadeCarveRadius = 6								--5
ChargeTime = 0.3									--0.4
...
["EXML_CHANGE_TABLE"] = {
	...
	{"MedalReqBronze",MedalReqBronze},
	{"MedalReqSilver",MedalReqSilver},
	{"MedalReqGold",MedalReqGold},
	...
	{"GroundWalkSpeed_Unknown",GroundWalkSpeed},
