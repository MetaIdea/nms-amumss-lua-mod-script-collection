...
SPACE_CLOUDS_COLOR_INTENSITY 		= 0.6		-- Vanilla = 1 // Mod default = 0.6 // Multiplies the color intensity of "space clouds" (around nebulas) by this amount
...
NEBULA_COLOR_INTENSITY 				= 0.7		-- Vanilla = 1 // Mod default = 0.7 // Multiplies the color intensity of nebulas by this amount
...
{
	["MOD_FILENAME"]	= "_CSO v3.3 [Darker Space].pak", 
