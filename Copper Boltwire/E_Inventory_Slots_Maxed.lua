...
B class 20
A class 32
S class 48    Max size might be locked to 24, so this might not work beyond 24, but one can try ;)
					...
					["EXML_CHANGE_TABLE"] 	= 
					{
                        ...
                        --      Multi Tools
						{
							...
							["VALUE_CHANGE_TABLE"] 	=
							{
								{"C", 12}, -- 12
								{"B", 20}, -- 16
								{"A", 32}, -- 20    Max size might be locked to 24, so this might not work beyond 24, but one can try ;)
								{"S", 48}, -- 24
							}
						},
					}
