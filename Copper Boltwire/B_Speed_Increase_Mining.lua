...
--[[ Summery Description:
GREATLY Increases the speed at which the "Mining laser" mode mines most minerals.
Less time mining, means more time exploring.
]]--
...
{
    ["MOD_FILENAME"]    = "B_Speed_Increase_Mining.pak",
